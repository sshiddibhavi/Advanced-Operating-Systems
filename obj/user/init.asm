...
umain(int argc, char **argv)
{
  ...
  8001ef:	e8 d2 1b 00 00       	call   801dc6 <spawnl>
		if (r < 0) {
  ...
  800211:	50                   	push   %eax
  800212:	e8 7e 1f 00 00       	call   802195 <wait>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80042e:	e8 54 00 00 00       	call   800487 <vcprintf>
	cprintf("\n");
  800433:	c7 04 24 ec 2b 80 00 	movl   $0x802bec,(%esp)
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800769:	52                   	push   %edx
  80076a:	68 16 2b 80 00       	push   $0x802b16
  80076f:	53                   	push   %ebx
  800770:	56                   	push   %esi
...
stat(const char *path, struct Stat *stat)
{
  ...
  8015d0:	e8 0c 02 00 00       	call   8017e1 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801617:	e8 85 0c 00 00       	call   8022a1 <ipc_find_env>
  ...
  801632:	e8 16 0c 00 00       	call   80224d <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801637:	83 c4 0c             	add    $0xc,%esp
  80163a:	6a 00                	push   $0x0
  80163c:	53                   	push   %ebx
  80163d:	6a 00                	push   $0x0
  80163f:	e8 a0 0b 00 00       	call   8021e4 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801700:	89 15 00 70 80 00    	mov    %edx,0x807000
  801706:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  80170b:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  801710:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  801713:	89 1d 04 70 80 00    	mov    %ebx,0x807004
  ...
  80173b:	78 1d                	js     80175a <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  80173d:	39 d8                	cmp    %ebx,%eax
  80173f:	76 19                	jbe    80175a <devfile_write+0x6a>
  801741:	68 f8 2a 80 00       	push   $0x802af8
  801746:	68 04 2b 80 00       	push   $0x802b04
  80174b:	68 a3 00 00 00       	push   $0xa3
  801750:	68 19 2b 80 00       	push   $0x802b19
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801791:	68 24 2b 80 00       	push   $0x802b24
  801796:	68 04 2b 80 00       	push   $0x802b04
  80179b:	6a 7c                	push   $0x7c
  80179d:	68 19 2b 80 00       	push   $0x802b19
  8017a2:	e8 58 ec ff ff       	call   8003ff <_panic>
	assert(r <= PGSIZE);
  8017a7:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8017ac:	7e 16                	jle    8017c4 <devfile_read+0x65>
  8017ae:	68 2b 2b 80 00       	push   $0x802b2b
  8017b3:	68 04 2b 80 00       	push   $0x802b04
  8017b8:	6a 7d                	push   $0x7d
  8017ba:	68 19 2b 80 00       	push   $0x802b19
  8017bf:	e8 3b ec ff ff       	call   8003ff <_panic>
...
open(const char *path, int mode)
{
  ...
  801801:	50                   	push   %eax
  801802:	e8 71 f8 ff ff       	call   801078 <fd_alloc>
  ...
  80182e:	e8 cd fd ff ff       	call   801600 <fsipc>
  ...
  801844:	e8 27 f9 ff ff       	call   801170 <fd_close>
		return r;
  ...
  801856:	e8 f6 f7 ff ff       	call   801051 <fd2num>
...
sync(void)
{
  ...
  80187e:	e8 7d fd ff ff       	call   801600 <fsipc>
}
  801883:	c9                   	leave  
  801884:	c3                   	ret    
...
spawn(const char *prog, const char **argv)
{
  ...
  8018a8:	0f 88 ae 04 00 00    	js     801d5c <spawn+0x4d7>
		return r;
	fd = r;
  ...
  8018bc:	50                   	push   %eax
  8018bd:	57                   	push   %edi
  8018be:	e8 fb fa ff ff       	call   8013be <readn>
  ...
  8018e2:	e8 0a f9 ff ff       	call   8011f1 <close>
		cprintf("elf magic %08x want %08x\n", elf->e_magic, ELF_MAGIC);
  8018e7:	83 c4 0c             	add    $0xc,%esp
  8018ea:	68 7f 45 4c 46       	push   $0x464c457f
  8018ef:	ff b5 e8 fd ff ff    	pushl  -0x218(%ebp)
  8018f5:	68 37 2b 80 00       	push   $0x802b37
  8018fa:	e8 d9 eb ff ff       	call   8004d8 <cprintf>
		return -E_NOT_EXEC;
  8018ff:	83 c4 10             	add    $0x10,%esp
  801902:	bb f2 ff ff ff       	mov    $0xfffffff2,%ebx
  801907:	e9 b0 04 00 00       	jmp    801dbc <spawn+0x537>
...
sys_exofork(void)
{
  ...
  801921:	0f 88 3d 04 00 00    	js     801d64 <spawn+0x4df>
		return r;
	child = r;
  ...
  80192f:	6b f6 7c             	imul   $0x7c,%esi,%esi
  ...
  8019b0:	0f 86 be 03 00 00    	jbe    801d74 <spawn+0x4ef>
		return -E_NO_MEM;
  ...
  8019c2:	e8 99 f4 ff ff       	call   800e60 <sys_page_alloc>
  8019c7:	83 c4 10             	add    $0x10,%esp
  8019ca:	85 c0                	test   %eax,%eax
  8019cc:	0f 88 a9 03 00 00    	js     801d7b <spawn+0x4f6>
  ...
  8019e2:	8d 87 00 d0 7f ee    	lea    -0x11803000(%edi),%eax
  ...
  801a12:	39 b5 90 fd ff ff    	cmp    %esi,-0x270(%ebp)
  801a18:	7f c8                	jg     8019e2 <spawn+0x15d>
		argv_store[i] = UTEMP2USTACK(string_store);
		strcpy(string_store, argv[i]);
		string_store += strlen(argv[i]) + 1;
	}
  ...
  801a35:	68 ac 2b 80 00       	push   $0x802bac
  801a3a:	68 04 2b 80 00       	push   $0x802b04
  801a3f:	68 f2 00 00 00       	push   $0xf2
  801a44:	68 51 2b 80 00       	push   $0x802b51
  801a49:	e8 b1 e9 ff ff       	call   8003ff <_panic>

	argv_store[-1] = UTEMP2USTACK(argv_store);
  801a4e:	8b bd 94 fd ff ff    	mov    -0x26c(%ebp),%edi
  801a54:	89 f8                	mov    %edi,%eax
  801a56:	2d 00 30 80 11       	sub    $0x11803000,%eax
  ...
  801a67:	8d 87 f8 cf 7f ee    	lea    -0x11803008(%edi),%eax
  ...
  801ad2:	00 00 00 
  801ad5:	e9 88 01 00 00       	jmp    801c62 <spawn+0x3dd>
		if (ph->p_type != ELF_PROG_LOAD)
  801ada:	8b 85 7c fd ff ff    	mov    -0x284(%ebp),%eax
  801ae0:	83 38 01             	cmpl   $0x1,(%eax)
  801ae3:	0f 85 6b 01 00 00    	jne    801c54 <spawn+0x3cf>
			continue;
		perm = PTE_P | PTE_U;
		if (ph->p_flags & ELF_PROG_FLAG_WRITE)
  801ae9:	89 c7                	mov    %eax,%edi
  ...
  801b0a:	8b 7f 04             	mov    0x4(%edi),%edi
  801b0d:	89 f9                	mov    %edi,%ecx
  801b0f:	89 bd 80 fd ff ff    	mov    %edi,-0x280(%ebp)
  801b15:	8b 78 10             	mov    0x10(%eax),%edi
  801b18:	8b 50 14             	mov    0x14(%eax),%edx
  801b1b:	89 95 90 fd ff ff    	mov    %edx,-0x270(%ebp)
  801b21:	8b 70 08             	mov    0x8(%eax),%esi
	int i, r;
	void *blk;
  ...
  801b26:	25 ff 0f 00 00       	and    $0xfff,%eax
  801b2b:	74 14                	je     801b41 <spawn+0x2bc>
		va -= i;
  801b2d:	29 c6                	sub    %eax,%esi
		memsz += i;
  801b2f:	01 c2                	add    %eax,%edx
  801b31:	89 95 90 fd ff ff    	mov    %edx,-0x270(%ebp)
		filesz += i;
  801b37:	01 c7                	add    %eax,%edi
		fileoffset -= i;
  801b39:	29 c1                	sub    %eax,%ecx
  801b3b:	89 8d 80 fd ff ff    	mov    %ecx,-0x280(%ebp)
	}

	for (i = 0; i < memsz; i += PGSIZE) {
  801b41:	bb 00 00 00 00       	mov    $0x0,%ebx
  801b46:	e9 f7 00 00 00       	jmp    801c42 <spawn+0x3bd>
		if (i >= filesz) {
  801b4b:	39 df                	cmp    %ebx,%edi
  801b4d:	77 27                	ja     801b76 <spawn+0x2f1>
			// allocate a blank page
			if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
  801b4f:	83 ec 04             	sub    $0x4,%esp
  801b52:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801b58:	56                   	push   %esi
  801b59:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  801b5f:	e8 fc f2 ff ff       	call   800e60 <sys_page_alloc>
  801b64:	83 c4 10             	add    $0x10,%esp
  801b67:	85 c0                	test   %eax,%eax
  801b69:	0f 89 c7 00 00 00    	jns    801c36 <spawn+0x3b1>
  801b6f:	89 c3                	mov    %eax,%ebx
  801b71:	e9 13 02 00 00       	jmp    801d89 <spawn+0x504>
				return r;
		} else {
			// from file
  ...
  801b82:	e8 d9 f2 ff ff       	call   800e60 <sys_page_alloc>
  801b87:	83 c4 10             	add    $0x10,%esp
  801b8a:	85 c0                	test   %eax,%eax
  801b8c:	0f 88 ed 01 00 00    	js     801d7f <spawn+0x4fa>
				return r;
			if ((r = seek(fd, fileoffset + i)) < 0)
  801b92:	83 ec 08             	sub    $0x8,%esp
  801b95:	8b 85 80 fd ff ff    	mov    -0x280(%ebp),%eax
  801b9b:	03 85 94 fd ff ff    	add    -0x26c(%ebp),%eax
  801ba1:	50                   	push   %eax
  801ba2:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801ba8:	e8 e6 f8 ff ff       	call   801493 <seek>
  801bad:	83 c4 10             	add    $0x10,%esp
  801bb0:	85 c0                	test   %eax,%eax
  801bb2:	0f 88 cb 01 00 00    	js     801d83 <spawn+0x4fe>
				return r;
			if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
  801bb8:	83 ec 04             	sub    $0x4,%esp
  801bbb:	89 f8                	mov    %edi,%eax
  801bbd:	2b 85 94 fd ff ff    	sub    -0x26c(%ebp),%eax
  801bc3:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801bc8:	ba 00 10 00 00       	mov    $0x1000,%edx
  801bcd:	0f 47 c2             	cmova  %edx,%eax
  801bd0:	50                   	push   %eax
  801bd1:	68 00 00 40 00       	push   $0x400000
  801bd6:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801bdc:	e8 dd f7 ff ff       	call   8013be <readn>
  801be1:	83 c4 10             	add    $0x10,%esp
  801be4:	85 c0                	test   %eax,%eax
  801be6:	0f 88 9b 01 00 00    	js     801d87 <spawn+0x502>
				return r;
			if ((r = sys_page_map(0, UTEMP, child, (void*) (va + i), perm)) < 0)
  801bec:	83 ec 0c             	sub    $0xc,%esp
  801bef:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801bf5:	56                   	push   %esi
  801bf6:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  801bfc:	68 00 00 40 00       	push   $0x400000
  801c01:	6a 00                	push   $0x0
  801c03:	e8 9b f2 ff ff       	call   800ea3 <sys_page_map>
  801c08:	83 c4 20             	add    $0x20,%esp
  801c0b:	85 c0                	test   %eax,%eax
  801c0d:	79 15                	jns    801c24 <spawn+0x39f>
				panic("spawn: sys_page_map data: %e", r);
  801c0f:	50                   	push   %eax
  801c10:	68 5d 2b 80 00       	push   $0x802b5d
  801c15:	68 25 01 00 00       	push   $0x125
  801c1a:	68 51 2b 80 00       	push   $0x802b51
  801c1f:	e8 db e7 ff ff       	call   8003ff <_panic>
			sys_page_unmap(0, UTEMP);
  801c24:	83 ec 08             	sub    $0x8,%esp
  801c27:	68 00 00 40 00       	push   $0x400000
  801c2c:	6a 00                	push   $0x0
  801c2e:	e8 b2 f2 ff ff       	call   800ee5 <sys_page_unmap>
  801c33:	83 c4 10             	add    $0x10,%esp
	...
	for (i = 0; i < memsz; i += PGSIZE) {
  801c36:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  801c3c:	81 c6 00 10 00 00    	add    $0x1000,%esi
  801c42:	89 9d 94 fd ff ff    	mov    %ebx,-0x26c(%ebp)
  801c48:	39 9d 90 fd ff ff    	cmp    %ebx,-0x270(%ebp)
  801c4e:	0f 87 f7 fe ff ff    	ja     801b4b <spawn+0x2c6>
	if ((r = init_stack(child, argv, &child_tf.tf_esp)) < 0)
		return r;
	...
	ph = (struct Proghdr*) (elf_buf + elf->e_phoff);
	for (i = 0; i < elf->e_phnum; i++, ph++) {
  801c54:	83 85 78 fd ff ff 01 	addl   $0x1,-0x288(%ebp)
  801c5b:	83 85 7c fd ff ff 20 	addl   $0x20,-0x284(%ebp)
  801c62:	0f b7 85 14 fe ff ff 	movzwl -0x1ec(%ebp),%eax
  801c69:	39 85 78 fd ff ff    	cmp    %eax,-0x288(%ebp)
  801c6f:	0f 8c 65 fe ff ff    	jl     801ada <spawn+0x255>
			perm |= PTE_W;
		if ((r = map_segment(child, ph->p_va, ph->p_memsz,
  ...
  801c78:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801c7e:	e8 6e f5 ff ff       	call   8011f1 <close>
...
copy_shared_pages(envid_t child)
{
  ...
  801c8b:	8b b5 84 fd ff ff    	mov    -0x27c(%ebp),%esi
		if ((uvpd[PDX(i)] & PTE_P) && (uvpt[PGNUM(i)] & PTE_P) && (uvpt[PGNUM(i)] & PTE_U) && (uvpt[PGNUM(i)] & PTE_SHARE)){
  801c91:	89 d8                	mov    %ebx,%eax
  801c93:	c1 e8 16             	shr    $0x16,%eax
  801c96:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  801c9d:	a8 01                	test   $0x1,%al
  801c9f:	74 46                	je     801ce7 <spawn+0x462>
  801ca1:	89 d8                	mov    %ebx,%eax
  801ca3:	c1 e8 0c             	shr    $0xc,%eax
  801ca6:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  801cad:	f6 c2 01             	test   $0x1,%dl
  801cb0:	74 35                	je     801ce7 <spawn+0x462>
  801cb2:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  801cb9:	f6 c2 04             	test   $0x4,%dl
  801cbc:	74 29                	je     801ce7 <spawn+0x462>
  ...
  801cdf:	e8 bf f1 ff ff       	call   800ea3 <sys_page_map>
  801ce4:	83 c4 20             	add    $0x20,%esp
static int
copy_shared_pages(envid_t child)
{
	// LAB 5: Your code here.
  ...
  801ced:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  801cf3:	75 9c                	jne    801c91 <spawn+0x40c>
  ...
  801cf5:	81 8d dc fd ff ff 00 	orl    $0x3000,-0x224(%ebp)
  801cfc:	30 00 00 
	if ((r = sys_env_set_trapframe(child, &child_tf)) < 0)
  801cff:	83 ec 08             	sub    $0x8,%esp
  801d02:	8d 85 a4 fd ff ff    	lea    -0x25c(%ebp),%eax
  801d08:	50                   	push   %eax
  801d09:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801d0f:	e8 55 f2 ff ff       	call   800f69 <sys_env_set_trapframe>
  801d14:	83 c4 10             	add    $0x10,%esp
  801d17:	85 c0                	test   %eax,%eax
  801d19:	79 15                	jns    801d30 <spawn+0x4ab>
		panic("sys_env_set_trapframe: %e", r);
  801d1b:	50                   	push   %eax
  801d1c:	68 7a 2b 80 00       	push   $0x802b7a
  801d21:	68 86 00 00 00       	push   $0x86
  801d26:	68 51 2b 80 00       	push   $0x802b51
  801d2b:	e8 cf e6 ff ff       	call   8003ff <_panic>

	if ((r = sys_env_set_status(child, ENV_RUNNABLE)) < 0)
  801d30:	83 ec 08             	sub    $0x8,%esp
  801d33:	6a 02                	push   $0x2
  801d35:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801d3b:	e8 e7 f1 ff ff       	call   800f27 <sys_env_set_status>
  801d40:	83 c4 10             	add    $0x10,%esp
  801d43:	85 c0                	test   %eax,%eax
  801d45:	79 25                	jns    801d6c <spawn+0x4e7>
		panic("sys_env_set_status: %e", r);
  801d47:	50                   	push   %eax
  801d48:	68 94 2b 80 00       	push   $0x802b94
  801d4d:	68 89 00 00 00       	push   $0x89
  801d52:	68 51 2b 80 00       	push   $0x802b51
  801d57:	e8 a3 e6 ff ff       	call   8003ff <_panic>
	//     correct initial eip and esp values in the child.
	//
	//   - Start the child process running with sys_env_set_status().
	...
	if ((r = open(prog, O_RDONLY)) < 0)
		return r;
  801d5c:	8b 9d 8c fd ff ff    	mov    -0x274(%ebp),%ebx
  801d62:	eb 58                	jmp    801dbc <spawn+0x537>
		return -E_NOT_EXEC;
	}
	...
	if ((r = sys_exofork()) < 0)
		return r;
  801d64:	8b 9d 74 fd ff ff    	mov    -0x28c(%ebp),%ebx
  801d6a:	eb 50                	jmp    801dbc <spawn+0x537>
		panic("sys_env_set_trapframe: %e", r);
  ...
  801d72:	eb 48                	jmp    801dbc <spawn+0x537>
	argv_store = (uintptr_t*) (ROUNDDOWN(string_store, 4) - 4 * (argc + 1));
	...
	if ((void*) (argv_store - 2) < (void*) UTEMP)
		return -E_NO_MEM;
  801d74:	bb fc ff ff ff       	mov    $0xfffffffc,%ebx
  801d79:	eb 41                	jmp    801dbc <spawn+0x537>

	// Allocate the single stack page at UTEMP.
	if ((r = sys_page_alloc(0, (void*) UTEMP, PTE_P|PTE_U|PTE_W)) < 0)
		return r;
  801d7b:	89 c3                	mov    %eax,%ebx
  801d7d:	eb 3d                	jmp    801dbc <spawn+0x537>
			// allocate a blank page
			if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
				return r;
		} else {
  ...
  801d81:	eb 06                	jmp    801d89 <spawn+0x504>
				return r;
			if ((r = seek(fd, fileoffset + i)) < 0)
  801d83:	89 c3                	mov    %eax,%ebx
  801d85:	eb 02                	jmp    801d89 <spawn+0x504>
				return r;
			if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
...
error:
  ...
  801d8c:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801d92:	e8 4a f0 ff ff       	call   800de1 <sys_env_destroy>
	close(fd);
  801d97:	83 c4 04             	add    $0x4,%esp
  801d9a:	ff b5 8c fd ff ff    	pushl  -0x274(%ebp)
  801da0:	e8 4c f4 ff ff       	call   8011f1 <close>
	return r;
  801da5:	83 c4 10             	add    $0x10,%esp
  801da8:	eb 12                	jmp    801dbc <spawn+0x537>
		goto error;
...
error:
  ...
  801db4:	e8 2c f1 ff ff       	call   800ee5 <sys_page_unmap>
...
spawnl(const char *prog, const char *arg0, ...)
{
  ...
  801dcb:	8d 55 10             	lea    0x10(%ebp),%edx
{
  ...
  801dce:	b8 00 00 00 00       	mov    $0x0,%eax
	...
	va_start(vl, arg0);
	while(va_arg(vl, void *) != NULL)
  801dd3:	eb 03                	jmp    801dd8 <spawnl+0x12>
		argc++;
  801dd5:	83 c0 01             	add    $0x1,%eax
	...
	va_start(vl, arg0);
	while(va_arg(vl, void *) != NULL)
  801dd8:	83 c2 04             	add    $0x4,%edx
  801ddb:	83 7a fc 00          	cmpl   $0x0,-0x4(%edx)
  801ddf:	75 f4                	jne    801dd5 <spawnl+0xf>
		argc++;
	va_end(vl);
  ...
  801de1:	8d 14 85 1a 00 00 00 	lea    0x1a(,%eax,4),%edx
  801de8:	83 e2 f0             	and    $0xfffffff0,%edx
  801deb:	29 d4                	sub    %edx,%esp
  801ded:	8d 54 24 03          	lea    0x3(%esp),%edx
  801df1:	c1 ea 02             	shr    $0x2,%edx
  801df4:	8d 34 95 00 00 00 00 	lea    0x0(,%edx,4),%esi
  801dfb:	89 f3                	mov    %esi,%ebx
	argv[0] = arg0;
  801dfd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801e00:	89 0c 95 00 00 00 00 	mov    %ecx,0x0(,%edx,4)
	argv[argc+1] = NULL;
  801e07:	c7 44 86 04 00 00 00 	movl   $0x0,0x4(%esi,%eax,4)
  801e0e:	00 
  ...
  801e16:	eb 0a                	jmp    801e22 <spawnl+0x5c>
		argv[i+1] = va_arg(vl, const char *);
  801e18:	83 c0 01             	add    $0x1,%eax
  801e1b:	8b 4c 85 0c          	mov    0xc(%ebp,%eax,4),%ecx
  801e1f:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
	argv[0] = arg0;
	argv[argc+1] = NULL;
  ...
  801e24:	75 f2                	jne    801e18 <spawnl+0x52>
		argv[i+1] = va_arg(vl, const char *);
	va_end(vl);
  ...
  801e2d:	e8 53 fa ff ff       	call   801885 <spawn>
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801e47:	e8 15 f2 ff ff       	call   801061 <fd2data>
  801e4c:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801e4e:	83 c4 08             	add    $0x8,%esp
  801e51:	68 d4 2b 80 00       	push   $0x802bd4
  801e56:	53                   	push   %ebx
  801e57:	e8 01 ec ff ff       	call   800a5d <strcpy>
  ...
  801e6e:	00 00 00 
	stat->st_dev = &devpipe;
  801e71:	c7 83 88 00 00 00 ac 	movl   $0x8047ac,0x88(%ebx)
  801e78:	47 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801e94:	e8 4c f0 ff ff       	call   800ee5 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801e99:	89 1c 24             	mov    %ebx,(%esp)
  801e9c:	e8 c0 f1 ff ff       	call   801061 <fd2data>
  801ea1:	83 c4 08             	add    $0x8,%esp
  801ea4:	50                   	push   %eax
  801ea5:	6a 00                	push   $0x0
  801ea7:	e8 39 f0 ff ff       	call   800ee5 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801ee7:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801eea:	8b 15 90 67 80 00    	mov    0x806790,%edx
  ...
  801f01:	50                   	push   %eax
  801f02:	56                   	push   %esi
  801f03:	68 db 2b 80 00       	push   $0x802bdb
  801f08:	e8 cb e5 ff ff       	call   8004d8 <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801f29:	56                   	push   %esi
  801f2a:	e8 32 f1 ff ff       	call   801061 <fd2data>
  ...
  801f46:	75 48                	jne    801f90 <devpipe_write+0x73>
			...
			sys_yield();
  801f48:	e8 f4 ee ff ff       	call   800e41 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801fa6:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801fa9:	57                   	push   %edi
  801faa:	e8 b2 f0 ff ff       	call   801061 <fd2data>
  ...
  801fce:	75 32                	jne    802002 <devpipe_read+0x65>
			...
			sys_yield();
  801fd0:	e8 6c ee ff ff       	call   800e41 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  80201a:	50                   	push   %eax
  80201b:	e8 58 f0 ff ff       	call   801078 <fd_alloc>
  ...
  80203a:	e8 21 ee ff ff       	call   800e60 <sys_page_alloc>
  ...
  802052:	50                   	push   %eax
  802053:	e8 20 f0 ff ff       	call   801078 <fd_alloc>
  ...
  802072:	e8 e9 ed ff ff       	call   800e60 <sys_page_alloc>
  ...
  80208a:	e8 d2 ef ff ff       	call   801061 <fd2data>
  ...
  80209c:	e8 bf ed ff ff       	call   800e60 <sys_page_alloc>
  ...
  8020b4:	e8 a8 ef ff ff       	call   801061 <fd2data>
  8020b9:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  8020c0:	50                   	push   %eax
  8020c1:	6a 00                	push   $0x0
  8020c3:	56                   	push   %esi
  8020c4:	6a 00                	push   $0x0
  8020c6:	e8 d8 ed ff ff       	call   800ea3 <sys_page_map>
  ...
  8020d4:	8b 15 ac 47 80 00    	mov    0x8047ac,%edx
  ...
  8020e9:	8b 15 ac 47 80 00    	mov    0x8047ac,%edx
  ...
  80212f:	e8 b1 ed ff ff       	call   800ee5 <sys_page_unmap>
  ...
  80213f:	e8 a1 ed ff ff       	call   800ee5 <sys_page_unmap>
  ...
  80214f:	e8 91 ed ff ff       	call   800ee5 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  80216f:	e8 53 ef ff ff       	call   8010c7 <fd_lookup>
  ...
  802181:	e8 db ee ff ff       	call   801061 <fd2data>
	return _pipeisclosed(fd, p);
...
wait(envid_t envid)
{
  ...
  8021a1:	68 f3 2b 80 00       	push   $0x802bf3
  8021a6:	68 04 2b 80 00       	push   $0x802b04
  8021ab:	6a 09                	push   $0x9
  8021ad:	68 fe 2b 80 00       	push   $0x802bfe
  8021b2:	e8 48 e2 ff ff       	call   8003ff <_panic>
	e = &envs[ENVX(envid)];
  ...
  8021c8:	eb 05                	jmp    8021cf <wait+0x3a>
		sys_yield();
  8021ca:	e8 72 ec ff ff       	call   800e41 <sys_yield>
{
	const volatile struct Env *e;
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021f2:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  8021f4:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  ...
  8021ff:	50                   	push   %eax
  802200:	e8 0b ee ff ff       	call   801010 <sys_ipc_recv>

	if (r < 0) {
  802205:	83 c4 10             	add    $0x10,%esp
  802208:	85 c0                	test   %eax,%eax
  80220a:	79 16                	jns    802222 <ipc_recv+0x3e>
		if (from_env_store)
  80220c:	85 f6                	test   %esi,%esi
  80220e:	74 06                	je     802216 <ipc_recv+0x32>
			*from_env_store = 0;
  802210:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  802216:	85 db                	test   %ebx,%ebx
  802218:	74 2c                	je     802246 <ipc_recv+0x62>
			*perm_store = 0;
  80221a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  802220:	eb 24                	jmp    802246 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  802222:	85 f6                	test   %esi,%esi
  802224:	74 0a                	je     802230 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  802226:	a1 90 67 80 00       	mov    0x806790,%eax
  80222b:	8b 40 74             	mov    0x74(%eax),%eax
  80222e:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  802230:	85 db                	test   %ebx,%ebx
  802232:	74 0a                	je     80223e <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  802234:	a1 90 67 80 00       	mov    0x806790,%eax
  802239:	8b 40 78             	mov    0x78(%eax),%eax
  80223c:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  80223e:	a1 90 67 80 00       	mov    0x806790,%eax
  802243:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80225f:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  802261:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  ...
  80226d:	56                   	push   %esi
  80226e:	57                   	push   %edi
  80226f:	e8 79 ed ff ff       	call   800fed <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  802274:	83 c4 10             	add    $0x10,%esp
  802277:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80227a:	75 07                	jne    802283 <ipc_send+0x36>
			sys_yield();
  80227c:	e8 c0 eb ff ff       	call   800e41 <sys_yield>
  802281:	eb e6                	jmp    802269 <ipc_send+0x1c>
		} else if (r < 0) {
  802283:	85 c0                	test   %eax,%eax
  802285:	79 12                	jns    802299 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  802287:	50                   	push   %eax
  802288:	68 09 2c 80 00       	push   $0x802c09
  80228d:	6a 51                	push   $0x51
  80228f:	68 16 2c 80 00       	push   $0x802c16
  802294:	e8 66 e1 ff ff       	call   8003ff <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  8022ba:	75 0d                	jne    8022c9 <ipc_find_env+0x28>
			return envs[i].env_id;
  8022bc:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8022bf:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  8022c4:	8b 40 48             	mov    0x48(%eax),%eax
  8022c7:	eb 0f                	jmp    8022d8 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8022d1:	75 d9                	jne    8022ac <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  8022e2:	c1 e8 16             	shr    $0x16,%eax
  8022e5:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  8022f1:	f6 c1 01             	test   $0x1,%cl
  8022f4:	74 1d                	je     802313 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  8022f6:	c1 ea 0c             	shr    $0xc,%edx
  8022f9:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  802300:	f6 c2 01             	test   $0x1,%dl
  802303:	74 0e                	je     802313 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  802305:	c1 ea 0c             	shr    $0xc,%edx
  802308:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  80230f:	ef 
  802310:	0f b7 c0             	movzwl %ax,%eax
}
  802313:	5d                   	pop    %ebp
  802314:	c3                   	ret    
