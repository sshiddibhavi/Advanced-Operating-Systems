...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041e:	52                   	push   %edx
  80041f:	68 76 22 80 00       	push   $0x802276
  800424:	53                   	push   %ebx
  800425:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800aca:	e8 4a 0f 00 00       	call   801a19 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4b:	e8 c9 0e 00 00       	call   801a19 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8d:	e8 87 0e 00 00       	call   801a19 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bcf:	e8 45 0e 00 00       	call   801a19 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c11:	e8 03 0e 00 00       	call   801a19 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c53:	e8 c1 0d 00 00       	call   801a19 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c95:	e8 7f 0d 00 00       	call   801a19 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf9:	e8 1b 0d 00 00       	call   801a19 <_panic>
...
stat(const char *path, struct Stat *stat)
{
  ...
  801285:	e8 0c 02 00 00       	call   801496 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8012cc:	e8 4b 08 00 00       	call   801b1c <ipc_find_env>
  ...
  8012e7:	e8 dc 07 00 00       	call   801ac8 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8012ec:	83 c4 0c             	add    $0xc,%esp
  8012ef:	6a 00                	push   $0x0
  8012f1:	53                   	push   %ebx
  8012f2:	6a 00                	push   $0x0
  8012f4:	e8 66 07 00 00       	call   801a5f <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8013b5:	89 15 00 50 80 00    	mov    %edx,0x805000
  8013bb:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8013c0:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  8013c5:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  8013c8:	89 1d 04 50 80 00    	mov    %ebx,0x805004
  ...
  8013f0:	78 1d                	js     80140f <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  8013f2:	39 d8                	cmp    %ebx,%eax
  8013f4:	76 19                	jbe    80140f <devfile_write+0x6a>
  8013f6:	68 58 22 80 00       	push   $0x802258
  8013fb:	68 64 22 80 00       	push   $0x802264
  801400:	68 a3 00 00 00       	push   $0xa3
  801405:	68 79 22 80 00       	push   $0x802279
  80140a:	e8 0a 06 00 00       	call   801a19 <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801427:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  80142d:	ba 00 00 00 00       	mov    $0x0,%edx
  801432:	b8 03 00 00 00       	mov    $0x3,%eax
  801437:	e8 79 fe ff ff       	call   8012b5 <fsipc>
  80143c:	89 c3                	mov    %eax,%ebx
  80143e:	85 c0                	test   %eax,%eax
  801440:	78 4b                	js     80148d <devfile_read+0x79>
		return r;
	assert(r <= n);
  801442:	39 c6                	cmp    %eax,%esi
  801444:	73 16                	jae    80145c <devfile_read+0x48>
  801446:	68 84 22 80 00       	push   $0x802284
  80144b:	68 64 22 80 00       	push   $0x802264
  801450:	6a 7c                	push   $0x7c
  801452:	68 79 22 80 00       	push   $0x802279
  801457:	e8 bd 05 00 00       	call   801a19 <_panic>
	assert(r <= PGSIZE);
  80145c:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801461:	7e 16                	jle    801479 <devfile_read+0x65>
  801463:	68 8b 22 80 00       	push   $0x80228b
  801468:	68 64 22 80 00       	push   $0x802264
  80146d:	6a 7d                	push   $0x7d
  80146f:	68 79 22 80 00       	push   $0x802279
  801474:	e8 a0 05 00 00       	call   801a19 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801479:	83 ec 04             	sub    $0x4,%esp
  80147c:	50                   	push   %eax
  80147d:	68 00 50 80 00       	push   $0x805000
  801482:	ff 75 0c             	pushl  0xc(%ebp)
  801485:	e8 1a f4 ff ff       	call   8008a4 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8014a0:	53                   	push   %ebx
  8014a1:	e8 33 f2 ff ff       	call   8006d9 <strlen>
  8014a6:	83 c4 10             	add    $0x10,%esp
  8014a9:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  8014ae:	7f 67                	jg     801517 <open+0x81>
		return -E_BAD_PATH;
  ...
  8014b6:	50                   	push   %eax
  8014b7:	e8 71 f8 ff ff       	call   800d2d <fd_alloc>
  ...
  8014c3:	78 57                	js     80151c <open+0x86>
		return r;
  ...
  801515:	eb 05                	jmp    80151c <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  801517:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  80152e:	b8 08 00 00 00       	mov    $0x8,%eax
  801533:	e8 7d fd ff ff       	call   8012b5 <fsipc>
}
  801538:	c9                   	leave  
  801539:	c3                   	ret    

0080153a <devpipe_stat>:
	return i;
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801552:	68 97 22 80 00       	push   $0x802297
  801557:	53                   	push   %ebx
  801558:	e8 b5 f1 ff ff       	call   800712 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  80155d:	8b 46 04             	mov    0x4(%esi),%eax
  801560:	2b 06                	sub    (%esi),%eax
  801562:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801568:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  80156f:	00 00 00 
	stat->st_dev = &devpipe;
  801572:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801579:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801595:	e8 00 f6 ff ff       	call   800b9a <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  80159a:	89 1c 24             	mov    %ebx,(%esp)
  80159d:	e8 74 f7 ff ff       	call   800d16 <fd2data>
  8015a2:	83 c4 08             	add    $0x8,%esp
  8015a5:	50                   	push   %eax
  8015a6:	6a 00                	push   $0x0
  8015a8:	e8 ed f5 ff ff       	call   800b9a <sys_page_unmap>
}
  8015ad:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8015b0:	c9                   	leave  
  8015b1:	c3                   	ret    

008015b2 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015c5:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  8015c8:	83 ec 0c             	sub    $0xc,%esp
  8015cb:	ff 75 e0             	pushl  -0x20(%ebp)
  8015ce:	e8 82 05 00 00       	call   801b55 <pageref>
  8015d3:	89 c3                	mov    %eax,%ebx
  8015d5:	89 3c 24             	mov    %edi,(%esp)
  8015d8:	e8 78 05 00 00       	call   801b55 <pageref>
  8015dd:	83 c4 10             	add    $0x10,%esp
  8015e0:	39 c3                	cmp    %eax,%ebx
  8015e2:	0f 94 c1             	sete   %cl
  8015e5:	0f b6 c9             	movzbl %cl,%ecx
  8015e8:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  8015eb:	8b 15 04 40 80 00    	mov    0x804004,%edx
  8015f1:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  8015f4:	39 ce                	cmp    %ecx,%esi
  8015f6:	74 1b                	je     801613 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  8015f8:	39 c3                	cmp    %eax,%ebx
  8015fa:	75 c4                	jne    8015c0 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8015fc:	8b 42 58             	mov    0x58(%edx),%eax
  8015ff:	ff 75 e4             	pushl  -0x1c(%ebp)
  801602:	50                   	push   %eax
  801603:	56                   	push   %esi
  801604:	68 9e 22 80 00       	push   $0x80229e
  801609:	e8 7f eb ff ff       	call   80018d <cprintf>
  80160e:	83 c4 10             	add    $0x10,%esp
  801611:	eb ad                	jmp    8015c0 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162a:	56                   	push   %esi
  80162b:	e8 e6 f6 ff ff       	call   800d16 <fd2data>
  ...
  801640:	e8 6d ff ff ff       	call   8015b2 <_pipeisclosed>
  ...
  801647:	75 48                	jne    801691 <devpipe_write+0x73>
			...
			sys_yield();
  801649:	e8 a8 f4 ff ff       	call   800af6 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8016a7:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  8016aa:	57                   	push   %edi
  8016ab:	e8 66 f6 ff ff       	call   800d16 <fd2data>
  ...
  8016c8:	e8 e5 fe ff ff       	call   8015b2 <_pipeisclosed>
  ...
  8016cf:	75 32                	jne    801703 <devpipe_read+0x65>
			...
			sys_yield();
  8016d1:	e8 20 f4 ff ff       	call   800af6 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  80171b:	50                   	push   %eax
  80171c:	e8 0c f6 ff ff       	call   800d2d <fd_alloc>
  ...
  80173b:	e8 d5 f3 ff ff       	call   800b15 <sys_page_alloc>
  ...
  801753:	50                   	push   %eax
  801754:	e8 d4 f5 ff ff       	call   800d2d <fd_alloc>
  ...
  801773:	e8 9d f3 ff ff       	call   800b15 <sys_page_alloc>
  ...
  80178b:	e8 86 f5 ff ff       	call   800d16 <fd2data>
  ...
  80179d:	e8 73 f3 ff ff       	call   800b15 <sys_page_alloc>
  ...
  8017b5:	e8 5c f5 ff ff       	call   800d16 <fd2data>
  8017ba:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  8017c1:	50                   	push   %eax
  8017c2:	6a 00                	push   $0x0
  8017c4:	56                   	push   %esi
  8017c5:	6a 00                	push   $0x0
  8017c7:	e8 8c f3 ff ff       	call   800b58 <sys_page_map>
  ...
  801830:	e8 65 f3 ff ff       	call   800b9a <sys_page_unmap>
  ...
  801840:	e8 55 f3 ff ff       	call   800b9a <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801870:	e8 07 f5 ff ff       	call   800d7c <fd_lookup>
  801875:	83 c4 10             	add    $0x10,%esp
  801878:	85 c0                	test   %eax,%eax
  80187a:	78 18                	js     801894 <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  80187c:	83 ec 0c             	sub    $0xc,%esp
  80187f:	ff 75 f4             	pushl  -0xc(%ebp)
  801882:	e8 8f f4 ff ff       	call   800d16 <fd2data>
	return _pipeisclosed(fd, p);
  801887:	89 c2                	mov    %eax,%edx
  801889:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80188c:	e8 21 fd ff ff       	call   8015b2 <_pipeisclosed>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018a6:	68 b6 22 80 00       	push   $0x8022b6
  8018ab:	ff 75 0c             	pushl  0xc(%ebp)
  8018ae:	e8 5f ee ff ff       	call   800712 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8018be:	56                   	push   %esi
  8018bf:	53                   	push   %ebx
  8018c0:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  8018cb:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  8018d1:	eb 2d                	jmp    801900 <devcons_write+0x46>
		m = n - tot;
  8018d3:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8018d6:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  8018d8:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  8018db:	ba 7f 00 00 00       	mov    $0x7f,%edx
  8018e0:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  8018ea:	50                   	push   %eax
  8018eb:	57                   	push   %edi
  8018ec:	e8 b3 ef ff ff       	call   8008a4 <memmove>
		sys_cputs(buf, m);
  8018f1:	83 c4 08             	add    $0x8,%esp
  8018f4:	53                   	push   %ebx
  8018f5:	57                   	push   %edi
  8018f6:	e8 5e f1 ff ff       	call   800a59 <sys_cputs>
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  8018fb:	01 de                	add    %ebx,%esi
  8018fd:	83 c4 10             	add    $0x10,%esp
  801900:	89 f0                	mov    %esi,%eax
  801902:	3b 75 10             	cmp    0x10(%ebp),%esi
  801905:	72 cc                	jb     8018d3 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80191e:	74 2a                	je     80194a <devcons_read+0x3b>
  801920:	eb 05                	jmp    801927 <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801922:	e8 cf f1 ff ff       	call   800af6 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801927:	e8 4b f1 ff ff       	call   800a77 <sys_cgetc>
  80192c:	85 c0                	test   %eax,%eax
  80192e:	74 f2                	je     801922 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801930:	85 c0                	test   %eax,%eax
  801932:	78 16                	js     80194a <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801934:	83 f8 04             	cmp    $0x4,%eax
  801937:	74 0c                	je     801945 <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  ...
  801943:	eb 05                	jmp    80194a <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  80195a:	8d 45 f7             	lea    -0x9(%ebp),%eax
  80195d:	50                   	push   %eax
  80195e:	e8 f6 f0 ff ff       	call   800a59 <sys_cputs>
}
...
getchar(void)
{
  ...
  801976:	e8 67 f6 ff ff       	call   800fe2 <read>
	if (r < 0)
  80197b:	83 c4 10             	add    $0x10,%esp
  80197e:	85 c0                	test   %eax,%eax
  801980:	78 0f                	js     801991 <getchar+0x29>
		return r;
	if (r < 1)
  801982:	85 c0                	test   %eax,%eax
  801984:	7e 06                	jle    80198c <getchar+0x24>
		return -E_EOF;
	return c;
  801986:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  80198a:	eb 05                	jmp    801991 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  80198c:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801991:	c9                   	leave  
  801992:	c3                   	ret    
...
opencons(void)
{
  ...
  8019c8:	50                   	push   %eax
  8019c9:	e8 5f f3 ff ff       	call   800d2d <fd_alloc>
...
opencons(void)
{
  ...
  8019d5:	78 3e                	js     801a15 <opencons+0x56>
		return r;
  ...
  8019e4:	e8 2c f1 ff ff       	call   800b15 <sys_page_alloc>
  ...
  8019f0:	78 23                	js     801a15 <opencons+0x56>
		return r;
  ...
  801a0a:	50                   	push   %eax
  801a0b:	e8 f6 f2 ff ff       	call   800d06 <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a27:	e8 ab f0 ff ff       	call   800ad7 <sys_getenvid>
  801a2c:	83 ec 0c             	sub    $0xc,%esp
  801a2f:	ff 75 0c             	pushl  0xc(%ebp)
  801a32:	ff 75 08             	pushl  0x8(%ebp)
  801a35:	56                   	push   %esi
  801a36:	50                   	push   %eax
  801a37:	68 c4 22 80 00       	push   $0x8022c4
  801a3c:	e8 4c e7 ff ff       	call   80018d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801a41:	83 c4 18             	add    $0x18,%esp
  801a44:	53                   	push   %ebx
  801a45:	ff 75 10             	pushl  0x10(%ebp)
  801a48:	e8 ef e6 ff ff       	call   80013c <vcprintf>
	cprintf("\n");
  801a4d:	c7 04 24 af 22 80 00 	movl   $0x8022af,(%esp)
  801a54:	e8 34 e7 ff ff       	call   80018d <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a6d:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801a6f:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801a74:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801a77:	83 ec 0c             	sub    $0xc,%esp
  801a7a:	50                   	push   %eax
  801a7b:	e8 45 f2 ff ff       	call   800cc5 <sys_ipc_recv>

	if (r < 0) {
  801a80:	83 c4 10             	add    $0x10,%esp
  801a83:	85 c0                	test   %eax,%eax
  801a85:	79 16                	jns    801a9d <ipc_recv+0x3e>
		if (from_env_store)
  801a87:	85 f6                	test   %esi,%esi
  801a89:	74 06                	je     801a91 <ipc_recv+0x32>
			*from_env_store = 0;
  801a8b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801a91:	85 db                	test   %ebx,%ebx
  801a93:	74 2c                	je     801ac1 <ipc_recv+0x62>
			*perm_store = 0;
  801a95:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801a9b:	eb 24                	jmp    801ac1 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801a9d:	85 f6                	test   %esi,%esi
  801a9f:	74 0a                	je     801aab <ipc_recv+0x4c>
  ...
  801aad:	74 0a                	je     801ab9 <ipc_recv+0x5a>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ada:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  801adc:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  ...
  801ae8:	56                   	push   %esi
  801ae9:	57                   	push   %edi
  801aea:	e8 b3 f1 ff ff       	call   800ca2 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801aef:	83 c4 10             	add    $0x10,%esp
  801af2:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801af5:	75 07                	jne    801afe <ipc_send+0x36>
			sys_yield();
  801af7:	e8 fa ef ff ff       	call   800af6 <sys_yield>
  801afc:	eb e6                	jmp    801ae4 <ipc_send+0x1c>
		} else if (r < 0) {
  801afe:	85 c0                	test   %eax,%eax
  801b00:	79 12                	jns    801b14 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801b02:	50                   	push   %eax
  801b03:	68 e8 22 80 00       	push   $0x8022e8
  801b08:	6a 51                	push   $0x51
  801b0a:	68 f5 22 80 00       	push   $0x8022f5
  801b0f:	e8 05 ff ff ff       	call   801a19 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b4c:	75 d9                	jne    801b27 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
