...
_pgfault_upcall:
  ...
  800326:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  80032b:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  80032f:	89 03                	mov    %eax,(%ebx)
	addl $0x8, %esp
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800ced:	75 2c                	jne    800d1b <set_pgfault_handler+0x3b>
		// First time through!
		// LAB 4: Your code here.
  ...
  800d11:	68 9b 12 80 00       	push   $0x80129b
  ...
  800d1e:	a3 08 20 80 00       	mov    %eax,0x802008
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  800d23:	83 ec 08             	sub    $0x8,%esp
  800d26:	68 17 03 80 00       	push   $0x800317
  800d2b:	6a 00                	push   $0x0
  800d2d:	e8 3f f5 ff ff       	call   800271 <sys_env_set_pgfault_upcall>
  800d32:	83 c4 10             	add    $0x10,%esp
  800d35:	85 c0                	test   %eax,%eax
  800d37:	79 14                	jns    800d4d <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  800d39:	83 ec 04             	sub    $0x4,%esp
  800d3c:	68 ac 12 80 00       	push   $0x8012ac
  800d41:	6a 2b                	push   $0x2b
  800d43:	68 9b 12 80 00       	push   $0x80129b
  800d48:	e8 ee f5 ff ff       	call   80033b <_panic>
