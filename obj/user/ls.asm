...
ls1(const char *prefix, bool isdir, off_t size, const char *name)
{
  ...
  80005f:	e8 94 19 00 00       	call   8019f8 <printf>
  ...
  80009d:	e8 56 19 00 00       	call   8019f8 <printf>
  8000a2:	83 c4 10             	add    $0x10,%esp
	}
	printf("%s", name);
  8000a5:	83 ec 08             	sub    $0x8,%esp
  8000a8:	ff 75 14             	pushl  0x14(%ebp)
  8000ab:	68 5a 27 80 00       	push   $0x80275a
  8000b0:	e8 43 19 00 00       	call   8019f8 <printf>
	if(flag['F'] && isdir)
  ...
  8000cf:	e8 24 19 00 00       	call   8019f8 <printf>
  8000d4:	83 c4 10             	add    $0x10,%esp
	printf("\n");
  8000d7:	83 ec 0c             	sub    $0xc,%esp
  8000da:	68 27 23 80 00       	push   $0x802327
  8000df:	e8 14 19 00 00       	call   8019f8 <printf>
}
...
lsdir(const char *path, const char *prefix)
{
  ...
  8000ff:	57                   	push   %edi
  800100:	e8 55 17 00 00       	call   80185a <open>
...
usage(void)
{
  ...
  800225:	e8 ce 17 00 00       	call   8019f8 <printf>
	exit();
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80068e:	52                   	push   %edx
  80068f:	68 5a 27 80 00       	push   $0x80275a
  800694:	53                   	push   %ebx
  800695:	56                   	push   %esi
...
stat(const char *path, struct Stat *stat)
{
  ...
  801649:	e8 0c 02 00 00       	call   80185a <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801690:	e8 15 09 00 00       	call   801faa <ipc_find_env>
  ...
  8016ab:	e8 a6 08 00 00       	call   801f56 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8016b0:	83 c4 0c             	add    $0xc,%esp
  8016b3:	6a 00                	push   $0x0
  8016b5:	53                   	push   %ebx
  8016b6:	6a 00                	push   $0x0
  8016b8:	e8 30 08 00 00       	call   801eed <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801779:	89 15 00 50 80 00    	mov    %edx,0x805000
  80177f:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801784:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  801789:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  80178c:	89 1d 04 50 80 00    	mov    %ebx,0x805004
  ...
  8017b4:	78 1d                	js     8017d3 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  8017b6:	39 d8                	cmp    %ebx,%eax
  8017b8:	76 19                	jbe    8017d3 <devfile_write+0x6a>
  8017ba:	68 3c 27 80 00       	push   $0x80273c
  8017bf:	68 48 27 80 00       	push   $0x802748
  8017c4:	68 a3 00 00 00       	push   $0xa3
  8017c9:	68 5d 27 80 00       	push   $0x80275d
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8017eb:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8017f1:	ba 00 00 00 00       	mov    $0x0,%edx
  8017f6:	b8 03 00 00 00       	mov    $0x3,%eax
  8017fb:	e8 79 fe ff ff       	call   801679 <fsipc>
  801800:	89 c3                	mov    %eax,%ebx
  801802:	85 c0                	test   %eax,%eax
  801804:	78 4b                	js     801851 <devfile_read+0x79>
		return r;
	assert(r <= n);
  801806:	39 c6                	cmp    %eax,%esi
  801808:	73 16                	jae    801820 <devfile_read+0x48>
  80180a:	68 68 27 80 00       	push   $0x802768
  80180f:	68 48 27 80 00       	push   $0x802748
  801814:	6a 7c                	push   $0x7c
  801816:	68 5d 27 80 00       	push   $0x80275d
  80181b:	e8 04 eb ff ff       	call   800324 <_panic>
	assert(r <= PGSIZE);
  801820:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801825:	7e 16                	jle    80183d <devfile_read+0x65>
  801827:	68 6f 27 80 00       	push   $0x80276f
  80182c:	68 48 27 80 00       	push   $0x802748
  801831:	6a 7d                	push   $0x7d
  801833:	68 5d 27 80 00       	push   $0x80275d
  801838:	e8 e7 ea ff ff       	call   800324 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  80183d:	83 ec 04             	sub    $0x4,%esp
  801840:	50                   	push   %eax
  801841:	68 00 50 80 00       	push   $0x805000
  801846:	ff 75 0c             	pushl  0xc(%ebp)
  801849:	e8 c6 f2 ff ff       	call   800b14 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  801864:	53                   	push   %ebx
  801865:	e8 df f0 ff ff       	call   800949 <strlen>
  80186a:	83 c4 10             	add    $0x10,%esp
  80186d:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801872:	7f 67                	jg     8018db <open+0x81>
		return -E_BAD_PATH;
  ...
  80187a:	50                   	push   %eax
  80187b:	e8 71 f8 ff ff       	call   8010f1 <fd_alloc>
  ...
  801887:	78 57                	js     8018e0 <open+0x86>
		return r;
  ...
  8018d9:	eb 05                	jmp    8018e0 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  8018db:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  8018f2:	b8 08 00 00 00       	mov    $0x8,%eax
  8018f7:	e8 7d fd ff ff       	call   801679 <fsipc>
}
  8018fc:	c9                   	leave  
  8018fd:	c3                   	ret    
...
{
	if (b->error > 0) {
  8018fe:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  801902:	7e 37                	jle    80193b <writebuf+0x3d>
};
...
writebuf(struct printbuf *b)
{
  ...
  80190d:	ff 70 04             	pushl  0x4(%eax)
  801910:	8d 40 10             	lea    0x10(%eax),%eax
  801913:	50                   	push   %eax
  801914:	ff 33                	pushl  (%ebx)
  801916:	e8 65 fb ff ff       	call   801480 <write>
		if (result > 0)
  80191b:	83 c4 10             	add    $0x10,%esp
  80191e:	85 c0                	test   %eax,%eax
  801920:	7e 03                	jle    801925 <writebuf+0x27>
			b->result += result;
  801922:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  801925:	3b 43 04             	cmp    0x4(%ebx),%eax
  801928:	74 0d                	je     801937 <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  80192a:	85 c0                	test   %eax,%eax
  80192c:	ba 00 00 00 00       	mov    $0x0,%edx
  801931:	0f 4f c2             	cmovg  %edx,%eax
  801934:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  801937:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  80193a:	c9                   	leave  
  80193b:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  801944:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  801947:	8b 53 04             	mov    0x4(%ebx),%edx
  80194a:	8d 42 01             	lea    0x1(%edx),%eax
  80194d:	89 43 04             	mov    %eax,0x4(%ebx)
  801950:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801953:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  801957:	3d 00 01 00 00       	cmp    $0x100,%eax
  80195c:	75 0e                	jne    80196c <putch+0x2f>
		writebuf(b);
  80195e:	89 d8                	mov    %ebx,%eax
  801960:	e8 99 ff ff ff       	call   8018fe <writebuf>
		b->idx = 0;
  801965:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	}
}
  80196c:	83 c4 04             	add    $0x4,%esp
  80196f:	5b                   	pop    %ebx
  801970:	5d                   	pop    %ebp
  801971:	c3                   	ret    
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  801975:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  80197b:	8b 45 08             	mov    0x8(%ebp),%eax
  80197e:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  801984:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  80198b:	00 00 00 
	b.result = 0;
  80198e:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  801995:	00 00 00 
	b.error = 1;
  801998:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  80199f:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  8019a2:	ff 75 10             	pushl  0x10(%ebp)
  8019a5:	ff 75 0c             	pushl  0xc(%ebp)
  8019a8:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  8019ae:	50                   	push   %eax
  8019af:	68 3d 19 80 00       	push   $0x80193d
  8019b4:	e8 7b eb ff ff       	call   800534 <vprintfmt>
	if (b.idx > 0)
  8019b9:	83 c4 10             	add    $0x10,%esp
  8019bc:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  8019c3:	7e 0b                	jle    8019d0 <vfprintf+0x5e>
		writebuf(&b);
  8019c5:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  8019cb:	e8 2e ff ff ff       	call   8018fe <writebuf>

	return (b.result ? b.result : b.error);
  8019d0:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8019d6:	85 c0                	test   %eax,%eax
  8019d8:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  8019df:	c9                   	leave  
  8019e0:	c3                   	ret    
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  8019e4:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  8019e7:	8d 45 10             	lea    0x10(%ebp),%eax
	cnt = vfprintf(fd, fmt, ap);
  8019ea:	50                   	push   %eax
  8019eb:	ff 75 0c             	pushl  0xc(%ebp)
  8019ee:	ff 75 08             	pushl  0x8(%ebp)
  8019f1:	e8 7c ff ff ff       	call   801972 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  8019fb:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  8019fe:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  801a01:	50                   	push   %eax
  801a02:	ff 75 08             	pushl  0x8(%ebp)
  801a05:	6a 01                	push   $0x1
  801a07:	e8 66 ff ff ff       	call   801972 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a26:	68 7b 27 80 00       	push   $0x80277b
  801a2b:	53                   	push   %ebx
  801a2c:	e8 51 ef ff ff       	call   800982 <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801a69:	e8 9c f3 ff ff       	call   800e0a <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801a6e:	89 1c 24             	mov    %ebx,(%esp)
  801a71:	e8 64 f6 ff ff       	call   8010da <fd2data>
  801a76:	83 c4 08             	add    $0x8,%esp
  801a79:	50                   	push   %eax
  801a7a:	6a 00                	push   $0x0
  801a7c:	e8 89 f3 ff ff       	call   800e0a <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801abc:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801abf:	8b 15 20 44 80 00    	mov    0x804420,%edx
  ...
  801ad6:	50                   	push   %eax
  801ad7:	56                   	push   %esi
  801ad8:	68 82 27 80 00       	push   $0x802782
  801add:	e8 1b e9 ff ff       	call   8003fd <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801afe:	56                   	push   %esi
  801aff:	e8 d6 f5 ff ff       	call   8010da <fd2data>
  ...
  801b1b:	75 48                	jne    801b65 <devpipe_write+0x73>
			...
			sys_yield();
  801b1d:	e8 44 f2 ff ff       	call   800d66 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801b7b:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801b7e:	57                   	push   %edi
  801b7f:	e8 56 f5 ff ff       	call   8010da <fd2data>
  ...
  801ba3:	75 32                	jne    801bd7 <devpipe_read+0x65>
			...
			sys_yield();
  801ba5:	e8 bc f1 ff ff       	call   800d66 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801bef:	50                   	push   %eax
  801bf0:	e8 fc f4 ff ff       	call   8010f1 <fd_alloc>
  ...
  801c0f:	e8 71 f1 ff ff       	call   800d85 <sys_page_alloc>
  ...
  801c27:	50                   	push   %eax
  801c28:	e8 c4 f4 ff ff       	call   8010f1 <fd_alloc>
  ...
  801c47:	e8 39 f1 ff ff       	call   800d85 <sys_page_alloc>
  ...
  801c5f:	e8 76 f4 ff ff       	call   8010da <fd2data>
  ...
  801c71:	e8 0f f1 ff ff       	call   800d85 <sys_page_alloc>
  ...
  801c89:	e8 4c f4 ff ff       	call   8010da <fd2data>
  801c8e:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801c95:	50                   	push   %eax
  801c96:	6a 00                	push   $0x0
  801c98:	56                   	push   %esi
  801c99:	6a 00                	push   $0x0
  801c9b:	e8 28 f1 ff ff       	call   800dc8 <sys_page_map>
  ...
  801d04:	e8 01 f1 ff ff       	call   800e0a <sys_page_unmap>
  ...
  801d14:	e8 f1 f0 ff ff       	call   800e0a <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801d44:	e8 f7 f3 ff ff       	call   801140 <fd_lookup>
  ...
  801d56:	e8 7f f3 ff ff       	call   8010da <fd2data>
	return _pipeisclosed(fd, p);
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d7a:	68 9a 27 80 00       	push   $0x80279a
  801d7f:	ff 75 0c             	pushl  0xc(%ebp)
  801d82:	e8 fb eb ff ff       	call   800982 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801dbe:	50                   	push   %eax
  801dbf:	57                   	push   %edi
  801dc0:	e8 4f ed ff ff       	call   800b14 <memmove>
		sys_cputs(buf, m);
  801dc5:	83 c4 08             	add    $0x8,%esp
  801dc8:	53                   	push   %ebx
  801dc9:	57                   	push   %edi
  801dca:	e8 fa ee ff ff       	call   800cc9 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801df4:	eb 05                	jmp    801dfb <devcons_read+0x18>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801df6:	e8 6b ef ff ff       	call   800d66 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801dfb:	e8 e7 ee ff ff       	call   800ce7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801e31:	50                   	push   %eax
  801e32:	e8 92 ee ff ff       	call   800cc9 <sys_cputs>
}
...
getchar(void)
{
  ...
  801e4a:	e8 57 f5 ff ff       	call   8013a6 <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  801e74:	e8 c7 f2 ff ff       	call   801140 <fd_lookup>
  ...
  801e83:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
...
opencons(void)
{
  ...
  801e9c:	50                   	push   %eax
  801e9d:	e8 4f f2 ff ff       	call   8010f1 <fd_alloc>
...
opencons(void)
{
  ...
  801eb8:	e8 c8 ee ff ff       	call   800d85 <sys_page_alloc>
  ...
  801ec6:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  801ede:	50                   	push   %eax
  801edf:	e8 e6 f1 ff ff       	call   8010ca <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801efb:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801efd:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801f02:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801f05:	83 ec 0c             	sub    $0xc,%esp
  801f08:	50                   	push   %eax
  801f09:	e8 27 f0 ff ff       	call   800f35 <sys_ipc_recv>

	if (r < 0) {
  801f0e:	83 c4 10             	add    $0x10,%esp
  801f11:	85 c0                	test   %eax,%eax
  801f13:	79 16                	jns    801f2b <ipc_recv+0x3e>
		if (from_env_store)
  801f15:	85 f6                	test   %esi,%esi
  801f17:	74 06                	je     801f1f <ipc_recv+0x32>
			*from_env_store = 0;
  801f19:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801f1f:	85 db                	test   %ebx,%ebx
  801f21:	74 2c                	je     801f4f <ipc_recv+0x62>
			*perm_store = 0;
  801f23:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801f29:	eb 24                	jmp    801f4f <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801f2b:	85 f6                	test   %esi,%esi
  801f2d:	74 0a                	je     801f39 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  801f2f:	a1 20 44 80 00       	mov    0x804420,%eax
  801f34:	8b 40 74             	mov    0x74(%eax),%eax
  801f37:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  801f39:	85 db                	test   %ebx,%ebx
  801f3b:	74 0a                	je     801f47 <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  801f3d:	a1 20 44 80 00       	mov    0x804420,%eax
  801f42:	8b 40 78             	mov    0x78(%eax),%eax
  801f45:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  801f47:	a1 20 44 80 00       	mov    0x804420,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f5f:	8b 7d 08             	mov    0x8(%ebp),%edi
  801f62:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801f68:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  801f6a:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  ...
  801f76:	56                   	push   %esi
  801f77:	57                   	push   %edi
  801f78:	e8 95 ef ff ff       	call   800f12 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801f7d:	83 c4 10             	add    $0x10,%esp
  801f80:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801f83:	75 07                	jne    801f8c <ipc_send+0x36>
			sys_yield();
  801f85:	e8 dc ed ff ff       	call   800d66 <sys_yield>
  801f8a:	eb e6                	jmp    801f72 <ipc_send+0x1c>
		} else if (r < 0) {
  801f8c:	85 c0                	test   %eax,%eax
  801f8e:	79 12                	jns    801fa2 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801f90:	50                   	push   %eax
  801f91:	68 a6 27 80 00       	push   $0x8027a6
  801f96:	6a 51                	push   $0x51
  801f98:	68 b3 27 80 00       	push   $0x8027b3
  801f9d:	e8 82 e3 ff ff       	call   800324 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  801fd2:	83 c0 01             	add    $0x1,%eax
  801fd5:	3d 00 04 00 00       	cmp    $0x400,%eax
  801fda:	75 d9                	jne    801fb5 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801feb:	c1 e8 16             	shr    $0x16,%eax
  801fee:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801ffa:	f6 c1 01             	test   $0x1,%cl
  801ffd:	74 1d                	je     80201c <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801fff:	c1 ea 0c             	shr    $0xc,%edx
  802002:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  802009:	f6 c2 01             	test   $0x1,%dl
  80200c:	74 0e                	je     80201c <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  80200e:	c1 ea 0c             	shr    $0xc,%edx
  802011:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  802018:	ef 
  802019:	0f b7 c0             	movzwl %ax,%eax
}
  80201c:	5d                   	pop    %ebp
  80201d:	c3                   	ret    
