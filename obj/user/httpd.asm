...
handle_client(int sock)
{
  ...
  8000e0:	50                   	push   %eax
  8000e1:	e8 c0 1e 00 00       	call   801fa6 <malloc>
  ...
  80011e:	50                   	push   %eax
  80011f:	e8 82 1e 00 00       	call   801fa6 <malloc>
...
req_free(struct http_request *req)
{
  ...
  8001a4:	e8 4f 1d 00 00       	call   801ef8 <free>
	free(req->version);
  8001a9:	83 c4 04             	add    $0x4,%esp
  8001ac:	ff 75 e4             	pushl  -0x1c(%ebp)
  8001af:	e8 44 1d 00 00       	call   801ef8 <free>
...
umain(int argc, char **argv)
{
  ...
  8001e0:	e8 9b 1a 00 00       	call   801c80 <socket>
  ...
  800230:	53                   	push   %ebx
  800231:	56                   	push   %esi
  800232:	e8 b7 19 00 00       	call   801bee <bind>
  ...
  80024d:	56                   	push   %esi
  80024e:	e8 0a 1a 00 00       	call   801c5d <listen>
  ...
  800285:	50                   	push   %eax
  800286:	56                   	push   %esi
  800287:	e8 2b 19 00 00       	call   801bb7 <accept>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80061b:	e8 54 00 00 00       	call   800674 <vcprintf>
	cprintf("\n");
  800620:	c7 04 24 c1 30 80 00 	movl   $0x8030c1,(%esp)
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800956:	52                   	push   %edx
  800957:	68 fa 2f 80 00       	push   $0x802ffa
  80095c:	53                   	push   %ebx
  80095d:	56                   	push   %esi
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801332:	ba c8 2f 80 00       	mov    $0x802fc8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80135d:	51                   	push   %ecx
  80135e:	50                   	push   %eax
  80135f:	68 4c 2f 80 00       	push   $0x802f4c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801587:	53                   	push   %ebx
  801588:	50                   	push   %eax
  801589:	68 8d 2f 80 00       	push   $0x802f8d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80165c:	53                   	push   %ebx
  80165d:	50                   	push   %eax
  80165e:	68 a9 2f 80 00       	push   $0x802fa9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801711:	53                   	push   %ebx
  801712:	50                   	push   %eax
  801713:	68 6c 2f 80 00       	push   $0x802f6c
...
stat(const char *path, struct Stat *stat)
{
  ...
  8017dc:	e8 0c 02 00 00       	call   8019ed <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801823:	e8 fa 0e 00 00       	call   802722 <ipc_find_env>
  ...
  80183e:	e8 8b 0e 00 00       	call   8026ce <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801843:	83 c4 0c             	add    $0xc,%esp
  801846:	6a 00                	push   $0x0
  801848:	53                   	push   %ebx
  801849:	6a 00                	push   $0x0
  80184b:	e8 15 0e 00 00       	call   802665 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80190c:	89 15 00 60 80 00    	mov    %edx,0x806000
  801912:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801917:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  80191c:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  80191f:	89 1d 04 60 80 00    	mov    %ebx,0x806004
	
	memmove(fsipcbuf.write.req_buf, buf, n_real);
  801925:	53                   	push   %ebx
  801926:	ff 75 0c             	pushl  0xc(%ebp)
  801929:	68 08 60 80 00       	push   $0x806008
  80192e:	e8 a9 f4 ff ff       	call   800ddc <memmove>
  ...
  801947:	78 1d                	js     801966 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  801949:	39 d8                	cmp    %ebx,%eax
  80194b:	76 19                	jbe    801966 <devfile_write+0x6a>
  80194d:	68 dc 2f 80 00       	push   $0x802fdc
  801952:	68 e8 2f 80 00       	push   $0x802fe8
  801957:	68 a3 00 00 00       	push   $0xa3
  80195c:	68 fd 2f 80 00       	push   $0x802ffd
  801961:	e8 86 ec ff ff       	call   8005ec <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80197e:	89 35 04 60 80 00    	mov    %esi,0x806004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  801984:	ba 00 00 00 00       	mov    $0x0,%edx
  801989:	b8 03 00 00 00       	mov    $0x3,%eax
  80198e:	e8 79 fe ff ff       	call   80180c <fsipc>
  801993:	89 c3                	mov    %eax,%ebx
  801995:	85 c0                	test   %eax,%eax
  801997:	78 4b                	js     8019e4 <devfile_read+0x79>
		return r;
	assert(r <= n);
  801999:	39 c6                	cmp    %eax,%esi
  80199b:	73 16                	jae    8019b3 <devfile_read+0x48>
  80199d:	68 08 30 80 00       	push   $0x803008
  8019a2:	68 e8 2f 80 00       	push   $0x802fe8
  8019a7:	6a 7c                	push   $0x7c
  8019a9:	68 fd 2f 80 00       	push   $0x802ffd
  8019ae:	e8 39 ec ff ff       	call   8005ec <_panic>
	assert(r <= PGSIZE);
  8019b3:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8019b8:	7e 16                	jle    8019d0 <devfile_read+0x65>
  8019ba:	68 0f 30 80 00       	push   $0x80300f
  8019bf:	68 e8 2f 80 00       	push   $0x802fe8
  8019c4:	6a 7d                	push   $0x7d
  8019c6:	68 fd 2f 80 00       	push   $0x802ffd
  8019cb:	e8 1c ec ff ff       	call   8005ec <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8019d0:	83 ec 04             	sub    $0x4,%esp
  8019d3:	50                   	push   %eax
  8019d4:	68 00 60 80 00       	push   $0x806000
  8019d9:	ff 75 0c             	pushl  0xc(%ebp)
  8019dc:	e8 fb f3 ff ff       	call   800ddc <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8019f7:	53                   	push   %ebx
  8019f8:	e8 14 f2 ff ff       	call   800c11 <strlen>
  8019fd:	83 c4 10             	add    $0x10,%esp
  801a00:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801a05:	7f 67                	jg     801a6e <open+0x81>
		return -E_BAD_PATH;
  ...
  801a0d:	50                   	push   %eax
  801a0e:	e8 71 f8 ff ff       	call   801284 <fd_alloc>
  ...
  801a6c:	eb 05                	jmp    801a73 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  801a6e:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  801a8a:	e8 7d fd ff ff       	call   80180c <fsipc>
}
  801a8f:	c9                   	leave  
  801a90:	c3                   	ret    

00801a91 <devsock_stat>:
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a97:	68 1b 30 80 00       	push   $0x80301b
  801a9c:	ff 75 0c             	pushl  0xc(%ebp)
  801a9f:	e8 a6 f1 ff ff       	call   800c4a <strcpy>
	return 0;
}
...
devsock_close(struct Fd *fd)
{
  ...
  801ab2:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (pageref(fd) == 1)
  801ab5:	53                   	push   %ebx
  801ab6:	e8 a0 0c 00 00       	call   80275b <pageref>
...
devsock_close(struct Fd *fd)
{
  ...
  801ac6:	75 10                	jne    801ad8 <devsock_close+0x2d>
		return nsipc_close(fd->fd_sock.sockid);
  801ac8:	83 ec 0c             	sub    $0xc,%esp
  801acb:	ff 73 0c             	pushl  0xc(%ebx)
  801ace:	e8 c0 02 00 00       	call   801d93 <nsipc_close>
...
devsock_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801af0:	ff 70 0c             	pushl  0xc(%eax)
  801af3:	e8 78 03 00 00       	call   801e70 <nsipc_send>
}
  801af8:	c9                   	leave  
  801af9:	c3                   	ret    

00801afa <devsock_read>:
...
devsock_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801b0b:	ff 70 0c             	pushl  0xc(%eax)
  801b0e:	e8 f1 02 00 00       	call   801e04 <nsipc_recv>
}
  801b13:	c9                   	leave  
  801b14:	c3                   	ret    
...
fd2sockid(int fd)
{
  ...
  801b1b:	8d 55 f4             	lea    -0xc(%ebp),%edx
  801b1e:	52                   	push   %edx
  801b1f:	50                   	push   %eax
  801b20:	e8 ae f7 ff ff       	call   8012d3 <fd_lookup>
  801b25:	83 c4 10             	add    $0x10,%esp
  801b28:	85 c0                	test   %eax,%eax
  801b2a:	78 17                	js     801b43 <fd2sockid+0x2e>
		return r;
	if (sfd->fd_dev_id != devsock.dev_id)
  801b2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b2f:	8b 0d 40 40 80 00    	mov    0x804040,%ecx
  801b35:	39 08                	cmp    %ecx,(%eax)
  801b37:	75 05                	jne    801b3e <fd2sockid+0x29>
		return -E_NOT_SUPP;
	return sfd->fd_sock.sockid;
  801b39:	8b 40 0c             	mov    0xc(%eax),%eax
  801b3c:	eb 05                	jmp    801b43 <fd2sockid+0x2e>
	int r;
...
alloc_sockfd(int sockid)
{
  ...
  801ba7:	50                   	push   %eax
  801ba8:	e8 b0 f6 ff ff       	call   80125d <fd2num>
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801bc0:	e8 50 ff ff ff       	call   801b15 <fd2sockid>
		return r;
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801bc9:	78 1f                	js     801bea <accept+0x33>
		return r;
  ...
  801bd4:	50                   	push   %eax
  801bd5:	e8 12 01 00 00       	call   801cec <nsipc_accept>
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801be1:	78 07                	js     801bea <accept+0x33>
		return r;
	return alloc_sockfd(r);
  801be3:	e8 5d ff ff ff       	call   801b45 <alloc_sockfd>
...
bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801bf7:	e8 19 ff ff ff       	call   801b15 <fd2sockid>
  801bfc:	85 c0                	test   %eax,%eax
  801bfe:	78 12                	js     801c12 <bind+0x24>
		return r;
  ...
  801c09:	50                   	push   %eax
  801c0a:	e8 2d 01 00 00       	call   801d3c <nsipc_bind>
...
shutdown(int s, int how)
{
  ...
  801c1d:	e8 f3 fe ff ff       	call   801b15 <fd2sockid>
  801c22:	85 c0                	test   %eax,%eax
  801c24:	78 0f                	js     801c35 <shutdown+0x21>
		return r;
	return nsipc_shutdown(r, how);
  801c26:	83 ec 08             	sub    $0x8,%esp
  801c29:	ff 75 0c             	pushl  0xc(%ebp)
  801c2c:	50                   	push   %eax
  801c2d:	e8 3f 01 00 00       	call   801d71 <nsipc_shutdown>
...
connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801c40:	e8 d0 fe ff ff       	call   801b15 <fd2sockid>
  801c45:	85 c0                	test   %eax,%eax
  801c47:	78 12                	js     801c5b <connect+0x24>
		return r;
  ...
  801c52:	50                   	push   %eax
  801c53:	e8 55 01 00 00       	call   801dad <nsipc_connect>
...
listen(int s, int backlog)
{
  ...
  801c66:	e8 aa fe ff ff       	call   801b15 <fd2sockid>
  801c6b:	85 c0                	test   %eax,%eax
  801c6d:	78 0f                	js     801c7e <listen+0x21>
		return r;
	return nsipc_listen(r, backlog);
  801c6f:	83 ec 08             	sub    $0x8,%esp
  801c72:	ff 75 0c             	pushl  0xc(%ebp)
  801c75:	50                   	push   %eax
  801c76:	e8 67 01 00 00       	call   801de2 <nsipc_listen>
...
socket(int domain, int type, int protocol)
{
  ...
  801c8f:	e8 3a 02 00 00       	call   801ece <nsipc_socket>
  801c94:	83 c4 10             	add    $0x10,%esp
  801c97:	85 c0                	test   %eax,%eax
  801c99:	78 05                	js     801ca0 <socket+0x20>
		return r;
	return alloc_sockfd(r);
  801c9b:	e8 a5 fe ff ff       	call   801b45 <alloc_sockfd>
}
  801ca0:	c9                   	leave  
  801ca1:	c3                   	ret    
...
nsipc(unsigned type)
{
  ...
  801ca9:	89 c3                	mov    %eax,%ebx
	...
	if (nsenv == 0)
  801cab:	83 3d 14 50 80 00 00 	cmpl   $0x0,0x805014
  801cb2:	75 12                	jne    801cc6 <nsipc+0x24>
		nsenv = ipc_find_env(ENV_TYPE_NS);
  801cb4:	83 ec 0c             	sub    $0xc,%esp
  801cb7:	6a 02                	push   $0x2
  801cb9:	e8 64 0a 00 00       	call   802722 <ipc_find_env>
  801cbe:	a3 14 50 80 00       	mov    %eax,0x805014
  ...
  801cc8:	68 00 70 80 00       	push   $0x807000
  801ccd:	53                   	push   %ebx
  801cce:	ff 35 14 50 80 00    	pushl  0x805014
  801cd4:	e8 f5 09 00 00       	call   8026ce <ipc_send>
	return ipc_recv(NULL, NULL, NULL);
  801cd9:	83 c4 0c             	add    $0xc,%esp
  801cdc:	6a 00                	push   $0x0
  801cde:	6a 00                	push   $0x0
  801ce0:	6a 00                	push   $0x0
  801ce2:	e8 7e 09 00 00       	call   802665 <ipc_recv>
}
  801ce7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801cea:	c9                   	leave  
  801ceb:	c3                   	ret    

00801cec <nsipc_accept>:
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801cef:	56                   	push   %esi
  801cf0:	53                   	push   %ebx
  801cf1:	8b 75 10             	mov    0x10(%ebp),%esi
	int r;
  ...
  801cfc:	8b 06                	mov    (%esi),%eax
  801cfe:	a3 04 70 80 00       	mov    %eax,0x807004
	if ((r = nsipc(NSREQ_ACCEPT)) >= 0) {
  801d03:	b8 01 00 00 00       	mov    $0x1,%eax
  801d08:	e8 95 ff ff ff       	call   801ca2 <nsipc>
  801d0d:	89 c3                	mov    %eax,%ebx
  801d0f:	85 c0                	test   %eax,%eax
  801d11:	78 20                	js     801d33 <nsipc_accept+0x47>
		struct Nsret_accept *ret = &nsipcbuf.acceptRet;
		memmove(addr, &ret->ret_addr, ret->ret_addrlen);
  801d13:	83 ec 04             	sub    $0x4,%esp
  801d16:	ff 35 10 70 80 00    	pushl  0x807010
  801d1c:	68 00 70 80 00       	push   $0x807000
  801d21:	ff 75 0c             	pushl  0xc(%ebp)
  801d24:	e8 b3 f0 ff ff       	call   800ddc <memmove>
		*addrlen = ret->ret_addrlen;
  801d29:	a1 10 70 80 00       	mov    0x807010,%eax
  801d2e:	89 06                	mov    %eax,(%esi)
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801d52:	68 04 70 80 00       	push   $0x807004
  801d57:	e8 80 f0 ff ff       	call   800ddc <memmove>
	nsipcbuf.bind.req_namelen = namelen;
  801d5c:	89 1d 14 70 80 00    	mov    %ebx,0x807014
	return nsipc(NSREQ_BIND);
  801d62:	b8 02 00 00 00       	mov    $0x2,%eax
  801d67:	e8 36 ff ff ff       	call   801ca2 <nsipc>
}
  801d6c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801d6f:	c9                   	leave  
  801d70:	c3                   	ret    

00801d71 <nsipc_shutdown>:
...
nsipc_shutdown(int s, int how)
{
  ...
  801d7a:	a3 00 70 80 00       	mov    %eax,0x807000
	nsipcbuf.shutdown.req_how = how;
  801d7f:	8b 45 0c             	mov    0xc(%ebp),%eax
  801d82:	a3 04 70 80 00       	mov    %eax,0x807004
	return nsipc(NSREQ_SHUTDOWN);
  801d87:	b8 03 00 00 00       	mov    $0x3,%eax
  801d8c:	e8 11 ff ff ff       	call   801ca2 <nsipc>
}
  801d91:	c9                   	leave  
  801d92:	c3                   	ret    

00801d93 <nsipc_close>:
...
nsipc_close(int s)
{
  ...
  801d9c:	a3 00 70 80 00       	mov    %eax,0x807000
	return nsipc(NSREQ_CLOSE);
  801da1:	b8 04 00 00 00       	mov    $0x4,%eax
  801da6:	e8 f7 fe ff ff       	call   801ca2 <nsipc>
}
  801dab:	c9                   	leave  
  801dac:	c3                   	ret    

00801dad <nsipc_connect>:
...
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801dba:	a3 00 70 80 00       	mov    %eax,0x807000
	memmove(&nsipcbuf.connect.req_name, name, namelen);
  801dbf:	53                   	push   %ebx
  801dc0:	ff 75 0c             	pushl  0xc(%ebp)
  801dc3:	68 04 70 80 00       	push   $0x807004
  801dc8:	e8 0f f0 ff ff       	call   800ddc <memmove>
	nsipcbuf.connect.req_namelen = namelen;
  801dcd:	89 1d 14 70 80 00    	mov    %ebx,0x807014
	return nsipc(NSREQ_CONNECT);
  801dd3:	b8 05 00 00 00       	mov    $0x5,%eax
  801dd8:	e8 c5 fe ff ff       	call   801ca2 <nsipc>
}
  801ddd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801de0:	c9                   	leave  
  801de1:	c3                   	ret    

00801de2 <nsipc_listen>:
...
nsipc_listen(int s, int backlog)
{
  ...
  801df3:	a3 04 70 80 00       	mov    %eax,0x807004
	return nsipc(NSREQ_LISTEN);
  801df8:	b8 06 00 00 00       	mov    $0x6,%eax
  801dfd:	e8 a0 fe ff ff       	call   801ca2 <nsipc>
}
  801e02:	c9                   	leave  
  801e03:	c3                   	ret    
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801e0f:	a3 00 70 80 00       	mov    %eax,0x807000
	nsipcbuf.recv.req_len = len;
  801e14:	89 35 04 70 80 00    	mov    %esi,0x807004
  ...
  801e27:	e8 76 fe ff ff       	call   801ca2 <nsipc>
  801e2c:	89 c3                	mov    %eax,%ebx
  801e2e:	85 c0                	test   %eax,%eax
  801e30:	78 35                	js     801e67 <nsipc_recv+0x63>
		assert(r < 1600 && r <= len);
  801e32:	3d 3f 06 00 00       	cmp    $0x63f,%eax
  801e37:	7f 04                	jg     801e3d <nsipc_recv+0x39>
  801e39:	39 c6                	cmp    %eax,%esi
  801e3b:	7d 16                	jge    801e53 <nsipc_recv+0x4f>
  801e3d:	68 27 30 80 00       	push   $0x803027
  801e42:	68 e8 2f 80 00       	push   $0x802fe8
  801e47:	6a 62                	push   $0x62
  801e49:	68 3c 30 80 00       	push   $0x80303c
  801e4e:	e8 99 e7 ff ff       	call   8005ec <_panic>
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  801e53:	83 ec 04             	sub    $0x4,%esp
  801e56:	50                   	push   %eax
  801e57:	68 00 70 80 00       	push   $0x807000
  801e5c:	ff 75 0c             	pushl  0xc(%ebp)
  801e5f:	e8 78 ef ff ff       	call   800ddc <memmove>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801e7d:	a3 00 70 80 00       	mov    %eax,0x807000
	assert(size < 1600);
  801e82:	81 fb 3f 06 00 00    	cmp    $0x63f,%ebx
  801e88:	7e 16                	jle    801ea0 <nsipc_send+0x30>
  801e8a:	68 48 30 80 00       	push   $0x803048
  801e8f:	68 e8 2f 80 00       	push   $0x802fe8
  801e94:	6a 6d                	push   $0x6d
  801e96:	68 3c 30 80 00       	push   $0x80303c
  801e9b:	e8 4c e7 ff ff       	call   8005ec <_panic>
	memmove(&nsipcbuf.send.req_buf, buf, size);
  801ea0:	83 ec 04             	sub    $0x4,%esp
  801ea3:	53                   	push   %ebx
  801ea4:	ff 75 0c             	pushl  0xc(%ebp)
  801ea7:	68 0c 70 80 00       	push   $0x80700c
  801eac:	e8 2b ef ff ff       	call   800ddc <memmove>
	nsipcbuf.send.req_size = size;
  801eb1:	89 1d 04 70 80 00    	mov    %ebx,0x807004
	nsipcbuf.send.req_flags = flags;
  801eb7:	8b 45 14             	mov    0x14(%ebp),%eax
  801eba:	a3 08 70 80 00       	mov    %eax,0x807008
	return nsipc(NSREQ_SEND);
  801ebf:	b8 08 00 00 00       	mov    $0x8,%eax
  801ec4:	e8 d9 fd ff ff       	call   801ca2 <nsipc>
}
...
nsipc_socket(int domain, int type, int protocol)
{
  ...
  801edf:	a3 04 70 80 00       	mov    %eax,0x807004
	nsipcbuf.socket.req_protocol = protocol;
  801ee4:	8b 45 10             	mov    0x10(%ebp),%eax
  801ee7:	a3 08 70 80 00       	mov    %eax,0x807008
	return nsipc(NSREQ_SOCKET);
  801eec:	b8 09 00 00 00       	mov    $0x9,%eax
  801ef1:	e8 ac fd ff ff       	call   801ca2 <nsipc>
}
  801ef6:	c9                   	leave  
  801ef7:	c3                   	ret    
...
free(void *v)
{
  ...
  801f04:	0f 84 97 00 00 00    	je     801fa1 <free+0xa9>
		return;
	assert(mbegin <= (uint8_t*) v && (uint8_t*) v < mend);
  801f0a:	8d 83 00 00 00 f8    	lea    -0x8000000(%ebx),%eax
  801f10:	3d ff ff ff 07       	cmp    $0x7ffffff,%eax
  801f15:	76 16                	jbe    801f2d <free+0x35>
  801f17:	68 54 30 80 00       	push   $0x803054
  801f1c:	68 e8 2f 80 00       	push   $0x802fe8
  801f21:	6a 7a                	push   $0x7a
  801f23:	68 84 30 80 00       	push   $0x803084
  801f28:	e8 bf e6 ff ff       	call   8005ec <_panic>

	c = ROUNDDOWN(v, PGSIZE);
  801f2d:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx

	while (uvpt[PGNUM(c)] & PTE_CONTINUED) {
  801f33:	eb 3a                	jmp    801f6f <free+0x77>
		sys_page_unmap(0, c);
  801f35:	83 ec 08             	sub    $0x8,%esp
  801f38:	53                   	push   %ebx
  801f39:	6a 00                	push   $0x0
  801f3b:	e8 92 f1 ff ff       	call   8010d2 <sys_page_unmap>
		c += PGSIZE;
  801f40:	81 c3 00 10 00 00    	add    $0x1000,%ebx
		assert(mbegin <= c && c < mend);
  801f46:	8d 83 00 00 00 f8    	lea    -0x8000000(%ebx),%eax
  801f4c:	83 c4 10             	add    $0x10,%esp
  801f4f:	3d ff ff ff 07       	cmp    $0x7ffffff,%eax
  801f54:	76 19                	jbe    801f6f <free+0x77>
  801f56:	68 91 30 80 00       	push   $0x803091
  801f5b:	68 e8 2f 80 00       	push   $0x802fe8
  801f60:	68 81 00 00 00       	push   $0x81
  801f65:	68 84 30 80 00       	push   $0x803084
  801f6a:	e8 7d e6 ff ff       	call   8005ec <_panic>
		return;
	assert(mbegin <= (uint8_t*) v && (uint8_t*) v < mend);
  ...
  801f7b:	f6 c4 02             	test   $0x2,%ah
  801f7e:	75 b5                	jne    801f35 <free+0x3d>
	/*
	...
	if (--(*ref) == 0)
  801f80:	8b 83 fc 0f 00 00    	mov    0xffc(%ebx),%eax
  801f86:	83 e8 01             	sub    $0x1,%eax
  801f89:	89 83 fc 0f 00 00    	mov    %eax,0xffc(%ebx)
  801f8f:	85 c0                	test   %eax,%eax
  801f91:	75 0e                	jne    801fa1 <free+0xa9>
		sys_page_unmap(0, c);
  801f93:	83 ec 08             	sub    $0x8,%esp
  801f96:	53                   	push   %ebx
  801f97:	6a 00                	push   $0x0
  801f99:	e8 34 f1 ff ff       	call   8010d2 <sys_page_unmap>
...
malloc(size_t n)
{
  ...
  801fac:	83 ec 1c             	sub    $0x1c,%esp
	...
	if (mptr == 0)
  801faf:	a1 18 50 80 00       	mov    0x805018,%eax
  801fb4:	85 c0                	test   %eax,%eax
  801fb6:	75 22                	jne    801fda <malloc+0x34>
		mptr = mbegin;
  801fb8:	c7 05 18 50 80 00 00 	movl   $0x8000000,0x805018
  801fbf:	00 00 08 

	n = ROUNDUP(n, 4);
  801fc2:	8b 45 08             	mov    0x8(%ebp),%eax
  801fc5:	83 c0 03             	add    $0x3,%eax
  801fc8:	83 e0 fc             	and    $0xfffffffc,%eax
  801fcb:	89 45 dc             	mov    %eax,-0x24(%ebp)

	if (n >= MAXMALLOC)
  801fce:	3d ff ff 0f 00       	cmp    $0xfffff,%eax
  801fd3:	76 74                	jbe    802049 <malloc+0xa3>
  801fd5:	e9 7a 01 00 00       	jmp    802154 <malloc+0x1ae>
	void *v;
  ...
  801fdd:	8d 53 03             	lea    0x3(%ebx),%edx
  801fe0:	83 e2 fc             	and    $0xfffffffc,%edx
  801fe3:	89 55 dc             	mov    %edx,-0x24(%ebp)

	if (n >= MAXMALLOC)
  801fe6:	81 fa ff ff 0f 00    	cmp    $0xfffff,%edx
  801fec:	0f 87 69 01 00 00    	ja     80215b <malloc+0x1b5>
		return 0;

	if ((uintptr_t) mptr % PGSIZE){
  801ff2:	a9 ff 0f 00 00       	test   $0xfff,%eax
  801ff7:	74 50                	je     802049 <malloc+0xa3>
  ...
  801ffb:	c1 e9 0c             	shr    $0xc,%ecx
  801ffe:	8d 54 10 03          	lea    0x3(%eax,%edx,1),%edx
  802002:	c1 ea 0c             	shr    $0xc,%edx
  802005:	39 d1                	cmp    %edx,%ecx
  802007:	75 20                	jne    802029 <malloc+0x83>
		/*
		 * we're in the middle of a partially
		 * allocated page - can we add this chunk?
		 * the +4 below is for the ref count.
		 */
		ref = (uint32_t*) (ROUNDUP(mptr, PGSIZE) - 4);
  802009:	8d 90 ff 0f 00 00    	lea    0xfff(%eax),%edx
  80200f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
		if ((uintptr_t) mptr / PGSIZE == (uintptr_t) (mptr + n - 1 + 4) / PGSIZE) {
			(*ref)++;
  802015:	83 42 fc 01          	addl   $0x1,-0x4(%edx)
			v = mptr;
			mptr += n;
  802019:	8b 55 dc             	mov    -0x24(%ebp),%edx
  80201c:	01 c2                	add    %eax,%edx
  80201e:	89 15 18 50 80 00    	mov    %edx,0x805018
			return v;
  802024:	e9 55 01 00 00       	jmp    80217e <malloc+0x1d8>
		}
		/*
  ...
  80202c:	50                   	push   %eax
  80202d:	e8 c6 fe ff ff       	call   801ef8 <free>
		mptr = ROUNDDOWN(mptr + PGSIZE, PGSIZE);
  802032:	a1 18 50 80 00       	mov    0x805018,%eax
  802037:	05 00 10 00 00       	add    $0x1000,%eax
  80203c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  802041:	a3 18 50 80 00       	mov    %eax,0x805018
  802046:	83 c4 10             	add    $0x10,%esp
  802049:	8b 35 18 50 80 00    	mov    0x805018,%esi
	return 1;
}
...
malloc(size_t n)
{
  80204f:	c7 45 d8 02 00 00 00 	movl   $0x2,-0x28(%ebp)
  802056:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
  ...
  802060:	89 75 e0             	mov    %esi,-0x20(%ebp)
  802063:	89 fb                	mov    %edi,%ebx
  802065:	8d 0c 37             	lea    (%edi,%esi,1),%ecx
static int
isfree(void *v, size_t n)
{
  ...
  80206a:	eb 36                	jmp    8020a2 <malloc+0xfc>
		if (va >= (uintptr_t) mend
  80206c:	3d ff ff ff 0f       	cmp    $0xfffffff,%eax
  802071:	0f 87 eb 00 00 00    	ja     802162 <malloc+0x1bc>
		    || ((uvpd[PDX(va)] & PTE_P) && (uvpt[PGNUM(va)] & PTE_P)))
  802077:	89 c2                	mov    %eax,%edx
  802079:	c1 ea 16             	shr    $0x16,%edx
  80207c:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  802083:	f6 c2 01             	test   $0x1,%dl
  802086:	74 15                	je     80209d <malloc+0xf7>
  ...
  802097:	0f 85 c5 00 00 00    	jne    802162 <malloc+0x1bc>
static int
isfree(void *v, size_t n)
{
	uintptr_t va, end_va = (uintptr_t) v + n;
	...
	for (va = (uintptr_t) v; va < end_va; va += PGSIZE)
  80209d:	05 00 10 00 00       	add    $0x1000,%eax
  8020a2:	39 c8                	cmp    %ecx,%eax
  8020a4:	72 c6                	jb     80206c <malloc+0xc6>
  8020a6:	eb 79                	jmp    802121 <malloc+0x17b>
	while (1) {
		if (isfree(mptr, n + 4))
			break;
		mptr += PGSIZE;
		if (mptr == mend) {
			mptr = mbegin;
  8020a8:	be 00 00 00 08       	mov    $0x8000000,%esi
  8020ad:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
			if (++nwrap == 2)
  8020b1:	83 6d d8 01          	subl   $0x1,-0x28(%ebp)
  8020b5:	75 a9                	jne    802060 <malloc+0xba>
  8020b7:	c7 05 18 50 80 00 00 	movl   $0x8000000,0x805018
  8020be:	00 00 08 
				return 0;	/* out of address space */
  8020c1:	b8 00 00 00 00       	mov    $0x0,%eax
  8020c6:	e9 b3 00 00 00       	jmp    80217e <malloc+0x1d8>
  ...
  8020cb:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
  8020d1:	39 df                	cmp    %ebx,%edi
  8020d3:	19 c0                	sbb    %eax,%eax
  8020d5:	25 00 02 00 00       	and    $0x200,%eax
		if (sys_page_alloc(0, mptr + i, PTE_P|PTE_U|PTE_W|cont) < 0){
  8020da:	83 ec 04             	sub    $0x4,%esp
  8020dd:	83 c8 07             	or     $0x7,%eax
  8020e0:	50                   	push   %eax
  8020e1:	03 15 18 50 80 00    	add    0x805018,%edx
  8020e7:	52                   	push   %edx
  8020e8:	6a 00                	push   $0x0
  8020ea:	e8 5e ef ff ff       	call   80104d <sys_page_alloc>
  8020ef:	83 c4 10             	add    $0x10,%esp
  8020f2:	85 c0                	test   %eax,%eax
  8020f4:	78 20                	js     802116 <malloc+0x170>
	}
	 ...
	 */
	for (i = 0; i < n + 4; i += PGSIZE){
  8020f6:	89 fe                	mov    %edi,%esi
  8020f8:	eb 3a                	jmp    802134 <malloc+0x18e>
		cont = (i + PGSIZE < n + 4) ? PTE_CONTINUED : 0;
		if (sys_page_alloc(0, mptr + i, PTE_P|PTE_U|PTE_W|cont) < 0){
			for (; i >= 0; i -= PGSIZE)
  ...
  8020ff:	03 05 18 50 80 00    	add    0x805018,%eax
  802105:	50                   	push   %eax
  802106:	6a 00                	push   $0x0
  802108:	e8 c5 ef ff ff       	call   8010d2 <sys_page_unmap>
	 * allocate at mptr - the +4 makes sure we allocate a ref count.
	 */
	for (i = 0; i < n + 4; i += PGSIZE){
		cont = (i + PGSIZE < n + 4) ? PTE_CONTINUED : 0;
		if (sys_page_alloc(0, mptr + i, PTE_P|PTE_U|PTE_W|cont) < 0){
			for (; i >= 0; i -= PGSIZE)
  80210d:	81 ee 00 10 00 00    	sub    $0x1000,%esi
  802113:	83 c4 10             	add    $0x10,%esp
  802116:	85 f6                	test   %esi,%esi
  802118:	79 e0                	jns    8020fa <malloc+0x154>
				sys_page_unmap(0, mptr + i);
			return 0;	/* out of physical memory */
  80211a:	b8 00 00 00 00       	mov    $0x0,%eax
  80211f:	eb 5d                	jmp    80217e <malloc+0x1d8>
  802121:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  802125:	74 08                	je     80212f <malloc+0x189>
  802127:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80212a:	a3 18 50 80 00       	mov    %eax,0x805018
	...
	for (i = 0; i < n + 4; i += PGSIZE){
		cont = (i + PGSIZE < n + 4) ? PTE_CONTINUED : 0;
  80212f:	be 00 00 00 00       	mov    $0x0,%esi
	}
  ...
  802136:	39 f3                	cmp    %esi,%ebx
  802138:	77 91                	ja     8020cb <malloc+0x125>
				sys_page_unmap(0, mptr + i);
			return 0;	/* out of physical memory */
		}
	}
  ...
  80213a:	a1 18 50 80 00       	mov    0x805018,%eax
	*ref = 2;	/* reference for mptr, reference for returned block */
  80213f:	c7 44 30 fc 02 00 00 	movl   $0x2,-0x4(%eax,%esi,1)
  802146:	00 
	v = mptr;
	mptr += n;
  802147:	8b 55 dc             	mov    -0x24(%ebp),%edx
  80214a:	01 c2                	add    %eax,%edx
  80214c:	89 15 18 50 80 00    	mov    %edx,0x805018
	return v;
  802152:	eb 2a                	jmp    80217e <malloc+0x1d8>
		mptr = mbegin;
  ...
  802159:	eb 23                	jmp    80217e <malloc+0x1d8>
  80215b:	b8 00 00 00 00       	mov    $0x0,%eax
  802160:	eb 1c                	jmp    80217e <malloc+0x1d8>
  802162:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
  802168:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
  80216c:	89 c6                	mov    %eax,%esi
	...
	while (1) {
		...
		mptr += PGSIZE;
		if (mptr == mend) {
  80216e:	3d 00 00 00 10       	cmp    $0x10000000,%eax
  802173:	0f 85 e7 fe ff ff    	jne    802060 <malloc+0xba>
  802179:	e9 2a ff ff ff       	jmp    8020a8 <malloc+0x102>
	ref = (uint32_t*) (mptr + i - 4);
	*ref = 2;	/* reference for mptr, reference for returned block */
	v = mptr;
	mptr += n;
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802189:	56                   	push   %esi
  80218a:	53                   	push   %ebx
  80218b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	struct Pipe *p = (struct Pipe*) fd2data(fd);
  80218e:	83 ec 0c             	sub    $0xc,%esp
  802191:	ff 75 08             	pushl  0x8(%ebp)
  802194:	e8 d4 f0 ff ff       	call   80126d <fd2data>
  802199:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  80219b:	83 c4 08             	add    $0x8,%esp
  80219e:	68 a9 30 80 00       	push   $0x8030a9
  8021a3:	53                   	push   %ebx
  8021a4:	e8 a1 ea ff ff       	call   800c4a <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  8021a9:	8b 46 04             	mov    0x4(%esi),%eax
  8021ac:	2b 06                	sub    (%esi),%eax
  8021ae:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  8021b4:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  8021bb:	00 00 00 
	stat->st_dev = &devpipe;
  8021be:	c7 83 88 00 00 00 5c 	movl   $0x80405c,0x88(%ebx)
  8021c5:	40 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8021db:	8b 5d 08             	mov    0x8(%ebp),%ebx
	(void) sys_page_unmap(0, fd);
  8021de:	53                   	push   %ebx
  8021df:	6a 00                	push   $0x0
  8021e1:	e8 ec ee ff ff       	call   8010d2 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8021e6:	89 1c 24             	mov    %ebx,(%esp)
  8021e9:	e8 7f f0 ff ff       	call   80126d <fd2data>
  8021ee:	83 c4 08             	add    $0x8,%esp
  8021f1:	50                   	push   %eax
  8021f2:	6a 00                	push   $0x0
  8021f4:	e8 d9 ee ff ff       	call   8010d2 <sys_page_unmap>
}
  8021f9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8021fc:	c9                   	leave  
  8021fd:	c3                   	ret    

008021fe <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  802207:	89 45 e0             	mov    %eax,-0x20(%ebp)
  80220a:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  80220c:	a1 1c 50 80 00       	mov    0x80501c,%eax
  802211:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  802214:	83 ec 0c             	sub    $0xc,%esp
  802217:	ff 75 e0             	pushl  -0x20(%ebp)
  80221a:	e8 3c 05 00 00       	call   80275b <pageref>
  80221f:	89 c3                	mov    %eax,%ebx
  802221:	89 3c 24             	mov    %edi,(%esp)
  802224:	e8 32 05 00 00       	call   80275b <pageref>
  802229:	83 c4 10             	add    $0x10,%esp
  80222c:	39 c3                	cmp    %eax,%ebx
  80222e:	0f 94 c1             	sete   %cl
  802231:	0f b6 c9             	movzbl %cl,%ecx
  802234:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  802237:	8b 15 1c 50 80 00    	mov    0x80501c,%edx
  80223d:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  802240:	39 ce                	cmp    %ecx,%esi
  802242:	74 1b                	je     80225f <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  802244:	39 c3                	cmp    %eax,%ebx
  802246:	75 c4                	jne    80220c <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  802248:	8b 42 58             	mov    0x58(%edx),%eax
  80224b:	ff 75 e4             	pushl  -0x1c(%ebp)
  80224e:	50                   	push   %eax
  80224f:	56                   	push   %esi
  802250:	68 b0 30 80 00       	push   $0x8030b0
  802255:	e8 6b e4 ff ff       	call   8006c5 <cprintf>
  80225a:	83 c4 10             	add    $0x10,%esp
  80225d:	eb ad                	jmp    80220c <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  802276:	56                   	push   %esi
  802277:	e8 f1 ef ff ff       	call   80126d <fd2data>
  ...
  802286:	eb 4b                	jmp    8022d3 <devpipe_write+0x69>
  ...
  80228c:	e8 6d ff ff ff       	call   8021fe <_pipeisclosed>
  802291:	85 c0                	test   %eax,%eax
  802293:	75 48                	jne    8022dd <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  802295:	e8 94 ed ff ff       	call   80102e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  80229a:	8b 43 04             	mov    0x4(%ebx),%eax
  80229d:	8b 0b                	mov    (%ebx),%ecx
  80229f:	8d 51 20             	lea    0x20(%ecx),%edx
  8022a2:	39 d0                	cmp    %edx,%eax
  8022a4:	73 e2                	jae    802288 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  8022a9:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  8022ad:	88 4d e7             	mov    %cl,-0x19(%ebp)
  8022b0:	89 c2                	mov    %eax,%edx
  8022b2:	c1 fa 1f             	sar    $0x1f,%edx
  8022b5:	89 d1                	mov    %edx,%ecx
  8022b7:	c1 e9 1b             	shr    $0x1b,%ecx
  8022ba:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  8022bd:	83 e2 1f             	and    $0x1f,%edx
  8022c0:	29 ca                	sub    %ecx,%edx
  8022c2:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  8022c6:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  8022ca:	83 c0 01             	add    $0x1,%eax
  8022cd:	89 43 04             	mov    %eax,0x4(%ebx)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  8022d0:	83 c7 01             	add    $0x1,%edi
  8022d3:	3b 7d 10             	cmp    0x10(%ebp),%edi
  8022d6:	75 c2                	jne    80229a <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  8022db:	eb 05                	jmp    8022e2 <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8022f3:	8b 7d 08             	mov    0x8(%ebp),%edi
	uint8_t *buf;
	size_t i;
	struct Pipe *p;
	...
	p = (struct Pipe*)fd2data(fd);
  8022f6:	57                   	push   %edi
  8022f7:	e8 71 ef ff ff       	call   80126d <fd2data>
  ...
  802306:	eb 3d                	jmp    802345 <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  802308:	85 db                	test   %ebx,%ebx
  80230a:	74 04                	je     802310 <devpipe_read+0x26>
				return i;
  80230c:	89 d8                	mov    %ebx,%eax
  80230e:	eb 44                	jmp    802354 <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  802310:	89 f2                	mov    %esi,%edx
  802312:	89 f8                	mov    %edi,%eax
  802314:	e8 e5 fe ff ff       	call   8021fe <_pipeisclosed>
  802319:	85 c0                	test   %eax,%eax
  80231b:	75 32                	jne    80234f <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  80231d:	e8 0c ed ff ff       	call   80102e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  802322:	8b 06                	mov    (%esi),%eax
  802324:	3b 46 04             	cmp    0x4(%esi),%eax
  802327:	74 df                	je     802308 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  802329:	99                   	cltd   
  80232a:	c1 ea 1b             	shr    $0x1b,%edx
  80232d:	01 d0                	add    %edx,%eax
  80232f:	83 e0 1f             	and    $0x1f,%eax
  802332:	29 d0                	sub    %edx,%eax
  802334:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  802339:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80233c:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  80233f:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  802342:	83 c3 01             	add    $0x1,%ebx
  802345:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  802348:	75 d8                	jne    802322 <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  80234d:	eb 05                	jmp    802354 <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  8023d7:	e8 91 ee ff ff       	call   80126d <fd2data>
  ...
  8023e9:	e8 5f ec ff ff       	call   80104d <sys_page_alloc>
  8023ee:	89 c3                	mov    %eax,%ebx
  8023f0:	83 c4 10             	add    $0x10,%esp
  8023f3:	85 c0                	test   %eax,%eax
  8023f5:	0f 88 89 00 00 00    	js     802484 <pipe+0x128>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  8023fb:	83 ec 0c             	sub    $0xc,%esp
  8023fe:	ff 75 f0             	pushl  -0x10(%ebp)
  802401:	e8 67 ee ff ff       	call   80126d <fd2data>
  802406:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  80240d:	50                   	push   %eax
  80240e:	6a 00                	push   $0x0
  802410:	56                   	push   %esi
  802411:	6a 00                	push   $0x0
  802413:	e8 78 ec ff ff       	call   801090 <sys_page_map>
  802418:	89 c3                	mov    %eax,%ebx
  80241a:	83 c4 20             	add    $0x20,%esp
  80241d:	85 c0                	test   %eax,%eax
  80241f:	78 55                	js     802476 <pipe+0x11a>
		goto err3;

	// set up fd structures
	fd0->fd_dev_id = devpipe.dev_id;
  802421:	8b 15 5c 40 80 00    	mov    0x80405c,%edx
  802427:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80242a:	89 10                	mov    %edx,(%eax)
	fd0->fd_omode = O_RDONLY;
  80242c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80242f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	fd1->fd_dev_id = devpipe.dev_id;
  802436:	8b 15 5c 40 80 00    	mov    0x80405c,%edx
  ...
  802474:	eb 30                	jmp    8024a6 <pipe+0x14a>
  ...
  80247c:	e8 51 ec ff ff       	call   8010d2 <sys_page_unmap>
  ...
  80248c:	e8 41 ec ff ff       	call   8010d2 <sys_page_unmap>
  ...
  80249c:	e8 31 ec ff ff       	call   8010d2 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  8024b2:	83 ec 20             	sub    $0x20,%esp
	struct Fd *fd;
	struct Pipe *p;
	int r;

	if ((r = fd_lookup(fdnum, &fd)) < 0)
  8024b5:	8d 45 f4             	lea    -0xc(%ebp),%eax
  8024b8:	50                   	push   %eax
  8024b9:	ff 75 08             	pushl  0x8(%ebp)
  8024bc:	e8 12 ee ff ff       	call   8012d3 <fd_lookup>
  8024c1:	83 c4 10             	add    $0x10,%esp
  8024c4:	85 c0                	test   %eax,%eax
  8024c6:	78 18                	js     8024e0 <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  8024c8:	83 ec 0c             	sub    $0xc,%esp
  8024cb:	ff 75 f4             	pushl  -0xc(%ebp)
  8024ce:	e8 9a ed ff ff       	call   80126d <fd2data>
	return _pipeisclosed(fd, p);
  8024d3:	89 c2                	mov    %eax,%edx
  8024d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024d8:	e8 21 fd ff ff       	call   8021fe <_pipeisclosed>
  8024dd:	83 c4 10             	add    $0x10,%esp
}
  8024e0:	c9                   	leave  
  8024e1:	c3                   	ret    

008024e2 <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8024f2:	68 c8 30 80 00       	push   $0x8030c8
  8024f7:	ff 75 0c             	pushl  0xc(%ebp)
  8024fa:	e8 4b e7 ff ff       	call   800c4a <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80250a:	56                   	push   %esi
  80250b:	53                   	push   %ebx
  80250c:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
  802512:	be 00 00 00 00       	mov    $0x0,%esi
		m = n - tot;
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  802517:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  80251d:	eb 2d                	jmp    80254c <devcons_write+0x46>
		m = n - tot;
  80251f:	8b 5d 10             	mov    0x10(%ebp),%ebx
  802522:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  802524:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  802527:	ba 7f 00 00 00       	mov    $0x7f,%edx
  80252c:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  802536:	50                   	push   %eax
  802537:	57                   	push   %edi
  802538:	e8 9f e8 ff ff       	call   800ddc <memmove>
		sys_cputs(buf, m);
  80253d:	83 c4 08             	add    $0x8,%esp
  802540:	53                   	push   %ebx
  802541:	57                   	push   %edi
  802542:	e8 4a ea ff ff       	call   800f91 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80256a:	74 2a                	je     802596 <devcons_read+0x3b>
  80256c:	eb 05                	jmp    802573 <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  80256e:	e8 bb ea ff ff       	call   80102e <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  802573:	e8 37 ea ff ff       	call   800faf <sys_cgetc>
  802578:	85 c0                	test   %eax,%eax
  80257a:	74 f2                	je     80256e <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  80257c:	85 c0                	test   %eax,%eax
  80257e:	78 16                	js     802596 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  802580:	83 f8 04             	cmp    $0x4,%eax
  802583:	74 0c                	je     802591 <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  802585:	8b 55 0c             	mov    0xc(%ebp),%edx
  802588:	88 02                	mov    %al,(%edx)
	return 1;
  80258a:	b8 01 00 00 00       	mov    $0x1,%eax
  80258f:	eb 05                	jmp    802596 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  8025a1:	88 45 f7             	mov    %al,-0x9(%ebp)

	// Unlike standard Unix's putchar,
	// the cputchar function _always_ outputs to the system console.
	sys_cputs(&c, 1);
  8025a4:	6a 01                	push   $0x1
  8025a6:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8025a9:	50                   	push   %eax
  8025aa:	e8 e2 e9 ff ff       	call   800f91 <sys_cputs>
}
...
getchar(void)
{
  ...
  8025b7:	83 ec 1c             	sub    $0x1c,%esp
	...
	r = read(0, &c, 1);
  8025ba:	6a 01                	push   $0x1
  8025bc:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8025bf:	50                   	push   %eax
  8025c0:	6a 00                	push   $0x0
  8025c2:	e8 72 ef ff ff       	call   801539 <read>
	if (r < 0)
  8025c7:	83 c4 10             	add    $0x10,%esp
  8025ca:	85 c0                	test   %eax,%eax
  8025cc:	78 0f                	js     8025dd <getchar+0x29>
		return r;
	if (r < 1)
  8025ce:	85 c0                	test   %eax,%eax
  8025d0:	7e 06                	jle    8025d8 <getchar+0x24>
		return -E_EOF;
	return c;
  8025d2:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  8025d6:	eb 05                	jmp    8025dd <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  8025d8:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  8025dd:	c9                   	leave  
  8025de:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8025ec:	e8 e2 ec ff ff       	call   8012d3 <fd_lookup>
  8025f1:	83 c4 10             	add    $0x10,%esp
  8025f4:	85 c0                	test   %eax,%eax
  8025f6:	78 11                	js     802609 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  8025f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8025fb:	8b 15 78 40 80 00    	mov    0x804078,%edx
...
opencons(void)
{
  ...
  802614:	50                   	push   %eax
  802615:	e8 6a ec ff ff       	call   801284 <fd_alloc>
...
opencons(void)
{
  ...
  802621:	78 3e                	js     802661 <opencons+0x56>
		return r;
  ...
  802630:	e8 18 ea ff ff       	call   80104d <sys_page_alloc>
  ...
  80263c:	78 23                	js     802661 <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  80263e:	8b 15 78 40 80 00    	mov    0x804078,%edx
  802644:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802647:	89 10                	mov    %edx,(%eax)
	fd->fd_omode = O_RDWR;
  802649:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80264c:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  802653:	83 ec 0c             	sub    $0xc,%esp
  802656:	50                   	push   %eax
  802657:	e8 01 ec ff ff       	call   80125d <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802668:	56                   	push   %esi
  802669:	53                   	push   %ebx
  80266a:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  802673:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  802675:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  80267a:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  80267d:	83 ec 0c             	sub    $0xc,%esp
  802680:	50                   	push   %eax
  802681:	e8 77 eb ff ff       	call   8011fd <sys_ipc_recv>

	if (r < 0) {
  802686:	83 c4 10             	add    $0x10,%esp
  802689:	85 c0                	test   %eax,%eax
  80268b:	79 16                	jns    8026a3 <ipc_recv+0x3e>
		if (from_env_store)
  80268d:	85 f6                	test   %esi,%esi
  80268f:	74 06                	je     802697 <ipc_recv+0x32>
			*from_env_store = 0;
  802691:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  802697:	85 db                	test   %ebx,%ebx
  802699:	74 2c                	je     8026c7 <ipc_recv+0x62>
			*perm_store = 0;
  80269b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8026a1:	eb 24                	jmp    8026c7 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  8026a3:	85 f6                	test   %esi,%esi
  8026a5:	74 0a                	je     8026b1 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  8026a7:	a1 1c 50 80 00       	mov    0x80501c,%eax
  8026ac:	8b 40 74             	mov    0x74(%eax),%eax
  8026af:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  8026b1:	85 db                	test   %ebx,%ebx
  8026b3:	74 0a                	je     8026bf <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  8026b5:	a1 1c 50 80 00       	mov    0x80501c,%eax
  8026ba:	8b 40 78             	mov    0x78(%eax),%eax
  8026bd:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  8026bf:	a1 1c 50 80 00       	mov    0x80501c,%eax
  8026c4:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8026da:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  8026e0:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  8026e2:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  8026e7:	0f 44 d8             	cmove  %eax,%ebx
	}

	int r = -1;
	while (r < 0) {
		r = sys_ipc_try_send(to_env, val, va, perm);
  8026ea:	ff 75 14             	pushl  0x14(%ebp)
  8026ed:	53                   	push   %ebx
  8026ee:	56                   	push   %esi
  8026ef:	57                   	push   %edi
  8026f0:	e8 e5 ea ff ff       	call   8011da <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  8026f5:	83 c4 10             	add    $0x10,%esp
  8026f8:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8026fb:	75 07                	jne    802704 <ipc_send+0x36>
			sys_yield();
  8026fd:	e8 2c e9 ff ff       	call   80102e <sys_yield>
  802702:	eb e6                	jmp    8026ea <ipc_send+0x1c>
		} else if (r < 0) {
  802704:	85 c0                	test   %eax,%eax
  802706:	79 12                	jns    80271a <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  802708:	50                   	push   %eax
  802709:	68 d4 30 80 00       	push   $0x8030d4
  80270e:	6a 51                	push   $0x51
  802710:	68 e1 30 80 00       	push   $0x8030e1
  802715:	e8 d2 de ff ff       	call   8005ec <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  80272d:	6b d0 7c             	imul   $0x7c,%eax,%edx
  802730:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  802736:	8b 52 50             	mov    0x50(%edx),%edx
  802739:	39 ca                	cmp    %ecx,%edx
  80273b:	75 0d                	jne    80274a <ipc_find_env+0x28>
			return envs[i].env_id;
  80273d:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802740:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  802745:	8b 40 48             	mov    0x48(%eax),%eax
  802748:	eb 0f                	jmp    802759 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802752:	75 d9                	jne    80272d <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  80275e:	8b 55 08             	mov    0x8(%ebp),%edx
	pte_t pte;

	if (!(uvpd[PDX(v)] & PTE_P))
  802761:	89 d0                	mov    %edx,%eax
  802763:	c1 e8 16             	shr    $0x16,%eax
  802766:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  802772:	f6 c1 01             	test   $0x1,%cl
  802775:	74 1d                	je     802794 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  802777:	c1 ea 0c             	shr    $0xc,%edx
  80277a:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  802781:	f6 c2 01             	test   $0x1,%dl
  802784:	74 0e                	je     802794 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  802786:	c1 ea 0c             	shr    $0xc,%edx
  802789:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  802790:	ef 
  802791:	0f b7 c0             	movzwl %ax,%eax
}
  802794:	5d                   	pop    %ebp
  802795:	c3                   	ret    
