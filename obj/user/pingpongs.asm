...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	i = 0;
	if ((who = sfork()) != 0) {
  80003c:	e8 7c 0f 00 00       	call   800fbd <sfork>
  ...
  800082:	e8 b6 0f 00 00       	call   80103d <ipc_send>
  ...
  800094:	50                   	push   %eax
  800095:	e8 3d 0f 00 00       	call   800fd7 <ipc_recv>
  ...
  8000e5:	e8 53 0f 00 00       	call   80103d <ipc_send>
		if (val == 10)
...
sys_env_destroy(envid_t envid)
{
  ...
  800b1a:	68 e4 16 80 00       	push   $0x8016e4
  800b1f:	6a 23                	push   $0x23
  800b21:	68 01 17 80 00       	push   $0x801701
  800b26:	e8 9f 05 00 00       	call   8010ca <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9b:	68 e4 16 80 00       	push   $0x8016e4
  800ba0:	6a 23                	push   $0x23
  800ba2:	68 01 17 80 00       	push   $0x801701
  800ba7:	e8 1e 05 00 00       	call   8010ca <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bdd:	68 e4 16 80 00       	push   $0x8016e4
  800be2:	6a 23                	push   $0x23
  800be4:	68 01 17 80 00       	push   $0x801701
  800be9:	e8 dc 04 00 00       	call   8010ca <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1f:	68 e4 16 80 00       	push   $0x8016e4
  800c24:	6a 23                	push   $0x23
  800c26:	68 01 17 80 00       	push   $0x801701
  800c2b:	e8 9a 04 00 00       	call   8010ca <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c61:	68 e4 16 80 00       	push   $0x8016e4
  800c66:	6a 23                	push   $0x23
  800c68:	68 01 17 80 00       	push   $0x801701
  800c6d:	e8 58 04 00 00       	call   8010ca <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca3:	68 e4 16 80 00       	push   $0x8016e4
  800ca8:	6a 23                	push   $0x23
  800caa:	68 01 17 80 00       	push   $0x801701
  800caf:	e8 16 04 00 00       	call   8010ca <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d07:	68 e4 16 80 00       	push   $0x8016e4
  800d0c:	6a 23                	push   $0x23
  800d0e:	68 01 17 80 00       	push   $0x801701
  800d13:	e8 b2 03 00 00       	call   8010ca <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d2e:	74 2c                	je     800d5c <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
  800d30:	89 d8                	mov    %ebx,%eax
  800d32:	c1 e8 16             	shr    $0x16,%eax
  800d35:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
  800d3c:	a8 01                	test   $0x1,%al
  800d3e:	74 1c                	je     800d5c <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
  800d40:	89 de                	mov    %ebx,%esi
  800d42:	c1 ee 0c             	shr    $0xc,%esi
  800d45:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
	      (uvpd[PDX(addr)] & PTE_P) &&
  800d4c:	a8 01                	test   $0x1,%al
  800d4e:	74 0c                	je     800d5c <pgfault+0x3c>
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
  800d50:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
  800d57:	f6 c4 08             	test   $0x8,%ah
  800d5a:	75 14                	jne    800d70 <pgfault+0x50>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
		panic("not copy on write");
  800d5c:	83 ec 04             	sub    $0x4,%esp
  800d5f:	68 0f 17 80 00       	push   $0x80170f
  800d64:	6a 21                	push   $0x21
  800d66:	68 21 17 80 00       	push   $0x801721
  800d6b:	e8 5a 03 00 00       	call   8010ca <_panic>
	// Hint:
  ...
  800d9a:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	...
	memcpy(PFTEMP, addr, PGSIZE);
	sys_page_map(0, PFTEMP,
  800da1:	25 05 06 00 00       	and    $0x605,%eax
  800da6:	83 c8 02             	or     $0x2,%eax
  800da9:	89 04 24             	mov    %eax,(%esp)
  800dac:	53                   	push   %ebx
  800dad:	6a 00                	push   $0x0
  800daf:	68 00 f0 7f 00       	push   $0x7ff000
  800db4:	6a 00                	push   $0x0
  800db6:	e8 f9 fd ff ff       	call   800bb4 <sys_page_map>
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
	sys_page_unmap(0, PFTEMP);
  800dbb:	83 c4 18             	add    $0x18,%esp
  800dbe:	68 00 f0 7f 00       	push   $0x7ff000
  800dc3:	6a 00                	push   $0x0
  800dc5:	e8 2c fe ff ff       	call   800bf6 <sys_page_unmap>
	return;
...
fork(void)
{
  ...
  800dd8:	56                   	push   %esi
  800dd9:	53                   	push   %ebx
  800dda:	83 ec 28             	sub    $0x28,%esp
	// LAB 4: Your code here.

	int r;

	set_pgfault_handler(pgfault);
  800ddd:	68 20 0d 80 00       	push   $0x800d20
  800de2:	e8 29 03 00 00       	call   801110 <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800de7:	b8 07 00 00 00       	mov    $0x7,%eax
  800dec:	cd 30                	int    $0x30
  800dee:	89 45 e4             	mov    %eax,-0x1c(%ebp)

	if ((r = sys_exofork()) < 0)
  800df1:	83 c4 10             	add    $0x10,%esp
  800df4:	85 c0                	test   %eax,%eax
  800df6:	79 14                	jns    800e0c <fork+0x38>
		panic ("No memory");
  800df8:	83 ec 04             	sub    $0x4,%esp
  800dfb:	68 2c 17 80 00       	push   $0x80172c
  800e00:	6a 77                	push   $0x77
  800e02:	68 21 17 80 00       	push   $0x801721
  800e07:	e8 be 02 00 00       	call   8010ca <_panic>
  800e0c:	89 c7                	mov    %eax,%edi
  800e0e:	bb 00 00 00 00       	mov    $0x0,%ebx
	else if (r == 0)
  800e13:	85 c0                	test   %eax,%eax
  800e15:	75 31                	jne    800e48 <fork+0x74>
	{
		set_pgfault_handler(pgfault);
  800e17:	83 ec 0c             	sub    $0xc,%esp
  800e1a:	68 20 0d 80 00       	push   $0x800d20
  800e1f:	e8 ec 02 00 00       	call   801110 <set_pgfault_handler>
		thisenv = &envs[ENVX(sys_getenvid())];
  800e24:	e8 0a fd ff ff       	call   800b33 <sys_getenvid>
  800e29:	25 ff 03 00 00       	and    $0x3ff,%eax
  800e2e:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e31:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e36:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  800e3b:	83 c4 10             	add    $0x10,%esp
  800e3e:	b8 00 00 00 00       	mov    $0x0,%eax
  800e43:	e9 6d 01 00 00       	jmp    800fb5 <fork+0x1e1>
	}
  ...
  800e56:	0f 84 c2 00 00 00    	je     800f1e <fork+0x14a>
  ...
  800e6b:	0f 84 ad 00 00 00    	je     800f1e <fork+0x14a>
			&& (uvpt [PGNUM(i)] & PTE_U))
  800e71:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e78:	f6 c2 04             	test   $0x4,%dl
  800e7b:	0f 84 9d 00 00 00    	je     800f1e <fork+0x14a>
{
	int r;
  ...
  800e8d:	f6 c6 08             	test   $0x8,%dh
  800e90:	75 0b                	jne    800e9d <fork+0xc9>
  800e92:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800e99:	a8 02                	test   $0x2,%al
  800e9b:	74 6d                	je     800f0a <fork+0x136>
	{
		if (sys_page_map(thisenv->env_id, address, envid, address, PTE_COW|PTE_U|PTE_P))
  800e9d:	a1 08 20 80 00       	mov    0x802008,%eax
  800ea2:	8b 40 48             	mov    0x48(%eax),%eax
  800ea5:	83 ec 0c             	sub    $0xc,%esp
  800ea8:	68 05 08 00 00       	push   $0x805
  800ead:	56                   	push   %esi
  800eae:	ff 75 e4             	pushl  -0x1c(%ebp)
  800eb1:	56                   	push   %esi
  800eb2:	50                   	push   %eax
  800eb3:	e8 fc fc ff ff       	call   800bb4 <sys_page_map>
  800eb8:	83 c4 20             	add    $0x20,%esp
  800ebb:	85 c0                	test   %eax,%eax
  800ebd:	74 14                	je     800ed3 <fork+0xff>
            panic("sys_page_map failed");
  800ebf:	83 ec 04             	sub    $0x4,%esp
  800ec2:	68 36 17 80 00       	push   $0x801736
  800ec7:	6a 4f                	push   $0x4f
  800ec9:	68 21 17 80 00       	push   $0x801721
  800ece:	e8 f7 01 00 00       	call   8010ca <_panic>
        if (sys_page_map(thisenv->env_id, address, thisenv->env_id, address, PTE_COW|PTE_U|PTE_P))
  800ed3:	a1 08 20 80 00       	mov    0x802008,%eax
  800ed8:	8b 50 48             	mov    0x48(%eax),%edx
  800edb:	8b 40 48             	mov    0x48(%eax),%eax
  ...
  800ee8:	56                   	push   %esi
  800ee9:	50                   	push   %eax
  800eea:	e8 c5 fc ff ff       	call   800bb4 <sys_page_map>
  800eef:	83 c4 20             	add    $0x20,%esp
  800ef2:	85 c0                	test   %eax,%eax
  800ef4:	74 28                	je     800f1e <fork+0x14a>
            panic("sys_page_map failed");
  800ef6:	83 ec 04             	sub    $0x4,%esp
  800ef9:	68 36 17 80 00       	push   $0x801736
  800efe:	6a 51                	push   $0x51
  800f00:	68 21 17 80 00       	push   $0x801721
  800f05:	e8 c0 01 00 00       	call   8010ca <_panic>
	}
	else
  ...
  800f16:	e8 99 fc ff ff       	call   800bb4 <sys_page_map>
  800f1b:	83 c4 20             	add    $0x20,%esp
	...
	int i;
	for (i=0; i < USTACKTOP; i+=PGSIZE)
  800f1e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800f24:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800f2a:	0f 85 18 ff ff ff    	jne    800e48 <fork+0x74>
		if ((uvpd [PDX(i)] & PTE_P) && (uvpt [PGNUM(i)] & PTE_P) 
			&& (uvpt [PGNUM(i)] & PTE_U))
			duppage (r, PGNUM(i));
	}
  ...
  800f3a:	57                   	push   %edi
  800f3b:	e8 31 fc ff ff       	call   800b71 <sys_page_alloc>
  800f40:	83 c4 10             	add    $0x10,%esp
  800f43:	85 c0                	test   %eax,%eax
  800f45:	74 17                	je     800f5e <fork+0x18a>
		panic ("sys_page_alloc error in fork()");
  800f47:	83 ec 04             	sub    $0x4,%esp
  800f4a:	68 60 17 80 00       	push   $0x801760
  800f4f:	68 88 00 00 00       	push   $0x88
  800f54:	68 21 17 80 00       	push   $0x801721
  800f59:	e8 6c 01 00 00       	call   8010ca <_panic>

	extern void _pgfault_upcall();
	if(sys_env_set_pgfault_upcall(r, _pgfault_upcall))
  800f5e:	83 ec 08             	sub    $0x8,%esp
  800f61:	68 7f 11 80 00       	push   $0x80117f
  800f66:	57                   	push   %edi
  800f67:	e8 0e fd ff ff       	call   800c7a <sys_env_set_pgfault_upcall>
  800f6c:	83 c4 10             	add    $0x10,%esp
  800f6f:	85 c0                	test   %eax,%eax
  800f71:	74 17                	je     800f8a <fork+0x1b6>
		panic ("sys_env_set_pgfault_upcall error in fork()");
  800f73:	83 ec 04             	sub    $0x4,%esp
  800f76:	68 80 17 80 00       	push   $0x801780
  800f7b:	68 8c 00 00 00       	push   $0x8c
  800f80:	68 21 17 80 00       	push   $0x801721
  800f85:	e8 40 01 00 00       	call   8010ca <_panic>

	if (sys_env_set_status(r, ENV_RUNNABLE))
  800f8a:	83 ec 08             	sub    $0x8,%esp
  800f8d:	6a 02                	push   $0x2
  800f8f:	57                   	push   %edi
  800f90:	e8 a3 fc ff ff       	call   800c38 <sys_env_set_status>
  800f95:	83 c4 10             	add    $0x10,%esp
  800f98:	85 c0                	test   %eax,%eax
  800f9a:	74 17                	je     800fb3 <fork+0x1df>
		panic ("Cannot set status in sys_env_set_status");
  800f9c:	83 ec 04             	sub    $0x4,%esp
  800f9f:	68 ac 17 80 00       	push   $0x8017ac
  800fa4:	68 8f 00 00 00       	push   $0x8f
  800fa9:	68 21 17 80 00       	push   $0x801721
  800fae:	e8 17 01 00 00       	call   8010ca <_panic>
	return r;
...
sfork(void)
{
  ...
  800fc3:	68 4a 17 80 00       	push   $0x80174a
  800fc8:	68 9b 00 00 00       	push   $0x9b
  800fcd:	68 21 17 80 00       	push   $0x801721
  800fd2:	e8 f3 00 00 00       	call   8010ca <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800fda:	56                   	push   %esi
  800fdb:	53                   	push   %ebx
  800fdc:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  800fec:	0f 44 c2             	cmove  %edx,%eax

	if (sys_ipc_recv(pg))
  800fef:	83 ec 0c             	sub    $0xc,%esp
  800ff2:	50                   	push   %eax
  800ff3:	e8 e7 fc ff ff       	call   800cdf <sys_ipc_recv>
  800ff8:	83 c4 10             	add    $0x10,%esp
  800ffb:	85 c0                	test   %eax,%eax
  800ffd:	74 13                	je     801012 <ipc_recv+0x3b>
	{
		*from_env_store = 0;
  800fff:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;
  801005:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		return -E_INVAL;
  80100b:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  801010:	eb 24                	jmp    801036 <ipc_recv+0x5f>
	}

	if (from_env_store)
  801012:	85 f6                	test   %esi,%esi
  801014:	74 0a                	je     801020 <ipc_recv+0x49>
        *from_env_store = thisenv->env_ipc_from;
  801016:	a1 08 20 80 00       	mov    0x802008,%eax
  80101b:	8b 40 74             	mov    0x74(%eax),%eax
  80101e:	89 06                	mov    %eax,(%esi)
    
    if (perm_store)
  801020:	85 db                	test   %ebx,%ebx
  801022:	74 0a                	je     80102e <ipc_recv+0x57>
        *perm_store = thisenv->env_ipc_perm;
  801024:	a1 08 20 80 00       	mov    0x802008,%eax
  801029:	8b 40 78             	mov    0x78(%eax),%eax
  80102c:	89 03                	mov    %eax,(%ebx)

    return thisenv->env_ipc_value;
  80102e:	a1 08 20 80 00       	mov    0x802008,%eax
  801033:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801046:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  801056:	0f 44 d8             	cmove  %eax,%ebx
  801059:	eb 05                	jmp    801060 <ipc_send+0x23>
	while((result = sys_ipc_try_send(to_env, val, pg, perm)) == -E_IPC_NOT_RECV) {
	    sys_yield();
  80105b:	e8 f2 fa ff ff       	call   800b52 <sys_yield>
	// LAB 4: Your code here.
	...
	if (!pg)
		pg = (void *)-1;
	while((result = sys_ipc_try_send(to_env, val, pg, perm)) == -E_IPC_NOT_RECV) {
  801060:	ff 75 14             	pushl  0x14(%ebp)
  801063:	53                   	push   %ebx
  801064:	56                   	push   %esi
  801065:	57                   	push   %edi
  801066:	e8 51 fc ff ff       	call   800cbc <sys_ipc_try_send>
  80106b:	83 c4 10             	add    $0x10,%esp
  80106e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801071:	74 e8                	je     80105b <ipc_send+0x1e>
	    sys_yield();
	}
	if (result)
  801073:	85 c0                	test   %eax,%eax
  801075:	74 12                	je     801089 <ipc_send+0x4c>
		panic ("E_IPC_NOT_RECV %e", result);
  801077:	50                   	push   %eax
  801078:	68 d4 17 80 00       	push   $0x8017d4
  80107d:	6a 43                	push   $0x43
  80107f:	68 e6 17 80 00       	push   $0x8017e6
  801084:	e8 41 00 00 00       	call   8010ca <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  80109c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80109f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8010a5:	8b 52 50             	mov    0x50(%edx),%edx
  8010a8:	39 ca                	cmp    %ecx,%edx
  8010aa:	75 0d                	jne    8010b9 <ipc_find_env+0x28>
			return envs[i].env_id;
  8010ac:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8010af:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  8010b4:	8b 40 48             	mov    0x48(%eax),%eax
  8010b7:	eb 0f                	jmp    8010c8 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8010bc:	3d 00 04 00 00       	cmp    $0x400,%eax
  8010c1:	75 d9                	jne    80109c <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010ce:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  8010cf:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8010d2:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8010d8:	e8 56 fa ff ff       	call   800b33 <sys_getenvid>
  8010dd:	83 ec 0c             	sub    $0xc,%esp
  8010e0:	ff 75 0c             	pushl  0xc(%ebp)
  8010e3:	ff 75 08             	pushl  0x8(%ebp)
  8010e6:	56                   	push   %esi
  8010e7:	50                   	push   %eax
  8010e8:	68 f0 17 80 00       	push   $0x8017f0
  8010ed:	e8 f7 f0 ff ff       	call   8001e9 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010f2:	83 c4 18             	add    $0x18,%esp
  8010f5:	53                   	push   %ebx
  8010f6:	ff 75 10             	pushl  0x10(%ebp)
  8010f9:	e8 9a f0 ff ff       	call   800198 <vcprintf>
	cprintf("\n");
  8010fe:	c7 04 24 58 14 80 00 	movl   $0x801458,(%esp)
  801105:	e8 df f0 ff ff       	call   8001e9 <cprintf>
  80110a:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  80110d:	cc                   	int3   
  80110e:	eb fd                	jmp    80110d <_panic+0x43>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80111d:	75 2c                	jne    80114b <set_pgfault_handler+0x3b>
		// First time through!
		// LAB 4: Your code here.
  ...
  80112b:	e8 41 fa ff ff       	call   800b71 <sys_page_alloc>
  801130:	83 c4 10             	add    $0x10,%esp
  801133:	85 c0                	test   %eax,%eax
  801135:	74 14                	je     80114b <set_pgfault_handler+0x3b>
			PTE_P | PTE_U | PTE_W))
			
        	panic("sys_page_alloc failed.");
  801137:	83 ec 04             	sub    $0x4,%esp
  80113a:	68 13 18 80 00       	push   $0x801813
  80113f:	6a 24                	push   $0x24
  801141:	68 2a 18 80 00       	push   $0x80182a
  801146:	e8 7f ff ff ff       	call   8010ca <_panic>
  ...
  80114e:	a3 0c 20 80 00       	mov    %eax,0x80200c
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  801153:	83 ec 08             	sub    $0x8,%esp
  801156:	68 7f 11 80 00       	push   $0x80117f
  80115b:	6a 00                	push   $0x0
  80115d:	e8 18 fb ff ff       	call   800c7a <sys_env_set_pgfault_upcall>
  801162:	83 c4 10             	add    $0x10,%esp
  801165:	85 c0                	test   %eax,%eax
  801167:	79 14                	jns    80117d <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  801169:	83 ec 04             	sub    $0x4,%esp
  80116c:	68 38 18 80 00       	push   $0x801838
  801171:	6a 2b                	push   $0x2b
  801173:	68 2a 18 80 00       	push   $0x80182a
  801178:	e8 4d ff ff ff       	call   8010ca <_panic>
...
_pgfault_upcall:
  ...
  801180:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  801187:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  80118a:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  80118e:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  801193:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  ...
  8011a1:	5c                   	pop    %esp
	...
	ret
  8011a2:	c3                   	ret    
  8011a3:	66 90                	xchg   %ax,%ax
  8011a5:	66 90                	xchg   %ax,%ax
  8011a7:	66 90                	xchg   %ax,%ax
