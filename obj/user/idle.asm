...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044b:	ba 18 23 80 00       	mov    $0x802318,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800476:	51                   	push   %ecx
  800477:	50                   	push   %eax
  800478:	68 9c 22 80 00       	push   $0x80229c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006a0:	53                   	push   %ebx
  8006a1:	50                   	push   %eax
  8006a2:	68 dd 22 80 00       	push   $0x8022dd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800775:	53                   	push   %ebx
  800776:	50                   	push   %eax
  800777:	68 f9 22 80 00       	push   $0x8022f9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80082a:	53                   	push   %ebx
  80082b:	50                   	push   %eax
  80082c:	68 bc 22 80 00       	push   $0x8022bc
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800a66:	68 2c 23 80 00       	push   $0x80232c
  800a6b:	68 38 23 80 00       	push   $0x802338
  800a70:	68 a3 00 00 00       	push   $0xa3
  800a75:	68 4d 23 80 00       	push   $0x80234d
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ab6:	68 58 23 80 00       	push   $0x802358
  800abb:	68 38 23 80 00       	push   $0x802338
  800ac0:	6a 7c                	push   $0x7c
  800ac2:	68 4d 23 80 00       	push   $0x80234d
  800ac7:	e8 24 0a 00 00       	call   8014f0 <_panic>
	assert(r <= PGSIZE);
  800acc:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ad1:	7e 16                	jle    800ae9 <devfile_read+0x65>
  800ad3:	68 5f 23 80 00       	push   $0x80235f
  800ad8:	68 38 23 80 00       	push   $0x802338
  800add:	6a 7d                	push   $0x7d
  800adf:	68 4d 23 80 00       	push   $0x80234d
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bb0:	68 6b 23 80 00       	push   $0x80236b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f56:	68 77 23 80 00       	push   $0x802377
  800f5b:	68 38 23 80 00       	push   $0x802338
  800f60:	6a 62                	push   $0x62
  800f62:	68 8c 23 80 00       	push   $0x80238c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fa3:	68 98 23 80 00       	push   $0x802398
  800fa8:	68 38 23 80 00       	push   $0x802338
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801029:	68 a4 23 80 00       	push   $0x8023a4
  80102e:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8010d9:	50                   	push   %eax
  8010da:	56                   	push   %esi
  8010db:	68 ab 23 80 00       	push   $0x8023ab
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80137d:	68 c3 23 80 00       	push   $0x8023c3
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80150c:	56                   	push   %esi
  80150d:	50                   	push   %eax
  80150e:	68 d0 23 80 00       	push   $0x8023d0
  ...
  80151f:	e8 54 00 00 00       	call   801578 <vcprintf>
	cprintf("\n");
  801524:	c7 04 24 bc 23 80 00 	movl   $0x8023bc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801677:	0f be 80 f3 23 80 00 	movsbl 0x8023f3(%eax),%eax
  80167e:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801842:	50                   	push   %eax
  801843:	68 0b 24 80 00       	push   $0x80240b
  801848:	53                   	push   %ebx
  801849:	56                   	push   %esi
  ...
  80185a:	52                   	push   %edx
  80185b:	68 4a 23 80 00       	push   $0x80234a
  801860:	53                   	push   %ebx
  801861:	56                   	push   %esi
  ...
  80187f:	b8 04 24 80 00       	mov    $0x802404,%eax
