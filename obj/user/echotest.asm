...
void umain(int argc, char **argv)
{
  ...
  800089:	e8 ca 1a 00 00       	call   801b58 <socket>
  ...
  8000f7:	e8 13 1a 00 00       	call   801b0f <connect>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80082e:	52                   	push   %edx
  80082f:	68 ba 2b 80 00       	push   $0x802bba
  800834:	53                   	push   %ebx
  800835:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800eda:	e8 d0 13 00 00       	call   8022af <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800f5b:	e8 4f 13 00 00       	call   8022af <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800f9d:	e8 0d 13 00 00       	call   8022af <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800fdf:	e8 cb 12 00 00       	call   8022af <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  801021:	e8 89 12 00 00       	call   8022af <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  801063:	e8 47 12 00 00       	call   8022af <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8010a5:	e8 05 12 00 00       	call   8022af <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  801109:	e8 a1 11 00 00       	call   8022af <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80120a:	ba 88 2b 80 00       	mov    $0x802b88,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801235:	51                   	push   %ecx
  801236:	50                   	push   %eax
  801237:	68 0c 2b 80 00       	push   $0x802b0c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80145f:	53                   	push   %ebx
  801460:	50                   	push   %eax
  801461:	68 4d 2b 80 00       	push   $0x802b4d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801534:	53                   	push   %ebx
  801535:	50                   	push   %eax
  801536:	68 69 2b 80 00       	push   $0x802b69
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8015e9:	53                   	push   %ebx
  8015ea:	50                   	push   %eax
  8015eb:	68 2c 2b 80 00       	push   $0x802b2c
...
stat(const char *path, struct Stat *stat)
{
  ...
  8016b4:	e8 0c 02 00 00       	call   8018c5 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8016fb:	e8 b2 0c 00 00       	call   8023b2 <ipc_find_env>
  ...
  801716:	e8 43 0c 00 00       	call   80235e <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80171b:	83 c4 0c             	add    $0xc,%esp
  80171e:	6a 00                	push   $0x0
  801720:	53                   	push   %ebx
  801721:	6a 00                	push   $0x0
  801723:	e8 cd 0b 00 00       	call   8022f5 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8017e4:	89 15 00 50 80 00    	mov    %edx,0x805000
  8017ea:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8017ef:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  8017f4:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  8017f7:	89 1d 04 50 80 00    	mov    %ebx,0x805004
	
	memmove(fsipcbuf.write.req_buf, buf, n_real);
  8017fd:	53                   	push   %ebx
  8017fe:	ff 75 0c             	pushl  0xc(%ebp)
  801801:	68 08 50 80 00       	push   $0x805008
  801806:	e8 a9 f4 ff ff       	call   800cb4 <memmove>
  ...
  801815:	e8 ca fe ff ff       	call   8016e4 <fsipc>
  80181a:	83 c4 10             	add    $0x10,%esp
  80181d:	85 c0                	test   %eax,%eax
  80181f:	78 1d                	js     80183e <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  801821:	39 d8                	cmp    %ebx,%eax
  801823:	76 19                	jbe    80183e <devfile_write+0x6a>
  801825:	68 9c 2b 80 00       	push   $0x802b9c
  80182a:	68 a8 2b 80 00       	push   $0x802ba8
  80182f:	68 a3 00 00 00       	push   $0xa3
  801834:	68 bd 2b 80 00       	push   $0x802bbd
  801839:	e8 71 0a 00 00       	call   8022af <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801866:	e8 79 fe ff ff       	call   8016e4 <fsipc>
  ...
  801875:	68 c8 2b 80 00       	push   $0x802bc8
  80187a:	68 a8 2b 80 00       	push   $0x802ba8
  80187f:	6a 7c                	push   $0x7c
  801881:	68 bd 2b 80 00       	push   $0x802bbd
  801886:	e8 24 0a 00 00       	call   8022af <_panic>
	assert(r <= PGSIZE);
  80188b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801890:	7e 16                	jle    8018a8 <devfile_read+0x65>
  801892:	68 cf 2b 80 00       	push   $0x802bcf
  801897:	68 a8 2b 80 00       	push   $0x802ba8
  80189c:	6a 7d                	push   $0x7d
  80189e:	68 bd 2b 80 00       	push   $0x802bbd
  8018a3:	e8 07 0a 00 00       	call   8022af <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8018a8:	83 ec 04             	sub    $0x4,%esp
  8018ab:	50                   	push   %eax
  8018ac:	68 00 50 80 00       	push   $0x805000
  8018b1:	ff 75 0c             	pushl  0xc(%ebp)
  8018b4:	e8 fb f3 ff ff       	call   800cb4 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8018cf:	53                   	push   %ebx
  8018d0:	e8 14 f2 ff ff       	call   800ae9 <strlen>
  ...
  8018e5:	50                   	push   %eax
  8018e6:	e8 71 f8 ff ff       	call   80115c <fd_alloc>
  ...
  8018fd:	e8 20 f2 ff ff       	call   800b22 <strcpy>
  ...
  801912:	e8 cd fd ff ff       	call   8016e4 <fsipc>
  ...
  801928:	e8 27 f9 ff ff       	call   801254 <fd_close>
		return r;
  ...
  80193a:	e8 f6 f7 ff ff       	call   801135 <fd2num>
...
sync(void)
{
  ...
  801962:	e8 7d fd ff ff       	call   8016e4 <fsipc>
}
  801967:	c9                   	leave  
  801968:	c3                   	ret    

00801969 <devsock_stat>:
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80196f:	68 db 2b 80 00       	push   $0x802bdb
  801974:	ff 75 0c             	pushl  0xc(%ebp)
  801977:	e8 a6 f1 ff ff       	call   800b22 <strcpy>
	return 0;
}
...
devsock_close(struct Fd *fd)
{
  ...
  80198a:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (pageref(fd) == 1)
  80198d:	53                   	push   %ebx
  80198e:	e8 58 0a 00 00       	call   8023eb <pageref>
...
devsock_close(struct Fd *fd)
{
  ...
  80199e:	75 10                	jne    8019b0 <devsock_close+0x2d>
		return nsipc_close(fd->fd_sock.sockid);
  8019a0:	83 ec 0c             	sub    $0xc,%esp
  8019a3:	ff 73 0c             	pushl  0xc(%ebx)
  8019a6:	e8 c0 02 00 00       	call   801c6b <nsipc_close>
...
devsock_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8019c8:	ff 70 0c             	pushl  0xc(%eax)
  8019cb:	e8 78 03 00 00       	call   801d48 <nsipc_send>
}
  8019d0:	c9                   	leave  
  8019d1:	c3                   	ret    

008019d2 <devsock_read>:
...
devsock_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8019e6:	e8 f1 02 00 00       	call   801cdc <nsipc_recv>
}
  8019eb:	c9                   	leave  
  8019ec:	c3                   	ret    
...
fd2sockid(int fd)
{
  ...
  8019f0:	83 ec 20             	sub    $0x20,%esp
	struct Fd *sfd;
	int r;

	if ((r = fd_lookup(fd, &sfd)) < 0)
  8019f3:	8d 55 f4             	lea    -0xc(%ebp),%edx
  8019f6:	52                   	push   %edx
  8019f7:	50                   	push   %eax
  8019f8:	e8 ae f7 ff ff       	call   8011ab <fd_lookup>
  8019fd:	83 c4 10             	add    $0x10,%esp
  801a00:	85 c0                	test   %eax,%eax
  801a02:	78 17                	js     801a1b <fd2sockid+0x2e>
		return r;
	if (sfd->fd_dev_id != devsock.dev_id)
  801a04:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a07:	8b 0d 24 30 80 00    	mov    0x803024,%ecx
  801a0d:	39 08                	cmp    %ecx,(%eax)
  801a0f:	75 05                	jne    801a16 <fd2sockid+0x29>
		return -E_NOT_SUPP;
	return sfd->fd_sock.sockid;
  801a11:	8b 40 0c             	mov    0xc(%eax),%eax
  801a14:	eb 05                	jmp    801a1b <fd2sockid+0x2e>
	int r;
...
alloc_sockfd(int sockid)
{
  ...
  801a2a:	50                   	push   %eax
  801a2b:	e8 2c f7 ff ff       	call   80115c <fd_alloc>
  801a30:	89 c3                	mov    %eax,%ebx
  801a32:	83 c4 10             	add    $0x10,%esp
  801a35:	85 c0                	test   %eax,%eax
  801a37:	78 1b                	js     801a54 <alloc_sockfd+0x37>
	    || (r = sys_page_alloc(0, sfd, PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0) {
  801a39:	83 ec 04             	sub    $0x4,%esp
  801a3c:	68 07 04 00 00       	push   $0x407
  801a41:	ff 75 f4             	pushl  -0xc(%ebp)
  801a44:	6a 00                	push   $0x0
  801a46:	e8 da f4 ff ff       	call   800f25 <sys_page_alloc>
  801a4b:	89 c3                	mov    %eax,%ebx
  801a4d:	83 c4 10             	add    $0x10,%esp
  801a50:	85 c0                	test   %eax,%eax
  801a52:	79 10                	jns    801a64 <alloc_sockfd+0x47>
		nsipc_close(sockid);
  801a54:	83 ec 0c             	sub    $0xc,%esp
  801a57:	56                   	push   %esi
  801a58:	e8 0e 02 00 00       	call   801c6b <nsipc_close>
		return r;
  801a5d:	83 c4 10             	add    $0x10,%esp
  801a60:	89 d8                	mov    %ebx,%eax
  801a62:	eb 24                	jmp    801a88 <alloc_sockfd+0x6b>
	}

	sfd->fd_dev_id = devsock.dev_id;
  801a64:	8b 15 24 30 80 00    	mov    0x803024,%edx
  ...
  801a7f:	50                   	push   %eax
  801a80:	e8 b0 f6 ff ff       	call   801135 <fd2num>
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801a98:	e8 50 ff ff ff       	call   8019ed <fd2sockid>
		return r;
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801aa1:	78 1f                	js     801ac2 <accept+0x33>
		return r;
  ...
  801aac:	50                   	push   %eax
  801aad:	e8 12 01 00 00       	call   801bc4 <nsipc_accept>
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801ab9:	78 07                	js     801ac2 <accept+0x33>
		return r;
	return alloc_sockfd(r);
  801abb:	e8 5d ff ff ff       	call   801a1d <alloc_sockfd>
...
bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801acf:	e8 19 ff ff ff       	call   8019ed <fd2sockid>
  ...
  801ae1:	50                   	push   %eax
  801ae2:	e8 2d 01 00 00       	call   801c14 <nsipc_bind>
...
shutdown(int s, int how)
{
  ...
  801af5:	e8 f3 fe ff ff       	call   8019ed <fd2sockid>
  ...
  801b04:	50                   	push   %eax
  801b05:	e8 3f 01 00 00       	call   801c49 <nsipc_shutdown>
...
connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801b18:	e8 d0 fe ff ff       	call   8019ed <fd2sockid>
  ...
  801b2a:	50                   	push   %eax
  801b2b:	e8 55 01 00 00       	call   801c85 <nsipc_connect>
...
listen(int s, int backlog)
{
  ...
  801b3e:	e8 aa fe ff ff       	call   8019ed <fd2sockid>
  ...
  801b4d:	50                   	push   %eax
  801b4e:	e8 67 01 00 00       	call   801cba <nsipc_listen>
...
socket(int domain, int type, int protocol)
{
  ...
  801b67:	e8 3a 02 00 00       	call   801da6 <nsipc_socket>
  801b6c:	83 c4 10             	add    $0x10,%esp
  801b6f:	85 c0                	test   %eax,%eax
  801b71:	78 05                	js     801b78 <socket+0x20>
		return r;
	return alloc_sockfd(r);
  801b73:	e8 a5 fe ff ff       	call   801a1d <alloc_sockfd>
}
  801b78:	c9                   	leave  
  801b79:	c3                   	ret    
...
nsipc(unsigned type)
{
  ...
  801b81:	89 c3                	mov    %eax,%ebx
	...
	if (nsenv == 0)
  801b83:	83 3d 14 40 80 00 00 	cmpl   $0x0,0x804014
  801b8a:	75 12                	jne    801b9e <nsipc+0x24>
		nsenv = ipc_find_env(ENV_TYPE_NS);
  801b8c:	83 ec 0c             	sub    $0xc,%esp
  801b8f:	6a 02                	push   $0x2
  801b91:	e8 1c 08 00 00       	call   8023b2 <ipc_find_env>
  801b96:	a3 14 40 80 00       	mov    %eax,0x804014
  ...
  801ba5:	53                   	push   %ebx
  801ba6:	ff 35 14 40 80 00    	pushl  0x804014
  801bac:	e8 ad 07 00 00       	call   80235e <ipc_send>
	return ipc_recv(NULL, NULL, NULL);
  801bb1:	83 c4 0c             	add    $0xc,%esp
  801bb4:	6a 00                	push   $0x0
  801bb6:	6a 00                	push   $0x0
  801bb8:	6a 00                	push   $0x0
  801bba:	e8 36 07 00 00       	call   8022f5 <ipc_recv>
}
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801be0:	e8 95 ff ff ff       	call   801b7a <nsipc>
  801be5:	89 c3                	mov    %eax,%ebx
  801be7:	85 c0                	test   %eax,%eax
  801be9:	78 20                	js     801c0b <nsipc_accept+0x47>
		struct Nsret_accept *ret = &nsipcbuf.acceptRet;
		memmove(addr, &ret->ret_addr, ret->ret_addrlen);
  801beb:	83 ec 04             	sub    $0x4,%esp
  801bee:	ff 35 10 60 80 00    	pushl  0x806010
  801bf4:	68 00 60 80 00       	push   $0x806000
  801bf9:	ff 75 0c             	pushl  0xc(%ebp)
  801bfc:	e8 b3 f0 ff ff       	call   800cb4 <memmove>
		*addrlen = ret->ret_addrlen;
  801c01:	a1 10 60 80 00       	mov    0x806010,%eax
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801c2f:	e8 80 f0 ff ff       	call   800cb4 <memmove>
	nsipcbuf.bind.req_namelen = namelen;
  801c34:	89 1d 14 60 80 00    	mov    %ebx,0x806014
	return nsipc(NSREQ_BIND);
  801c3a:	b8 02 00 00 00       	mov    $0x2,%eax
  801c3f:	e8 36 ff ff ff       	call   801b7a <nsipc>
}
  801c44:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801c47:	c9                   	leave  
  801c48:	c3                   	ret    

00801c49 <nsipc_shutdown>:
...
nsipc_shutdown(int s, int how)
{
  ...
  801c64:	e8 11 ff ff ff       	call   801b7a <nsipc>
}
  801c69:	c9                   	leave  
  801c6a:	c3                   	ret    

00801c6b <nsipc_close>:
...
nsipc_close(int s)
{
  ...
  801c79:	b8 04 00 00 00       	mov    $0x4,%eax
  801c7e:	e8 f7 fe ff ff       	call   801b7a <nsipc>
}
  801c83:	c9                   	leave  
  801c84:	c3                   	ret    

00801c85 <nsipc_connect>:
...
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801c9b:	68 04 60 80 00       	push   $0x806004
  801ca0:	e8 0f f0 ff ff       	call   800cb4 <memmove>
	nsipcbuf.connect.req_namelen = namelen;
  801ca5:	89 1d 14 60 80 00    	mov    %ebx,0x806014
	return nsipc(NSREQ_CONNECT);
  801cab:	b8 05 00 00 00       	mov    $0x5,%eax
  801cb0:	e8 c5 fe ff ff       	call   801b7a <nsipc>
}
  801cb5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801cb8:	c9                   	leave  
  801cb9:	c3                   	ret    

00801cba <nsipc_listen>:
...
nsipc_listen(int s, int backlog)
{
  ...
  801ccb:	a3 04 60 80 00       	mov    %eax,0x806004
	return nsipc(NSREQ_LISTEN);
  801cd0:	b8 06 00 00 00       	mov    $0x6,%eax
  801cd5:	e8 a0 fe ff ff       	call   801b7a <nsipc>
}
  801cda:	c9                   	leave  
  801cdb:	c3                   	ret    
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801cec:	89 35 04 60 80 00    	mov    %esi,0x806004
	nsipcbuf.recv.req_flags = flags;
  801cf2:	8b 45 14             	mov    0x14(%ebp),%eax
  801cf5:	a3 08 60 80 00       	mov    %eax,0x806008

	if ((r = nsipc(NSREQ_RECV)) >= 0) {
  801cfa:	b8 07 00 00 00       	mov    $0x7,%eax
  801cff:	e8 76 fe ff ff       	call   801b7a <nsipc>
  801d04:	89 c3                	mov    %eax,%ebx
  801d06:	85 c0                	test   %eax,%eax
  801d08:	78 35                	js     801d3f <nsipc_recv+0x63>
		assert(r < 1600 && r <= len);
  801d0a:	3d 3f 06 00 00       	cmp    $0x63f,%eax
  801d0f:	7f 04                	jg     801d15 <nsipc_recv+0x39>
  801d11:	39 c6                	cmp    %eax,%esi
  801d13:	7d 16                	jge    801d2b <nsipc_recv+0x4f>
  801d15:	68 e7 2b 80 00       	push   $0x802be7
  801d1a:	68 a8 2b 80 00       	push   $0x802ba8
  801d1f:	6a 62                	push   $0x62
  801d21:	68 fc 2b 80 00       	push   $0x802bfc
  801d26:	e8 84 05 00 00       	call   8022af <_panic>
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  801d2b:	83 ec 04             	sub    $0x4,%esp
  801d2e:	50                   	push   %eax
  801d2f:	68 00 60 80 00       	push   $0x806000
  801d34:	ff 75 0c             	pushl  0xc(%ebp)
  801d37:	e8 78 ef ff ff       	call   800cb4 <memmove>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801d55:	a3 00 60 80 00       	mov    %eax,0x806000
	assert(size < 1600);
  801d5a:	81 fb 3f 06 00 00    	cmp    $0x63f,%ebx
  801d60:	7e 16                	jle    801d78 <nsipc_send+0x30>
  801d62:	68 08 2c 80 00       	push   $0x802c08
  801d67:	68 a8 2b 80 00       	push   $0x802ba8
  801d6c:	6a 6d                	push   $0x6d
  801d6e:	68 fc 2b 80 00       	push   $0x802bfc
  801d73:	e8 37 05 00 00       	call   8022af <_panic>
	memmove(&nsipcbuf.send.req_buf, buf, size);
  801d78:	83 ec 04             	sub    $0x4,%esp
  801d7b:	53                   	push   %ebx
  801d7c:	ff 75 0c             	pushl  0xc(%ebp)
  801d7f:	68 0c 60 80 00       	push   $0x80600c
  801d84:	e8 2b ef ff ff       	call   800cb4 <memmove>
	nsipcbuf.send.req_size = size;
  801d89:	89 1d 04 60 80 00    	mov    %ebx,0x806004
	nsipcbuf.send.req_flags = flags;
  801d8f:	8b 45 14             	mov    0x14(%ebp),%eax
  801d92:	a3 08 60 80 00       	mov    %eax,0x806008
	return nsipc(NSREQ_SEND);
  801d97:	b8 08 00 00 00       	mov    $0x8,%eax
  801d9c:	e8 d9 fd ff ff       	call   801b7a <nsipc>
}
  801da1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801da4:	c9                   	leave  
  801da5:	c3                   	ret    

00801da6 <nsipc_socket>:
...
nsipc_socket(int domain, int type, int protocol)
{
  ...
  801dc4:	b8 09 00 00 00       	mov    $0x9,%eax
  801dc9:	e8 ac fd ff ff       	call   801b7a <nsipc>
}
  801dce:	c9                   	leave  
  801dcf:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dde:	e8 62 f3 ff ff       	call   801145 <fd2data>
  801de3:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801de5:	83 c4 08             	add    $0x8,%esp
  801de8:	68 14 2c 80 00       	push   $0x802c14
  801ded:	53                   	push   %ebx
  801dee:	e8 2f ed ff ff       	call   800b22 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801df3:	8b 46 04             	mov    0x4(%esi),%eax
  801df6:	2b 06                	sub    (%esi),%eax
  801df8:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801dfe:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801e05:	00 00 00 
	stat->st_dev = &devpipe;
  801e08:	c7 83 88 00 00 00 40 	movl   $0x803040,0x88(%ebx)
  801e0f:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801e2b:	e8 7a f1 ff ff       	call   800faa <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801e30:	89 1c 24             	mov    %ebx,(%esp)
  801e33:	e8 0d f3 ff ff       	call   801145 <fd2data>
  801e38:	83 c4 08             	add    $0x8,%esp
  801e3b:	50                   	push   %eax
  801e3c:	6a 00                	push   $0x0
  801e3e:	e8 67 f1 ff ff       	call   800faa <sys_page_unmap>
}
  801e43:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801e46:	c9                   	leave  
  801e47:	c3                   	ret    

00801e48 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e54:	89 d7                	mov    %edx,%edi
	...
	while (1) {
		n = thisenv->env_runs;
  801e56:	a1 18 40 80 00       	mov    0x804018,%eax
  801e5b:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801e5e:	83 ec 0c             	sub    $0xc,%esp
  801e61:	ff 75 e0             	pushl  -0x20(%ebp)
  801e64:	e8 82 05 00 00       	call   8023eb <pageref>
  801e69:	89 c3                	mov    %eax,%ebx
  801e6b:	89 3c 24             	mov    %edi,(%esp)
  801e6e:	e8 78 05 00 00       	call   8023eb <pageref>
  801e73:	83 c4 10             	add    $0x10,%esp
  801e76:	39 c3                	cmp    %eax,%ebx
  801e78:	0f 94 c1             	sete   %cl
  801e7b:	0f b6 c9             	movzbl %cl,%ecx
  801e7e:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801e81:	8b 15 18 40 80 00    	mov    0x804018,%edx
  801e87:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801e8a:	39 ce                	cmp    %ecx,%esi
  801e8c:	74 1b                	je     801ea9 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801e8e:	39 c3                	cmp    %eax,%ebx
  801e90:	75 c4                	jne    801e56 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801e92:	8b 42 58             	mov    0x58(%edx),%eax
  801e95:	ff 75 e4             	pushl  -0x1c(%ebp)
  801e98:	50                   	push   %eax
  801e99:	56                   	push   %esi
  801e9a:	68 1b 2c 80 00       	push   $0x802c1b
  801e9f:	e8 f9 e6 ff ff       	call   80059d <cprintf>
  801ea4:	83 c4 10             	add    $0x10,%esp
  801ea7:	eb ad                	jmp    801e56 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801ec0:	56                   	push   %esi
  801ec1:	e8 7f f2 ff ff       	call   801145 <fd2data>
  ...
  801ed0:	eb 4b                	jmp    801f1d <devpipe_write+0x69>
  ...
  801ed6:	e8 6d ff ff ff       	call   801e48 <_pipeisclosed>
  801edb:	85 c0                	test   %eax,%eax
  801edd:	75 48                	jne    801f27 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  801edf:	e8 22 f0 ff ff       	call   800f06 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801eee:	73 e2                	jae    801ed2 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801f1d:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801f20:	75 c2                	jne    801ee4 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801f25:	eb 05                	jmp    801f2c <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
  ...
  801f2c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  801f2f:	5b                   	pop    %ebx
  801f30:	5e                   	pop    %esi
  801f31:	5f                   	pop    %edi
  801f32:	5d                   	pop    %ebp
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801f3d:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801f40:	57                   	push   %edi
  801f41:	e8 ff f1 ff ff       	call   801145 <fd2data>
  ...
  801f50:	eb 3d                	jmp    801f8f <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801f52:	85 db                	test   %ebx,%ebx
  801f54:	74 04                	je     801f5a <devpipe_read+0x26>
				return i;
  801f56:	89 d8                	mov    %ebx,%eax
  801f58:	eb 44                	jmp    801f9e <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801f5a:	89 f2                	mov    %esi,%edx
  801f5c:	89 f8                	mov    %edi,%eax
  801f5e:	e8 e5 fe ff ff       	call   801e48 <_pipeisclosed>
  801f63:	85 c0                	test   %eax,%eax
  801f65:	75 32                	jne    801f99 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801f67:	e8 9a ef ff ff       	call   800f06 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801f6e:	3b 46 04             	cmp    0x4(%esi),%eax
  801f71:	74 df                	je     801f52 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801f73:	99                   	cltd   
  801f74:	c1 ea 1b             	shr    $0x1b,%edx
  801f77:	01 d0                	add    %edx,%eax
  801f79:	83 e0 1f             	and    $0x1f,%eax
  801f7c:	29 d0                	sub    %edx,%eax
  801f7e:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801f83:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801f86:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801f89:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801f8c:	83 c3 01             	add    $0x1,%ebx
  801f8f:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801f92:	75 d8                	jne    801f6c <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801f97:	eb 05                	jmp    801f9e <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  802021:	e8 1f f1 ff ff       	call   801145 <fd2data>
  ...
  802033:	e8 ed ee ff ff       	call   800f25 <sys_page_alloc>
  802038:	89 c3                	mov    %eax,%ebx
  80203a:	83 c4 10             	add    $0x10,%esp
  80203d:	85 c0                	test   %eax,%eax
  80203f:	0f 88 89 00 00 00    	js     8020ce <pipe+0x128>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  802045:	83 ec 0c             	sub    $0xc,%esp
  802048:	ff 75 f0             	pushl  -0x10(%ebp)
  80204b:	e8 f5 f0 ff ff       	call   801145 <fd2data>
  802050:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  802057:	50                   	push   %eax
  802058:	6a 00                	push   $0x0
  80205a:	56                   	push   %esi
  80205b:	6a 00                	push   $0x0
  80205d:	e8 06 ef ff ff       	call   800f68 <sys_page_map>
  802062:	89 c3                	mov    %eax,%ebx
  802064:	83 c4 20             	add    $0x20,%esp
  802067:	85 c0                	test   %eax,%eax
  802069:	78 55                	js     8020c0 <pipe+0x11a>
		goto err3;
  ...
  802079:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	fd1->fd_dev_id = devpipe.dev_id;
  802080:	8b 15 40 30 80 00    	mov    0x803040,%edx
  802086:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802089:	89 10                	mov    %edx,(%eax)
	fd1->fd_omode = O_WRONLY;
  80208b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80208e:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
  ...
  8020c6:	e8 df ee ff ff       	call   800faa <sys_page_unmap>
  ...
  8020d6:	e8 cf ee ff ff       	call   800faa <sys_page_unmap>
  8020db:	83 c4 10             	add    $0x10,%esp
    err1:
	sys_page_unmap(0, fd0);
  8020de:	83 ec 08             	sub    $0x8,%esp
  8020e1:	ff 75 f4             	pushl  -0xc(%ebp)
  8020e4:	6a 00                	push   $0x0
  8020e6:	e8 bf ee ff ff       	call   800faa <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  802106:	e8 a0 f0 ff ff       	call   8011ab <fd_lookup>
  ...
  802118:	e8 28 f0 ff ff       	call   801145 <fd2data>
	return _pipeisclosed(fd, p);
  80211d:	89 c2                	mov    %eax,%edx
  80211f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802122:	e8 21 fd ff ff       	call   801e48 <_pipeisclosed>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80213c:	68 33 2c 80 00       	push   $0x802c33
  802141:	ff 75 0c             	pushl  0xc(%ebp)
  802144:	e8 d9 e9 ff ff       	call   800b22 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  802154:	56                   	push   %esi
  802155:	53                   	push   %ebx
  802156:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  802161:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  802167:	eb 2d                	jmp    802196 <devcons_write+0x46>
		m = n - tot;
  ...
  80216e:	83 fb 7f             	cmp    $0x7f,%ebx
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  802171:	ba 7f 00 00 00       	mov    $0x7f,%edx
  802176:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  802179:	83 ec 04             	sub    $0x4,%esp
  80217c:	53                   	push   %ebx
  80217d:	03 45 0c             	add    0xc(%ebp),%eax
  802180:	50                   	push   %eax
  802181:	57                   	push   %edi
  802182:	e8 2d eb ff ff       	call   800cb4 <memmove>
		sys_cputs(buf, m);
  802187:	83 c4 08             	add    $0x8,%esp
  80218a:	53                   	push   %ebx
  80218b:	57                   	push   %edi
  80218c:	e8 d8 ec ff ff       	call   800e69 <sys_cputs>
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  802191:	01 de                	add    %ebx,%esi
  802193:	83 c4 10             	add    $0x10,%esp
  802196:	89 f0                	mov    %esi,%eax
  802198:	3b 75 10             	cmp    0x10(%ebp),%esi
  80219b:	72 cc                	jb     802169 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8021b4:	74 2a                	je     8021e0 <devcons_read+0x3b>
  8021b6:	eb 05                	jmp    8021bd <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8021b8:	e8 49 ed ff ff       	call   800f06 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8021bd:	e8 c5 ec ff ff       	call   800e87 <sys_cgetc>
  8021c2:	85 c0                	test   %eax,%eax
  8021c4:	74 f2                	je     8021b8 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  8021c6:	85 c0                	test   %eax,%eax
  8021c8:	78 16                	js     8021e0 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  8021ca:	83 f8 04             	cmp    $0x4,%eax
  8021cd:	74 0c                	je     8021db <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  8021cf:	8b 55 0c             	mov    0xc(%ebp),%edx
  8021d2:	88 02                	mov    %al,(%edx)
	return 1;
  8021d4:	b8 01 00 00 00       	mov    $0x1,%eax
  8021d9:	eb 05                	jmp    8021e0 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  8021eb:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputs(&c, 1);
  8021ee:	6a 01                	push   $0x1
  8021f0:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8021f3:	50                   	push   %eax
  8021f4:	e8 70 ec ff ff       	call   800e69 <sys_cputs>
}
...
getchar(void)
{
  ...
  80220c:	e8 00 f2 ff ff       	call   801411 <read>
	if (r < 0)
  802211:	83 c4 10             	add    $0x10,%esp
  802214:	85 c0                	test   %eax,%eax
  802216:	78 0f                	js     802227 <getchar+0x29>
		return r;
	if (r < 1)
  802218:	85 c0                	test   %eax,%eax
  80221a:	7e 06                	jle    802222 <getchar+0x24>
		return -E_EOF;
	return c;
  80221c:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  802220:	eb 05                	jmp    802227 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
...
iscons(int fdnum)
{
  ...
  802236:	e8 70 ef ff ff       	call   8011ab <fd_lookup>
  ...
  802245:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
opencons(void)
{
  ...
  80225e:	50                   	push   %eax
  80225f:	e8 f8 ee ff ff       	call   80115c <fd_alloc>
...
opencons(void)
{
  ...
  80226b:	78 3e                	js     8022ab <opencons+0x56>
		return r;
  ...
  80227a:	e8 a6 ec ff ff       	call   800f25 <sys_page_alloc>
  ...
  802286:	78 23                	js     8022ab <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  802288:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
  ...
  8022a0:	50                   	push   %eax
  8022a1:	e8 8f ee ff ff       	call   801135 <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022b3:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  8022b4:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8022b7:	8b 35 04 30 80 00    	mov    0x803004,%esi
  8022bd:	e8 25 ec ff ff       	call   800ee7 <sys_getenvid>
  8022c2:	83 ec 0c             	sub    $0xc,%esp
  8022c5:	ff 75 0c             	pushl  0xc(%ebp)
  8022c8:	ff 75 08             	pushl  0x8(%ebp)
  8022cb:	56                   	push   %esi
  8022cc:	50                   	push   %eax
  8022cd:	68 40 2c 80 00       	push   $0x802c40
  8022d2:	e8 c6 e2 ff ff       	call   80059d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8022d7:	83 c4 18             	add    $0x18,%esp
  8022da:	53                   	push   %ebx
  8022db:	ff 75 10             	pushl  0x10(%ebp)
  8022de:	e8 69 e2 ff ff       	call   80054c <vcprintf>
	cprintf("\n");
  8022e3:	c7 04 24 74 27 80 00 	movl   $0x802774,(%esp)
  8022ea:	e8 ae e2 ff ff       	call   80059d <cprintf>
  8022ef:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8022f2:	cc                   	int3   
  8022f3:	eb fd                	jmp    8022f2 <_panic+0x43>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802303:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  802305:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  80230a:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  80230d:	83 ec 0c             	sub    $0xc,%esp
  802310:	50                   	push   %eax
  802311:	e8 bf ed ff ff       	call   8010d5 <sys_ipc_recv>

	if (r < 0) {
  802316:	83 c4 10             	add    $0x10,%esp
  802319:	85 c0                	test   %eax,%eax
  80231b:	79 16                	jns    802333 <ipc_recv+0x3e>
		if (from_env_store)
  80231d:	85 f6                	test   %esi,%esi
  80231f:	74 06                	je     802327 <ipc_recv+0x32>
			*from_env_store = 0;
  802321:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  802327:	85 db                	test   %ebx,%ebx
  802329:	74 2c                	je     802357 <ipc_recv+0x62>
			*perm_store = 0;
  80232b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  802331:	eb 24                	jmp    802357 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  802333:	85 f6                	test   %esi,%esi
  802335:	74 0a                	je     802341 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  802337:	a1 18 40 80 00       	mov    0x804018,%eax
  80233c:	8b 40 74             	mov    0x74(%eax),%eax
  80233f:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  802341:	85 db                	test   %ebx,%ebx
  802343:	74 0a                	je     80234f <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  802345:	a1 18 40 80 00       	mov    0x804018,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802370:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  802372:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  802377:	0f 44 d8             	cmove  %eax,%ebx
	}
  ...
  80237e:	56                   	push   %esi
  80237f:	57                   	push   %edi
  802380:	e8 2d ed ff ff       	call   8010b2 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  802385:	83 c4 10             	add    $0x10,%esp
  802388:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80238b:	75 07                	jne    802394 <ipc_send+0x36>
			sys_yield();
  80238d:	e8 74 eb ff ff       	call   800f06 <sys_yield>
  802392:	eb e6                	jmp    80237a <ipc_send+0x1c>
		} else if (r < 0) {
  802394:	85 c0                	test   %eax,%eax
  802396:	79 12                	jns    8023aa <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  802398:	50                   	push   %eax
  802399:	68 64 2c 80 00       	push   $0x802c64
  80239e:	6a 51                	push   $0x51
  8023a0:	68 71 2c 80 00       	push   $0x802c71
  8023a5:	e8 05 ff ff ff       	call   8022af <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  8023dd:	3d 00 04 00 00       	cmp    $0x400,%eax
  8023e2:	75 d9                	jne    8023bd <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
