...
umain(int argc, char **argv)
{
  ...
  8000b7:	50                   	push   %eax
  8000b8:	68 40 13 80 00       	push   $0x801340
  8000bd:	6a 21                	push   $0x21
  8000bf:	68 68 13 80 00       	push   $0x801368
  ...
  8000d7:	52                   	push   %edx
  8000d8:	50                   	push   %eax
  8000d9:	68 7b 13 80 00       	push   $0x80137b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800161:	56                   	push   %esi
  800162:	50                   	push   %eax
  800163:	68 a4 13 80 00       	push   $0x8013a4
  ...
  800174:	e8 54 00 00 00       	call   8001cd <vcprintf>
	cprintf("\n");
  800179:	c7 04 24 97 13 80 00 	movl   $0x801397,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800281:	e8 1a 0e 00 00       	call   8010a0 <__udivdi3>
  ...
  8002c4:	e8 07 0f 00 00       	call   8011d0 <__umoddi3>
  8002c9:	83 c4 14             	add    $0x14,%esp
  8002cc:	0f be 80 c7 13 80 00 	movsbl 0x8013c7(%eax),%eax
  8002d3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003c8:	ff 24 85 80 14 80 00 	jmp    *0x801480(,%eax,4)
  ...
  80048c:	8b 14 85 e0 15 80 00 	mov    0x8015e0(,%eax,4),%edx
  800493:	85 d2                	test   %edx,%edx
  800495:	75 18                	jne    8004af <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800497:	50                   	push   %eax
  800498:	68 df 13 80 00       	push   $0x8013df
  80049d:	53                   	push   %ebx
  80049e:	56                   	push   %esi
  ...
  8004af:	52                   	push   %edx
  8004b0:	68 e8 13 80 00       	push   $0x8013e8
  8004b5:	53                   	push   %ebx
  8004b6:	56                   	push   %esi
  ...
  8004d4:	b8 d8 13 80 00       	mov    $0x8013d8,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4f:	68 04 16 80 00       	push   $0x801604
  800b54:	6a 23                	push   $0x23
  800b56:	68 21 16 80 00       	push   $0x801621
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd0:	68 04 16 80 00       	push   $0x801604
  800bd5:	6a 23                	push   $0x23
  800bd7:	68 21 16 80 00       	push   $0x801621
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c12:	68 04 16 80 00       	push   $0x801604
  800c17:	6a 23                	push   $0x23
  800c19:	68 21 16 80 00       	push   $0x801621
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c54:	68 04 16 80 00       	push   $0x801604
  800c59:	6a 23                	push   $0x23
  800c5b:	68 21 16 80 00       	push   $0x801621
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c96:	68 04 16 80 00       	push   $0x801604
  800c9b:	6a 23                	push   $0x23
  800c9d:	68 21 16 80 00       	push   $0x801621
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cd8:	68 04 16 80 00       	push   $0x801604
  800cdd:	6a 23                	push   $0x23
  800cdf:	68 21 16 80 00       	push   $0x801621
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3c:	68 04 16 80 00       	push   $0x801604
  800d41:	6a 23                	push   $0x23
  800d43:	68 21 16 80 00       	push   $0x801621
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d63:	74 2c                	je     800d91 <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
  800d65:	89 d8                	mov    %ebx,%eax
  800d67:	c1 e8 16             	shr    $0x16,%eax
  800d6a:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
  800d71:	a8 01                	test   $0x1,%al
  800d73:	74 1c                	je     800d91 <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
  800d75:	89 de                	mov    %ebx,%esi
  800d77:	c1 ee 0c             	shr    $0xc,%esi
  800d7a:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   (see <inc/memlayout.h>).
  ...
  800d83:	74 0c                	je     800d91 <pgfault+0x3c>
	      (uvpt[PGNUM(addr)] & PTE_P) &&
  ...
  800d85:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	...
	if (!((err & FEC_WR) &&
  800d8c:	f6 c4 08             	test   $0x8,%ah
  800d8f:	75 14                	jne    800da5 <pgfault+0x50>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
		panic("not copy on write");
  800d91:	83 ec 04             	sub    $0x4,%esp
  800d94:	68 2f 16 80 00       	push   $0x80162f
  800d99:	6a 21                	push   $0x21
  800d9b:	68 41 16 80 00       	push   $0x801641
  800da0:	e8 a0 f3 ff ff       	call   800145 <_panic>
	// Hint:
  ...
  800da5:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  ...
  800dcf:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	...
	memcpy(PFTEMP, addr, PGSIZE);
	sys_page_map(0, PFTEMP,
  800dd6:	25 05 06 00 00       	and    $0x605,%eax
  800ddb:	83 c8 02             	or     $0x2,%eax
  800dde:	89 04 24             	mov    %eax,(%esp)
  800de1:	53                   	push   %ebx
  800de2:	6a 00                	push   $0x0
  800de4:	68 00 f0 7f 00       	push   $0x7ff000
  800de9:	6a 00                	push   $0x0
  800deb:	e8 f9 fd ff ff       	call   800be9 <sys_page_map>
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
	sys_page_unmap(0, PFTEMP);
  800df0:	83 c4 18             	add    $0x18,%esp
  800df3:	68 00 f0 7f 00       	push   $0x7ff000
  800df8:	6a 00                	push   $0x0
  800dfa:	e8 2c fe ff ff       	call   800c2b <sys_page_unmap>
	return;
...
fork(void)
{
  ...
  800e12:	68 55 0d 80 00       	push   $0x800d55
  800e17:	e8 f0 01 00 00       	call   80100c <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800e2b:	79 14                	jns    800e41 <fork+0x38>
		panic ("No memory");
  800e2d:	83 ec 04             	sub    $0x4,%esp
  800e30:	68 4c 16 80 00       	push   $0x80164c
  800e35:	6a 77                	push   $0x77
  800e37:	68 41 16 80 00       	push   $0x801641
  800e3c:	e8 04 f3 ff ff       	call   800145 <_panic>
  800e41:	89 c7                	mov    %eax,%edi
  800e43:	bb 00 00 00 00       	mov    $0x0,%ebx
	else if (r == 0)
  800e48:	85 c0                	test   %eax,%eax
  800e4a:	75 31                	jne    800e7d <fork+0x74>
	{
		set_pgfault_handler(pgfault);
  800e4c:	83 ec 0c             	sub    $0xc,%esp
  800e4f:	68 55 0d 80 00       	push   $0x800d55
  800e54:	e8 b3 01 00 00       	call   80100c <set_pgfault_handler>
		thisenv = &envs[ENVX(sys_getenvid())];
  800e59:	e8 0a fd ff ff       	call   800b68 <sys_getenvid>
  800e5e:	25 ff 03 00 00       	and    $0x3ff,%eax
  800e63:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e66:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e6b:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  800e70:	83 c4 10             	add    $0x10,%esp
  800e73:	b8 00 00 00 00       	mov    $0x0,%eax
  800e78:	e9 6d 01 00 00       	jmp    800fea <fork+0x1e1>
	}
  ...
  800e7f:	c1 e8 16             	shr    $0x16,%eax
  800e82:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  800e89:	a8 01                	test   $0x1,%al
  800e8b:	0f 84 c2 00 00 00    	je     800f53 <fork+0x14a>
  800e91:	89 d8                	mov    %ebx,%eax
  800e93:	c1 e8 0c             	shr    $0xc,%eax
  800e96:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e9d:	f6 c2 01             	test   $0x1,%dl
  800ea0:	0f 84 ad 00 00 00    	je     800f53 <fork+0x14a>
			&& (uvpt [PGNUM(i)] & PTE_U))
  800ea6:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800ead:	f6 c2 04             	test   $0x4,%dl
  800eb0:	0f 84 9d 00 00 00    	je     800f53 <fork+0x14a>
{
	int r;
  ...
  800eb8:	c1 e6 0c             	shl    $0xc,%esi

	if (uvpt[pn] & PTE_COW || uvpt[pn] & PTE_W)
  800ebb:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800ec2:	f6 c6 08             	test   $0x8,%dh
  800ec5:	75 0b                	jne    800ed2 <fork+0xc9>
  800ec7:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800ece:	a8 02                	test   $0x2,%al
  800ed0:	74 6d                	je     800f3f <fork+0x136>
	{
		if (sys_page_map(thisenv->env_id, address, envid, address, PTE_COW|PTE_U|PTE_P))
  800ed2:	a1 08 20 80 00       	mov    0x802008,%eax
  ...
  800ee6:	56                   	push   %esi
  800ee7:	50                   	push   %eax
  800ee8:	e8 fc fc ff ff       	call   800be9 <sys_page_map>
  800eed:	83 c4 20             	add    $0x20,%esp
  800ef0:	85 c0                	test   %eax,%eax
  800ef2:	74 14                	je     800f08 <fork+0xff>
            panic("sys_page_map failed");
  800ef4:	83 ec 04             	sub    $0x4,%esp
  800ef7:	68 56 16 80 00       	push   $0x801656
  800efc:	6a 4f                	push   $0x4f
  800efe:	68 41 16 80 00       	push   $0x801641
  800f03:	e8 3d f2 ff ff       	call   800145 <_panic>
        if (sys_page_map(thisenv->env_id, address, thisenv->env_id, address, PTE_COW|PTE_U|PTE_P))
  800f08:	a1 08 20 80 00       	mov    0x802008,%eax
  800f0d:	8b 50 48             	mov    0x48(%eax),%edx
  ...
  800f1d:	56                   	push   %esi
  800f1e:	50                   	push   %eax
  800f1f:	e8 c5 fc ff ff       	call   800be9 <sys_page_map>
  800f24:	83 c4 20             	add    $0x20,%esp
  800f27:	85 c0                	test   %eax,%eax
  800f29:	74 28                	je     800f53 <fork+0x14a>
            panic("sys_page_map failed");
  800f2b:	83 ec 04             	sub    $0x4,%esp
  800f2e:	68 56 16 80 00       	push   $0x801656
  800f33:	6a 51                	push   $0x51
  800f35:	68 41 16 80 00       	push   $0x801641
  ...
  800f4b:	e8 99 fc ff ff       	call   800be9 <sys_page_map>
  ...
  800f5f:	0f 85 18 ff ff ff    	jne    800e7d <fork+0x74>
		if ((uvpd [PDX(i)] & PTE_P) && (uvpt [PGNUM(i)] & PTE_P) 
			&& (uvpt [PGNUM(i)] & PTE_U))
			duppage (r, PGNUM(i));
	}
  ...
  800f6f:	57                   	push   %edi
  800f70:	e8 31 fc ff ff       	call   800ba6 <sys_page_alloc>
  800f75:	83 c4 10             	add    $0x10,%esp
  800f78:	85 c0                	test   %eax,%eax
  800f7a:	74 17                	je     800f93 <fork+0x18a>
		panic ("sys_page_alloc error in fork()");
  800f7c:	83 ec 04             	sub    $0x4,%esp
  800f7f:	68 80 16 80 00       	push   $0x801680
  800f84:	68 88 00 00 00       	push   $0x88
  800f89:	68 41 16 80 00       	push   $0x801641
  800f8e:	e8 b2 f1 ff ff       	call   800145 <_panic>

	extern void _pgfault_upcall();
	if(sys_env_set_pgfault_upcall(r, _pgfault_upcall))
  800f93:	83 ec 08             	sub    $0x8,%esp
  800f96:	68 7b 10 80 00       	push   $0x80107b
  800f9b:	57                   	push   %edi
  800f9c:	e8 0e fd ff ff       	call   800caf <sys_env_set_pgfault_upcall>
  800fa1:	83 c4 10             	add    $0x10,%esp
  800fa4:	85 c0                	test   %eax,%eax
  800fa6:	74 17                	je     800fbf <fork+0x1b6>
		panic ("sys_env_set_pgfault_upcall error in fork()");
  800fa8:	83 ec 04             	sub    $0x4,%esp
  800fab:	68 a0 16 80 00       	push   $0x8016a0
  800fb0:	68 8c 00 00 00       	push   $0x8c
  800fb5:	68 41 16 80 00       	push   $0x801641
  800fba:	e8 86 f1 ff ff       	call   800145 <_panic>

	if (sys_env_set_status(r, ENV_RUNNABLE))
  800fbf:	83 ec 08             	sub    $0x8,%esp
  800fc2:	6a 02                	push   $0x2
  800fc4:	57                   	push   %edi
  800fc5:	e8 a3 fc ff ff       	call   800c6d <sys_env_set_status>
  800fca:	83 c4 10             	add    $0x10,%esp
  800fcd:	85 c0                	test   %eax,%eax
  800fcf:	74 17                	je     800fe8 <fork+0x1df>
		panic ("Cannot set status in sys_env_set_status");
  800fd1:	83 ec 04             	sub    $0x4,%esp
  800fd4:	68 cc 16 80 00       	push   $0x8016cc
  800fd9:	68 8f 00 00 00       	push   $0x8f
  800fde:	68 41 16 80 00       	push   $0x801641
  800fe3:	e8 5d f1 ff ff       	call   800145 <_panic>
	return r;
...
sfork(void)
{
  ...
  800ff8:	68 6a 16 80 00       	push   $0x80166a
  800ffd:	68 9b 00 00 00       	push   $0x9b
  801002:	68 41 16 80 00       	push   $0x801641
  801007:	e8 39 f1 ff ff       	call   800145 <_panic>

0080100c <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801012:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  801019:	75 2c                	jne    801047 <set_pgfault_handler+0x3b>
		// First time through!
		// LAB 4: Your code here.
  ...
  801027:	e8 7a fb ff ff       	call   800ba6 <sys_page_alloc>
  80102c:	83 c4 10             	add    $0x10,%esp
  80102f:	85 c0                	test   %eax,%eax
  801031:	74 14                	je     801047 <set_pgfault_handler+0x3b>
			PTE_P | PTE_U | PTE_W))
			
        	panic("sys_page_alloc failed.");
  801033:	83 ec 04             	sub    $0x4,%esp
  801036:	68 f4 16 80 00       	push   $0x8016f4
  80103b:	6a 24                	push   $0x24
  80103d:	68 0b 17 80 00       	push   $0x80170b
  801042:	e8 fe f0 ff ff       	call   800145 <_panic>
  ...
  80104a:	a3 0c 20 80 00       	mov    %eax,0x80200c
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  80104f:	83 ec 08             	sub    $0x8,%esp
  801052:	68 7b 10 80 00       	push   $0x80107b
  801057:	6a 00                	push   $0x0
  801059:	e8 51 fc ff ff       	call   800caf <sys_env_set_pgfault_upcall>
  80105e:	83 c4 10             	add    $0x10,%esp
  801061:	85 c0                	test   %eax,%eax
  801063:	79 14                	jns    801079 <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  801065:	83 ec 04             	sub    $0x4,%esp
  801068:	68 1c 17 80 00       	push   $0x80171c
  80106d:	6a 2b                	push   $0x2b
  80106f:	68 0b 17 80 00       	push   $0x80170b
  801074:	e8 cc f0 ff ff       	call   800145 <_panic>
...
_pgfault_upcall:
  ...
  80107c:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  801086:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  80108a:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  80108f:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
