	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bb:	e8 50 1a 00 00       	call   801d10 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004a6:	52                   	push   %edx
  8004a7:	68 3a 23 80 00       	push   $0x80233a
  8004ac:	53                   	push   %ebx
  8004ad:	56                   	push   %esi
...
stat(const char *path, struct Stat *stat)
{
  ...
  80130d:	e8 0c 02 00 00       	call   80151e <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801354:	e8 05 08 00 00       	call   801b5e <ipc_find_env>
  ...
  80136f:	e8 96 07 00 00       	call   801b0a <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801374:	83 c4 0c             	add    $0xc,%esp
  801377:	6a 00                	push   $0x0
  801379:	53                   	push   %ebx
  80137a:	6a 00                	push   $0x0
  80137c:	e8 20 07 00 00       	call   801aa1 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80143d:	89 15 00 50 c0 00    	mov    %edx,0xc05000
  801443:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801448:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  80144d:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  801450:	89 1d 04 50 c0 00    	mov    %ebx,0xc05004
  ...
  801478:	78 1d                	js     801497 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  80147a:	39 d8                	cmp    %ebx,%eax
  80147c:	76 19                	jbe    801497 <devfile_write+0x6a>
  80147e:	68 1c 23 80 00       	push   $0x80231c
  801483:	68 28 23 80 00       	push   $0x802328
  801488:	68 a3 00 00 00       	push   $0xa3
  80148d:	68 3d 23 80 00       	push   $0x80233d
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014aa:	a3 00 50 c0 00       	mov    %eax,0xc05000
	fsipcbuf.read.req_n = n;
  8014af:	89 35 04 50 c0 00    	mov    %esi,0xc05004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8014b5:	ba 00 00 00 00       	mov    $0x0,%edx
  8014ba:	b8 03 00 00 00       	mov    $0x3,%eax
  8014bf:	e8 79 fe ff ff       	call   80133d <fsipc>
  8014c4:	89 c3                	mov    %eax,%ebx
  8014c6:	85 c0                	test   %eax,%eax
  8014c8:	78 4b                	js     801515 <devfile_read+0x79>
		return r;
	assert(r <= n);
  8014ca:	39 c6                	cmp    %eax,%esi
  8014cc:	73 16                	jae    8014e4 <devfile_read+0x48>
  8014ce:	68 48 23 80 00       	push   $0x802348
  8014d3:	68 28 23 80 00       	push   $0x802328
  8014d8:	6a 7c                	push   $0x7c
  8014da:	68 3d 23 80 00       	push   $0x80233d
  8014df:	e8 58 ec ff ff       	call   80013c <_panic>
	assert(r <= PGSIZE);
  8014e4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8014e9:	7e 16                	jle    801501 <devfile_read+0x65>
  8014eb:	68 4f 23 80 00       	push   $0x80234f
  8014f0:	68 28 23 80 00       	push   $0x802328
  8014f5:	6a 7d                	push   $0x7d
  8014f7:	68 3d 23 80 00       	push   $0x80233d
  8014fc:	e8 3b ec ff ff       	call   80013c <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801501:	83 ec 04             	sub    $0x4,%esp
  801504:	50                   	push   %eax
  801505:	68 00 50 c0 00       	push   $0xc05000
  80150a:	ff 75 0c             	pushl  0xc(%ebp)
  80150d:	e8 1a f4 ff ff       	call   80092c <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  801528:	53                   	push   %ebx
  801529:	e8 33 f2 ff ff       	call   800761 <strlen>
  80152e:	83 c4 10             	add    $0x10,%esp
  801531:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801536:	7f 67                	jg     80159f <open+0x81>
		return -E_BAD_PATH;
  ...
  80153e:	50                   	push   %eax
  80153f:	e8 71 f8 ff ff       	call   800db5 <fd_alloc>
  ...
  80159d:	eb 05                	jmp    8015a4 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  80159f:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  8015bb:	e8 7d fd ff ff       	call   80133d <fsipc>
}
  8015c0:	c9                   	leave  
  8015c1:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015da:	68 5b 23 80 00       	push   $0x80235b
  8015df:	53                   	push   %ebx
  8015e0:	e8 b5 f1 ff ff       	call   80079a <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  80161d:	e8 00 f6 ff ff       	call   800c22 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801622:	89 1c 24             	mov    %ebx,(%esp)
  801625:	e8 74 f7 ff ff       	call   800d9e <fd2data>
  80162a:	83 c4 08             	add    $0x8,%esp
  80162d:	50                   	push   %eax
  80162e:	6a 00                	push   $0x0
  801630:	e8 ed f5 ff ff       	call   800c22 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801646:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801648:	a1 20 40 c0 00       	mov    0xc04020,%eax
  80164d:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801650:	83 ec 0c             	sub    $0xc,%esp
  801653:	ff 75 e0             	pushl  -0x20(%ebp)
  801656:	e8 3c 05 00 00       	call   801b97 <pageref>
  80165b:	89 c3                	mov    %eax,%ebx
  80165d:	89 3c 24             	mov    %edi,(%esp)
  801660:	e8 32 05 00 00       	call   801b97 <pageref>
  801665:	83 c4 10             	add    $0x10,%esp
  801668:	39 c3                	cmp    %eax,%ebx
  80166a:	0f 94 c1             	sete   %cl
  80166d:	0f b6 c9             	movzbl %cl,%ecx
  801670:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801673:	8b 15 20 40 c0 00    	mov    0xc04020,%edx
  801679:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  80167c:	39 ce                	cmp    %ecx,%esi
  80167e:	74 1b                	je     80169b <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801680:	39 c3                	cmp    %eax,%ebx
  801682:	75 c4                	jne    801648 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801684:	8b 42 58             	mov    0x58(%edx),%eax
  801687:	ff 75 e4             	pushl  -0x1c(%ebp)
  80168a:	50                   	push   %eax
  80168b:	56                   	push   %esi
  80168c:	68 62 23 80 00       	push   $0x802362
  801691:	e8 7f eb ff ff       	call   800215 <cprintf>
  801696:	83 c4 10             	add    $0x10,%esp
  801699:	eb ad                	jmp    801648 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016b2:	56                   	push   %esi
  8016b3:	e8 e6 f6 ff ff       	call   800d9e <fd2data>
  ...
  8016c8:	e8 6d ff ff ff       	call   80163a <_pipeisclosed>
  ...
  8016cf:	75 48                	jne    801719 <devpipe_write+0x73>
			...
			sys_yield();
  8016d1:	e8 a8 f4 ff ff       	call   800b7e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80172f:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801732:	57                   	push   %edi
  801733:	e8 66 f6 ff ff       	call   800d9e <fd2data>
  ...
  801757:	75 32                	jne    80178b <devpipe_read+0x65>
			...
			sys_yield();
  801759:	e8 20 f4 ff ff       	call   800b7e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8017a3:	50                   	push   %eax
  8017a4:	e8 0c f6 ff ff       	call   800db5 <fd_alloc>
  ...
  8017c3:	e8 d5 f3 ff ff       	call   800b9d <sys_page_alloc>
  ...
  8017db:	50                   	push   %eax
  8017dc:	e8 d4 f5 ff ff       	call   800db5 <fd_alloc>
  ...
  8017fb:	e8 9d f3 ff ff       	call   800b9d <sys_page_alloc>
  ...
  801813:	e8 86 f5 ff ff       	call   800d9e <fd2data>
  ...
  801825:	e8 73 f3 ff ff       	call   800b9d <sys_page_alloc>
  ...
  80183d:	e8 5c f5 ff ff       	call   800d9e <fd2data>
  801842:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801849:	50                   	push   %eax
  80184a:	6a 00                	push   $0x0
  80184c:	56                   	push   %esi
  80184d:	6a 00                	push   $0x0
  80184f:	e8 8c f3 ff ff       	call   800be0 <sys_page_map>
  ...
  8018b8:	e8 65 f3 ff ff       	call   800c22 <sys_page_unmap>
  ...
  8018c8:	e8 55 f3 ff ff       	call   800c22 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  8018f8:	e8 07 f5 ff ff       	call   800e04 <fd_lookup>
  8018fd:	83 c4 10             	add    $0x10,%esp
  801900:	85 c0                	test   %eax,%eax
  801902:	78 18                	js     80191c <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801904:	83 ec 0c             	sub    $0xc,%esp
  801907:	ff 75 f4             	pushl  -0xc(%ebp)
  80190a:	e8 8f f4 ff ff       	call   800d9e <fd2data>
	return _pipeisclosed(fd, p);
  80190f:	89 c2                	mov    %eax,%edx
  801911:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801914:	e8 21 fd ff ff       	call   80163a <_pipeisclosed>
  801919:	83 c4 10             	add    $0x10,%esp
}
  80191c:	c9                   	leave  
  80191d:	c3                   	ret    

0080191e <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80192e:	68 7a 23 80 00       	push   $0x80237a
  801933:	ff 75 0c             	pushl  0xc(%ebp)
  801936:	e8 5f ee ff ff       	call   80079a <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801953:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801959:	eb 2d                	jmp    801988 <devcons_write+0x46>
		m = n - tot;
  80195b:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80195e:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801960:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801963:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801968:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  80196b:	83 ec 04             	sub    $0x4,%esp
  80196e:	53                   	push   %ebx
  80196f:	03 45 0c             	add    0xc(%ebp),%eax
  801972:	50                   	push   %eax
  801973:	57                   	push   %edi
  801974:	e8 b3 ef ff ff       	call   80092c <memmove>
		sys_cputs(buf, m);
  801979:	83 c4 08             	add    $0x8,%esp
  80197c:	53                   	push   %ebx
  80197d:	57                   	push   %edi
  80197e:	e8 5e f1 ff ff       	call   800ae1 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8019a6:	74 2a                	je     8019d2 <devcons_read+0x3b>
  8019a8:	eb 05                	jmp    8019af <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8019aa:	e8 cf f1 ff ff       	call   800b7e <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8019af:	e8 4b f1 ff ff       	call   800aff <sys_cgetc>
  8019b4:	85 c0                	test   %eax,%eax
  8019b6:	74 f2                	je     8019aa <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  8019b8:	85 c0                	test   %eax,%eax
  8019ba:	78 16                	js     8019d2 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  8019bc:	83 f8 04             	cmp    $0x4,%eax
  8019bf:	74 0c                	je     8019cd <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  8019c1:	8b 55 0c             	mov    0xc(%ebp),%edx
  8019c4:	88 02                	mov    %al,(%edx)
	return 1;
  8019c6:	b8 01 00 00 00       	mov    $0x1,%eax
  8019cb:	eb 05                	jmp    8019d2 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  8019e2:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8019e5:	50                   	push   %eax
  8019e6:	e8 f6 f0 ff ff       	call   800ae1 <sys_cputs>
}
...
getchar(void)
{
  ...
  8019f8:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8019fb:	50                   	push   %eax
  8019fc:	6a 00                	push   $0x0
  8019fe:	e8 67 f6 ff ff       	call   80106a <read>
	if (r < 0)
  801a03:	83 c4 10             	add    $0x10,%esp
  801a06:	85 c0                	test   %eax,%eax
  801a08:	78 0f                	js     801a19 <getchar+0x29>
		return r;
	if (r < 1)
  801a0a:	85 c0                	test   %eax,%eax
  801a0c:	7e 06                	jle    801a14 <getchar+0x24>
		return -E_EOF;
	return c;
  801a0e:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801a12:	eb 05                	jmp    801a19 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801a14:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801a19:	c9                   	leave  
  801a1a:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  801a28:	e8 d7 f3 ff ff       	call   800e04 <fd_lookup>
  801a2d:	83 c4 10             	add    $0x10,%esp
  801a30:	85 c0                	test   %eax,%eax
  801a32:	78 11                	js     801a45 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  801a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a37:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801a3d:	39 10                	cmp    %edx,(%eax)
  801a3f:	0f 94 c0             	sete   %al
  801a42:	0f b6 c0             	movzbl %al,%eax
}
  801a45:	c9                   	leave  
  801a46:	c3                   	ret    
...
opencons(void)
{
  ...
  801a50:	50                   	push   %eax
  801a51:	e8 5f f3 ff ff       	call   800db5 <fd_alloc>
...
opencons(void)
{
  ...
  801a5d:	78 3e                	js     801a9d <opencons+0x56>
		return r;
  ...
  801a6c:	e8 2c f1 ff ff       	call   800b9d <sys_page_alloc>
  ...
  801a78:	78 23                	js     801a9d <opencons+0x56>
		return r;
  ...
  801a92:	50                   	push   %eax
  801a93:	e8 f6 f2 ff ff       	call   800d8e <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801aaf:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801ab1:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801ab6:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801ab9:	83 ec 0c             	sub    $0xc,%esp
  801abc:	50                   	push   %eax
  801abd:	e8 8b f2 ff ff       	call   800d4d <sys_ipc_recv>

	if (r < 0) {
  801ac2:	83 c4 10             	add    $0x10,%esp
  801ac5:	85 c0                	test   %eax,%eax
  801ac7:	79 16                	jns    801adf <ipc_recv+0x3e>
		if (from_env_store)
  801ac9:	85 f6                	test   %esi,%esi
  801acb:	74 06                	je     801ad3 <ipc_recv+0x32>
			*from_env_store = 0;
  801acd:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801ad3:	85 db                	test   %ebx,%ebx
  801ad5:	74 2c                	je     801b03 <ipc_recv+0x62>
			*perm_store = 0;
  801ad7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801add:	eb 24                	jmp    801b03 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801adf:	85 f6                	test   %esi,%esi
  801ae1:	74 0a                	je     801aed <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  801ae3:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801ae8:	8b 40 74             	mov    0x74(%eax),%eax
  801aeb:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  801aed:	85 db                	test   %ebx,%ebx
  801aef:	74 0a                	je     801afb <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  801af1:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801af6:	8b 40 78             	mov    0x78(%eax),%eax
  801af9:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  801afb:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801b00:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b16:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801b1c:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  801b1e:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801b23:	0f 44 d8             	cmove  %eax,%ebx
	}

	int r = -1;
	while (r < 0) {
		r = sys_ipc_try_send(to_env, val, va, perm);
  801b26:	ff 75 14             	pushl  0x14(%ebp)
  801b29:	53                   	push   %ebx
  801b2a:	56                   	push   %esi
  801b2b:	57                   	push   %edi
  801b2c:	e8 f9 f1 ff ff       	call   800d2a <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801b31:	83 c4 10             	add    $0x10,%esp
  801b34:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b37:	75 07                	jne    801b40 <ipc_send+0x36>
			sys_yield();
  801b39:	e8 40 f0 ff ff       	call   800b7e <sys_yield>
  801b3e:	eb e6                	jmp    801b26 <ipc_send+0x1c>
		} else if (r < 0) {
  801b40:	85 c0                	test   %eax,%eax
  801b42:	79 12                	jns    801b56 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801b44:	50                   	push   %eax
  801b45:	68 86 23 80 00       	push   $0x802386
  801b4a:	6a 51                	push   $0x51
  801b4c:	68 93 23 80 00       	push   $0x802393
  801b51:	e8 e6 e5 ff ff       	call   80013c <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b6c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b72:	8b 52 50             	mov    0x50(%edx),%edx
  801b75:	39 ca                	cmp    %ecx,%edx
  801b77:	75 0d                	jne    801b86 <ipc_find_env+0x28>
			return envs[i].env_id;
  801b79:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b7c:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b81:	8b 40 48             	mov    0x48(%eax),%eax
  801b84:	eb 0f                	jmp    801b95 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
...
pageref(void *v)
{
  ...
  801b9f:	c1 e8 16             	shr    $0x16,%eax
  801ba2:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801bae:	f6 c1 01             	test   $0x1,%cl
  801bb1:	74 1d                	je     801bd0 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801bb3:	c1 ea 0c             	shr    $0xc,%edx
  801bb6:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801bbd:	f6 c2 01             	test   $0x1,%dl
  801bc0:	74 0e                	je     801bd0 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801bc2:	c1 ea 0c             	shr    $0xc,%edx
  801bc5:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801bcc:	ef 
  801bcd:	0f b7 c0             	movzwl %ax,%eax
}
  801bd0:	5d                   	pop    %ebp
  801bd1:	c3                   	ret    
