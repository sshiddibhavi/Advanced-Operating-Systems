...
umain(int argc, char **argv)
{
  ...
  8000cb:	e8 58 18 00 00       	call   801928 <fprintf>
  ...
  8000df:	e8 44 18 00 00       	call   801928 <fprintf>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80044b:	e8 d0 1a 00 00       	call   801f20 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800636:	52                   	push   %edx
  800637:	68 0a 25 80 00       	push   $0x80250a
  80063c:	53                   	push   %ebx
  80063d:	56                   	push   %esi
...
readline(const char *prompt)
{
  ...
  800904:	50                   	push   %eax
  800905:	68 0a 25 80 00       	push   $0x80250a
  80090a:	6a 01                	push   $0x1
  80090c:	e8 17 10 00 00       	call   801928 <fprintf>
...
stat(const char *path, struct Stat *stat)
{
  ...
  801590:	e8 0c 02 00 00       	call   8017a1 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015d7:	e8 92 07 00 00       	call   801d6e <ipc_find_env>
  ...
  8015f2:	e8 23 07 00 00       	call   801d1a <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8015f7:	83 c4 0c             	add    $0xc,%esp
  8015fa:	6a 00                	push   $0x0
  8015fc:	53                   	push   %ebx
  8015fd:	6a 00                	push   $0x0
  8015ff:	e8 ad 06 00 00       	call   801cb1 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8016c6:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8016cb:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  8016d0:	0f 46 d8             	cmovbe %eax,%ebx
  ...
  8016dd:	68 08 50 80 00       	push   $0x805008
  8016e2:	e8 c8 f4 ff ff       	call   800baf <memmove>

	
	int r;
	if ((r = fsipc(FSREQ_WRITE, NULL)) < 0) 
  8016e7:	ba 00 00 00 00       	mov    $0x0,%edx
  8016ec:	b8 04 00 00 00       	mov    $0x4,%eax
  8016f1:	e8 ca fe ff ff       	call   8015c0 <fsipc>
  8016f6:	83 c4 10             	add    $0x10,%esp
  8016f9:	85 c0                	test   %eax,%eax
  8016fb:	78 1d                	js     80171a <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  8016fd:	39 d8                	cmp    %ebx,%eax
  8016ff:	76 19                	jbe    80171a <devfile_write+0x6a>
  801701:	68 ec 24 80 00       	push   $0x8024ec
  801706:	68 f8 24 80 00       	push   $0x8024f8
  80170b:	68 a3 00 00 00       	push   $0xa3
  801710:	68 0d 25 80 00       	push   $0x80250d
  801715:	e8 b2 eb ff ff       	call   8002cc <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801742:	e8 79 fe ff ff       	call   8015c0 <fsipc>
  ...
  801751:	68 18 25 80 00       	push   $0x802518
  801756:	68 f8 24 80 00       	push   $0x8024f8
  80175b:	6a 7c                	push   $0x7c
  80175d:	68 0d 25 80 00       	push   $0x80250d
  801762:	e8 65 eb ff ff       	call   8002cc <_panic>
	assert(r <= PGSIZE);
  801767:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80176c:	7e 16                	jle    801784 <devfile_read+0x65>
  80176e:	68 1f 25 80 00       	push   $0x80251f
  801773:	68 f8 24 80 00       	push   $0x8024f8
  801778:	6a 7d                	push   $0x7d
  80177a:	68 0d 25 80 00       	push   $0x80250d
  80177f:	e8 48 eb ff ff       	call   8002cc <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801784:	83 ec 04             	sub    $0x4,%esp
  801787:	50                   	push   %eax
  801788:	68 00 50 80 00       	push   $0x805000
  80178d:	ff 75 0c             	pushl  0xc(%ebp)
  801790:	e8 1a f4 ff ff       	call   800baf <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8017ab:	53                   	push   %ebx
  8017ac:	e8 33 f2 ff ff       	call   8009e4 <strlen>
  ...
  8017c1:	50                   	push   %eax
  8017c2:	e8 71 f8 ff ff       	call   801038 <fd_alloc>
  ...
  8017d9:	e8 3f f2 ff ff       	call   800a1d <strcpy>
  ...
  8017ee:	e8 cd fd ff ff       	call   8015c0 <fsipc>
  ...
  801804:	e8 27 f9 ff ff       	call   801130 <fd_close>
		return r;
  ...
  801816:	e8 f6 f7 ff ff       	call   801011 <fd2num>
...
sync(void)
{
  ...
  80183e:	e8 7d fd ff ff       	call   8015c0 <fsipc>
}
  801843:	c9                   	leave  
  801844:	c3                   	ret    
...
writebuf(struct printbuf *b)
{
  ...
  801849:	7e 37                	jle    801882 <writebuf+0x3d>
};
...
writebuf(struct printbuf *b)
{
  ...
  80185d:	e8 65 fb ff ff       	call   8013c7 <write>
		if (result > 0)
  ...
  80186c:	3b 43 04             	cmp    0x4(%ebx),%eax
  80186f:	74 0d                	je     80187e <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  801871:	85 c0                	test   %eax,%eax
  801873:	ba 00 00 00 00       	mov    $0x0,%edx
  801878:	0f 4f c2             	cmovg  %edx,%eax
  80187b:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  80187e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801881:	c9                   	leave  
  801882:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  80188b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  80188e:	8b 53 04             	mov    0x4(%ebx),%edx
  801891:	8d 42 01             	lea    0x1(%edx),%eax
  801894:	89 43 04             	mov    %eax,0x4(%ebx)
  801897:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80189a:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  80189e:	3d 00 01 00 00       	cmp    $0x100,%eax
  8018a3:	75 0e                	jne    8018b3 <putch+0x2f>
		writebuf(b);
  8018a5:	89 d8                	mov    %ebx,%eax
  8018a7:	e8 99 ff ff ff       	call   801845 <writebuf>
		b->idx = 0;
  8018ac:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	}
}
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  8018bc:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  8018c2:	8b 45 08             	mov    0x8(%ebp),%eax
  8018c5:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  8018cb:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  8018d2:	00 00 00 
	b.result = 0;
  8018d5:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8018dc:	00 00 00 
	b.error = 1;
  8018df:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  8018e6:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  8018e9:	ff 75 10             	pushl  0x10(%ebp)
  8018ec:	ff 75 0c             	pushl  0xc(%ebp)
  8018ef:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  8018f5:	50                   	push   %eax
  8018f6:	68 84 18 80 00       	push   $0x801884
  8018fb:	e8 dc eb ff ff       	call   8004dc <vprintfmt>
	if (b.idx > 0)
  801900:	83 c4 10             	add    $0x10,%esp
  801903:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  80190a:	7e 0b                	jle    801917 <vfprintf+0x5e>
		writebuf(&b);
  80190c:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801912:	e8 2e ff ff ff       	call   801845 <writebuf>

	return (b.result ? b.result : b.error);
  801917:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  80191d:	85 c0                	test   %eax,%eax
  80191f:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  801926:	c9                   	leave  
  801927:	c3                   	ret    
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  80192b:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  80192e:	8d 45 10             	lea    0x10(%ebp),%eax
	cnt = vfprintf(fd, fmt, ap);
  801931:	50                   	push   %eax
  801932:	ff 75 0c             	pushl  0xc(%ebp)
  801935:	ff 75 08             	pushl  0x8(%ebp)
  801938:	e8 7c ff ff ff       	call   8018b9 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  80194e:	e8 66 ff ff ff       	call   8018b9 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80196d:	68 2b 25 80 00       	push   $0x80252b
  801972:	53                   	push   %ebx
  801973:	e8 a5 f0 ff ff       	call   800a1d <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801978:	8b 46 04             	mov    0x4(%esi),%eax
  80197b:	2b 06                	sub    (%esi),%eax
  80197d:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801983:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  80198a:	00 00 00 
	stat->st_dev = &devpipe;
  80198d:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  801994:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8019b0:	e8 f0 f4 ff ff       	call   800ea5 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8019b5:	89 1c 24             	mov    %ebx,(%esp)
  8019b8:	e8 64 f6 ff ff       	call   801021 <fd2data>
  8019bd:	83 c4 08             	add    $0x8,%esp
  8019c0:	50                   	push   %eax
  8019c1:	6a 00                	push   $0x0
  8019c3:	e8 dd f4 ff ff       	call   800ea5 <sys_page_unmap>
}
  8019c8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8019cb:	c9                   	leave  
  8019cc:	c3                   	ret    

008019cd <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8019d9:	89 d7                	mov    %edx,%edi
	...
	while (1) {
		n = thisenv->env_runs;
  8019db:	a1 04 44 80 00       	mov    0x804404,%eax
  8019e0:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  8019e3:	83 ec 0c             	sub    $0xc,%esp
  8019e6:	ff 75 e0             	pushl  -0x20(%ebp)
  8019e9:	e8 b9 03 00 00       	call   801da7 <pageref>
  8019ee:	89 c3                	mov    %eax,%ebx
  8019f0:	89 3c 24             	mov    %edi,(%esp)
  8019f3:	e8 af 03 00 00       	call   801da7 <pageref>
  8019f8:	83 c4 10             	add    $0x10,%esp
  8019fb:	39 c3                	cmp    %eax,%ebx
  8019fd:	0f 94 c1             	sete   %cl
  801a00:	0f b6 c9             	movzbl %cl,%ecx
  801a03:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801a06:	8b 15 04 44 80 00    	mov    0x804404,%edx
  801a0c:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801a0f:	39 ce                	cmp    %ecx,%esi
  801a11:	74 1b                	je     801a2e <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801a13:	39 c3                	cmp    %eax,%ebx
  801a15:	75 c4                	jne    8019db <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801a17:	8b 42 58             	mov    0x58(%edx),%eax
  801a1a:	ff 75 e4             	pushl  -0x1c(%ebp)
  801a1d:	50                   	push   %eax
  801a1e:	56                   	push   %esi
  801a1f:	68 32 25 80 00       	push   $0x802532
  801a24:	e8 7c e9 ff ff       	call   8003a5 <cprintf>
  801a29:	83 c4 10             	add    $0x10,%esp
  801a2c:	eb ad                	jmp    8019db <_pipeisclosed+0xe>
	}
}
  801a2e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801a45:	56                   	push   %esi
  801a46:	e8 d6 f5 ff ff       	call   801021 <fd2data>
  ...
  801a5b:	e8 6d ff ff ff       	call   8019cd <_pipeisclosed>
  ...
  801a62:	75 48                	jne    801aac <devpipe_write+0x73>
			...
			sys_yield();
  801a64:	e8 98 f3 ff ff       	call   800e01 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801ac2:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801ac5:	57                   	push   %edi
  801ac6:	e8 56 f5 ff ff       	call   801021 <fd2data>
  ...
  801ae3:	e8 e5 fe ff ff       	call   8019cd <_pipeisclosed>
  ...
  801aea:	75 32                	jne    801b1e <devpipe_read+0x65>
			...
			sys_yield();
  801aec:	e8 10 f3 ff ff       	call   800e01 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801b36:	50                   	push   %eax
  801b37:	e8 fc f4 ff ff       	call   801038 <fd_alloc>
  ...
  801b56:	e8 c5 f2 ff ff       	call   800e20 <sys_page_alloc>
  ...
  801b6e:	50                   	push   %eax
  801b6f:	e8 c4 f4 ff ff       	call   801038 <fd_alloc>
  ...
  801b8e:	e8 8d f2 ff ff       	call   800e20 <sys_page_alloc>
  ...
  801ba6:	e8 76 f4 ff ff       	call   801021 <fd2data>
  ...
  801bb8:	e8 63 f2 ff ff       	call   800e20 <sys_page_alloc>
  ...
  801bd0:	e8 4c f4 ff ff       	call   801021 <fd2data>
  801bd5:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801bdc:	50                   	push   %eax
  801bdd:	6a 00                	push   $0x0
  801bdf:	56                   	push   %esi
  801be0:	6a 00                	push   $0x0
  801be2:	e8 7c f2 ff ff       	call   800e63 <sys_page_map>
  ...
  801c4b:	e8 55 f2 ff ff       	call   800ea5 <sys_page_unmap>
  ...
  801c5b:	e8 45 f2 ff ff       	call   800ea5 <sys_page_unmap>
  ...
  801c6b:	e8 35 f2 ff ff       	call   800ea5 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801c95:	78 18                	js     801caf <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801c97:	83 ec 0c             	sub    $0xc,%esp
  801c9a:	ff 75 f4             	pushl  -0xc(%ebp)
  801c9d:	e8 7f f3 ff ff       	call   801021 <fd2data>
	return _pipeisclosed(fd, p);
  801ca2:	89 c2                	mov    %eax,%edx
  801ca4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ca7:	e8 21 fd ff ff       	call   8019cd <_pipeisclosed>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cbf:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801cc1:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801cc6:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801cc9:	83 ec 0c             	sub    $0xc,%esp
  801ccc:	50                   	push   %eax
  801ccd:	e8 fe f2 ff ff       	call   800fd0 <sys_ipc_recv>

	if (r < 0) {
  801cd2:	83 c4 10             	add    $0x10,%esp
  801cd5:	85 c0                	test   %eax,%eax
  801cd7:	79 16                	jns    801cef <ipc_recv+0x3e>
		if (from_env_store)
  801cd9:	85 f6                	test   %esi,%esi
  801cdb:	74 06                	je     801ce3 <ipc_recv+0x32>
			*from_env_store = 0;
  801cdd:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801ce3:	85 db                	test   %ebx,%ebx
  801ce5:	74 2c                	je     801d13 <ipc_recv+0x62>
			*perm_store = 0;
  801ce7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801ced:	eb 24                	jmp    801d13 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801cef:	85 f6                	test   %esi,%esi
  801cf1:	74 0a                	je     801cfd <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  801cf3:	a1 04 44 80 00       	mov    0x804404,%eax
  801cf8:	8b 40 74             	mov    0x74(%eax),%eax
  801cfb:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  801cfd:	85 db                	test   %ebx,%ebx
  801cff:	74 0a                	je     801d0b <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  801d01:	a1 04 44 80 00       	mov    0x804404,%eax
  801d06:	8b 40 78             	mov    0x78(%eax),%eax
  801d09:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  801d0b:	a1 04 44 80 00       	mov    0x804404,%eax
  801d10:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d2c:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  801d2e:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801d33:	0f 44 d8             	cmove  %eax,%ebx
	}
  ...
  801d3a:	56                   	push   %esi
  801d3b:	57                   	push   %edi
  801d3c:	e8 6c f2 ff ff       	call   800fad <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801d41:	83 c4 10             	add    $0x10,%esp
  801d44:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d47:	75 07                	jne    801d50 <ipc_send+0x36>
			sys_yield();
  801d49:	e8 b3 f0 ff ff       	call   800e01 <sys_yield>
  801d4e:	eb e6                	jmp    801d36 <ipc_send+0x1c>
		} else if (r < 0) {
  801d50:	85 c0                	test   %eax,%eax
  801d52:	79 12                	jns    801d66 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801d54:	50                   	push   %eax
  801d55:	68 4a 25 80 00       	push   $0x80254a
  801d5a:	6a 51                	push   $0x51
  801d5c:	68 57 25 80 00       	push   $0x802557
  801d61:	e8 66 e5 ff ff       	call   8002cc <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801d79:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d7c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d82:	8b 52 50             	mov    0x50(%edx),%edx
  801d85:	39 ca                	cmp    %ecx,%edx
  801d87:	75 0d                	jne    801d96 <ipc_find_env+0x28>
			return envs[i].env_id;
  801d89:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d8c:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d91:	8b 40 48             	mov    0x48(%eax),%eax
  801d94:	eb 0f                	jmp    801da5 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801d99:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d9e:	75 d9                	jne    801d79 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801daf:	c1 e8 16             	shr    $0x16,%eax
  801db2:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801dbe:	f6 c1 01             	test   $0x1,%cl
  801dc1:	74 1d                	je     801de0 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801dc3:	c1 ea 0c             	shr    $0xc,%edx
  801dc6:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801dcd:	f6 c2 01             	test   $0x1,%dl
  801dd0:	74 0e                	je     801de0 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801dd2:	c1 ea 0c             	shr    $0xc,%edx
  801dd5:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801ddc:	ef 
  801ddd:	0f b7 c0             	movzwl %ax,%eax
}
  801de0:	5d                   	pop    %ebp
  801de1:	c3                   	ret    
