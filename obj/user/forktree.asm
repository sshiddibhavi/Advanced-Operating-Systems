...
forkchild(const char *cur, char branch)
{
  ...
  8000a8:	e8 0a 0d 00 00       	call   800db7 <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022f:	e8 6c 0e 00 00       	call   8010a0 <__udivdi3>
  ...
  800272:	e8 59 0f 00 00       	call   8011d0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b09:	e8 ac 04 00 00       	call   800fba <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b8a:	e8 2b 04 00 00       	call   800fba <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bcc:	e8 e9 03 00 00       	call   800fba <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c0e:	e8 a7 03 00 00       	call   800fba <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c50:	e8 65 03 00 00       	call   800fba <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c92:	e8 23 03 00 00       	call   800fba <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf6:	e8 bf 02 00 00       	call   800fba <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d11:	74 2c                	je     800d3f <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
  ...
  800d18:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
	...
	if (!((err & FEC_WR) &&
  800d1f:	a8 01                	test   $0x1,%al
  800d21:	74 1c                	je     800d3f <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
  800d23:	89 de                	mov    %ebx,%esi
  800d25:	c1 ee 0c             	shr    $0xc,%esi
  800d28:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
	      (uvpd[PDX(addr)] & PTE_P) &&
  800d2f:	a8 01                	test   $0x1,%al
  800d31:	74 0c                	je     800d3f <pgfault+0x3c>
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
  800d33:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
  800d3a:	f6 c4 08             	test   $0x8,%ah
  800d3d:	75 14                	jne    800d53 <pgfault+0x50>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
		panic("not copy on write");
  800d3f:	83 ec 04             	sub    $0x4,%esp
  800d42:	68 cf 15 80 00       	push   $0x8015cf
  800d47:	6a 21                	push   $0x21
  800d49:	68 e1 15 80 00       	push   $0x8015e1
  800d4e:	e8 67 02 00 00       	call   800fba <_panic>
	// Hint:
  ...
  800d53:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
	sys_page_alloc(0, PFTEMP, PTE_W | PTE_P | PTE_U);
  800d59:	83 ec 04             	sub    $0x4,%esp
  800d5c:	6a 07                	push   $0x7
  800d5e:	68 00 f0 7f 00       	push   $0x7ff000
  800d63:	6a 00                	push   $0x0
  800d65:	e8 ea fd ff ff       	call   800b54 <sys_page_alloc>
	memcpy(PFTEMP, addr, PGSIZE);
  800d6a:	83 c4 0c             	add    $0xc,%esp
  800d6d:	68 00 10 00 00       	push   $0x1000
  800d72:	53                   	push   %ebx
  800d73:	68 00 f0 7f 00       	push   $0x7ff000
  800d78:	e8 ce fb ff ff       	call   80094b <memcpy>
	sys_page_map(0, PFTEMP,
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
  800d7d:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	// LAB 4: Your code here.
	...
	memcpy(PFTEMP, addr, PGSIZE);
	sys_page_map(0, PFTEMP,
  800d84:	25 05 06 00 00       	and    $0x605,%eax
  800d89:	83 c8 02             	or     $0x2,%eax
  800d8c:	89 04 24             	mov    %eax,(%esp)
  800d8f:	53                   	push   %ebx
  800d90:	6a 00                	push   $0x0
  800d92:	68 00 f0 7f 00       	push   $0x7ff000
  800d97:	6a 00                	push   $0x0
  800d99:	e8 f9 fd ff ff       	call   800b97 <sys_page_map>
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
  ...
  800da8:	e8 2c fe ff ff       	call   800bd9 <sys_page_unmap>
	return;
  800dad:	83 c4 10             	add    $0x10,%esp

	
}
  800db0:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800db3:	5b                   	pop    %ebx
  800db4:	5e                   	pop    %esi
  800db5:	5d                   	pop    %ebp
  800db6:	c3                   	ret    
...
fork(void)
{
  ...
  800dc0:	68 03 0d 80 00       	push   $0x800d03
  800dc5:	e8 36 02 00 00       	call   801000 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800dd9:	79 14                	jns    800def <fork+0x38>
		panic ("No memory");
  800ddb:	83 ec 04             	sub    $0x4,%esp
  800dde:	68 ec 15 80 00       	push   $0x8015ec
  800de3:	6a 77                	push   $0x77
  800de5:	68 e1 15 80 00       	push   $0x8015e1
  800dea:	e8 cb 01 00 00       	call   800fba <_panic>
  800def:	89 c7                	mov    %eax,%edi
  800df1:	bb 00 00 00 00       	mov    $0x0,%ebx
	else if (r == 0)
  800df6:	85 c0                	test   %eax,%eax
  800df8:	75 31                	jne    800e2b <fork+0x74>
	{
		set_pgfault_handler(pgfault);
  800dfa:	83 ec 0c             	sub    $0xc,%esp
  800dfd:	68 03 0d 80 00       	push   $0x800d03
  800e02:	e8 f9 01 00 00       	call   801000 <set_pgfault_handler>
		thisenv = &envs[ENVX(sys_getenvid())];
  800e07:	e8 0a fd ff ff       	call   800b16 <sys_getenvid>
  800e0c:	25 ff 03 00 00       	and    $0x3ff,%eax
  800e11:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e14:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e19:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800e1e:	83 c4 10             	add    $0x10,%esp
  800e21:	b8 00 00 00 00       	mov    $0x0,%eax
  800e26:	e9 6d 01 00 00       	jmp    800f98 <fork+0x1e1>
	}
  ...
  800e2d:	c1 e8 16             	shr    $0x16,%eax
  800e30:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  800e37:	a8 01                	test   $0x1,%al
  800e39:	0f 84 c2 00 00 00    	je     800f01 <fork+0x14a>
  800e3f:	89 d8                	mov    %ebx,%eax
  800e41:	c1 e8 0c             	shr    $0xc,%eax
  800e44:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e4b:	f6 c2 01             	test   $0x1,%dl
  800e4e:	0f 84 ad 00 00 00    	je     800f01 <fork+0x14a>
			&& (uvpt [PGNUM(i)] & PTE_U))
  800e54:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e5b:	f6 c2 04             	test   $0x4,%dl
  800e5e:	0f 84 9d 00 00 00    	je     800f01 <fork+0x14a>
{
	int r;
  ...
  800e66:	c1 e6 0c             	shl    $0xc,%esi

	if (uvpt[pn] & PTE_COW || uvpt[pn] & PTE_W)
  800e69:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e70:	f6 c6 08             	test   $0x8,%dh
  800e73:	75 0b                	jne    800e80 <fork+0xc9>
  800e75:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800e7c:	a8 02                	test   $0x2,%al
  800e7e:	74 6d                	je     800eed <fork+0x136>
	{
		if (sys_page_map(thisenv->env_id, address, envid, address, PTE_COW|PTE_U|PTE_P))
  800e80:	a1 04 20 80 00       	mov    0x802004,%eax
  800e85:	8b 40 48             	mov    0x48(%eax),%eax
  800e88:	83 ec 0c             	sub    $0xc,%esp
  800e8b:	68 05 08 00 00       	push   $0x805
  800e90:	56                   	push   %esi
  800e91:	ff 75 e4             	pushl  -0x1c(%ebp)
  800e94:	56                   	push   %esi
  800e95:	50                   	push   %eax
  800e96:	e8 fc fc ff ff       	call   800b97 <sys_page_map>
  800e9b:	83 c4 20             	add    $0x20,%esp
  800e9e:	85 c0                	test   %eax,%eax
  800ea0:	74 14                	je     800eb6 <fork+0xff>
            panic("sys_page_map failed");
  800ea2:	83 ec 04             	sub    $0x4,%esp
  800ea5:	68 f6 15 80 00       	push   $0x8015f6
  800eaa:	6a 4f                	push   $0x4f
  800eac:	68 e1 15 80 00       	push   $0x8015e1
  800eb1:	e8 04 01 00 00       	call   800fba <_panic>
        if (sys_page_map(thisenv->env_id, address, thisenv->env_id, address, PTE_COW|PTE_U|PTE_P))
  800eb6:	a1 04 20 80 00       	mov    0x802004,%eax
  800ebb:	8b 50 48             	mov    0x48(%eax),%edx
  ...
  800ecb:	56                   	push   %esi
  800ecc:	50                   	push   %eax
  800ecd:	e8 c5 fc ff ff       	call   800b97 <sys_page_map>
  800ed2:	83 c4 20             	add    $0x20,%esp
  800ed5:	85 c0                	test   %eax,%eax
  800ed7:	74 28                	je     800f01 <fork+0x14a>
            panic("sys_page_map failed");
  800ed9:	83 ec 04             	sub    $0x4,%esp
  800edc:	68 f6 15 80 00       	push   $0x8015f6
  800ee1:	6a 51                	push   $0x51
  800ee3:	68 e1 15 80 00       	push   $0x8015e1
  800ee8:	e8 cd 00 00 00       	call   800fba <_panic>
	}
	else
  ...
  800ef9:	e8 99 fc ff ff       	call   800b97 <sys_page_map>
  800efe:	83 c4 20             	add    $0x20,%esp
	...
	int i;
	for (i=0; i < USTACKTOP; i+=PGSIZE)
  800f01:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800f07:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800f0d:	0f 85 18 ff ff ff    	jne    800e2b <fork+0x74>
		if ((uvpd [PDX(i)] & PTE_P) && (uvpt [PGNUM(i)] & PTE_P) 
			&& (uvpt [PGNUM(i)] & PTE_U))
			duppage (r, PGNUM(i));
	}
  ...
  800f1d:	57                   	push   %edi
  800f1e:	e8 31 fc ff ff       	call   800b54 <sys_page_alloc>
  800f23:	83 c4 10             	add    $0x10,%esp
  800f26:	85 c0                	test   %eax,%eax
  800f28:	74 17                	je     800f41 <fork+0x18a>
		panic ("sys_page_alloc error in fork()");
  800f2a:	83 ec 04             	sub    $0x4,%esp
  800f2d:	68 20 16 80 00       	push   $0x801620
  800f32:	68 88 00 00 00       	push   $0x88
  800f37:	68 e1 15 80 00       	push   $0x8015e1
  800f3c:	e8 79 00 00 00       	call   800fba <_panic>

	extern void _pgfault_upcall();
	if(sys_env_set_pgfault_upcall(r, _pgfault_upcall))
  800f41:	83 ec 08             	sub    $0x8,%esp
  800f44:	68 6f 10 80 00       	push   $0x80106f
  800f49:	57                   	push   %edi
  800f4a:	e8 0e fd ff ff       	call   800c5d <sys_env_set_pgfault_upcall>
  800f4f:	83 c4 10             	add    $0x10,%esp
  800f52:	85 c0                	test   %eax,%eax
  800f54:	74 17                	je     800f6d <fork+0x1b6>
		panic ("sys_env_set_pgfault_upcall error in fork()");
  800f56:	83 ec 04             	sub    $0x4,%esp
  800f59:	68 40 16 80 00       	push   $0x801640
  800f5e:	68 8c 00 00 00       	push   $0x8c
  800f63:	68 e1 15 80 00       	push   $0x8015e1
  800f68:	e8 4d 00 00 00       	call   800fba <_panic>

	if (sys_env_set_status(r, ENV_RUNNABLE))
  800f6d:	83 ec 08             	sub    $0x8,%esp
  800f70:	6a 02                	push   $0x2
  800f72:	57                   	push   %edi
  800f73:	e8 a3 fc ff ff       	call   800c1b <sys_env_set_status>
  800f78:	83 c4 10             	add    $0x10,%esp
  800f7b:	85 c0                	test   %eax,%eax
  800f7d:	74 17                	je     800f96 <fork+0x1df>
		panic ("Cannot set status in sys_env_set_status");
  800f7f:	83 ec 04             	sub    $0x4,%esp
  800f82:	68 6c 16 80 00       	push   $0x80166c
  800f87:	68 8f 00 00 00       	push   $0x8f
  800f8c:	68 e1 15 80 00       	push   $0x8015e1
  800f91:	e8 24 00 00 00       	call   800fba <_panic>
	return r;
...
sfork(void)
{
  ...
  800fa6:	68 0a 16 80 00       	push   $0x80160a
  800fab:	68 9b 00 00 00       	push   $0x9b
  800fb0:	68 e1 15 80 00       	push   $0x8015e1
  800fb5:	e8 00 00 00 00       	call   800fba <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fbe:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800fbf:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800fc2:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800fc8:	e8 49 fb ff ff       	call   800b16 <sys_getenvid>
  800fcd:	83 ec 0c             	sub    $0xc,%esp
  800fd0:	ff 75 0c             	pushl  0xc(%ebp)
  800fd3:	ff 75 08             	pushl  0x8(%ebp)
  800fd6:	56                   	push   %esi
  800fd7:	50                   	push   %eax
  800fd8:	68 94 16 80 00       	push   $0x801694
  800fdd:	e8 ea f1 ff ff       	call   8001cc <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800fe2:	83 c4 18             	add    $0x18,%esp
  800fe5:	53                   	push   %ebx
  800fe6:	ff 75 10             	pushl  0x10(%ebp)
  800fe9:	e8 8d f1 ff ff       	call   80017b <vcprintf>
	cprintf("\n");
  800fee:	c7 04 24 4f 13 80 00 	movl   $0x80134f,(%esp)
  ...
  800ffa:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800ffd:	cc                   	int3   
  800ffe:	eb fd                	jmp    800ffd <_panic+0x43>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80100d:	75 2c                	jne    80103b <set_pgfault_handler+0x3b>
		// First time through!
		// LAB 4: Your code here.
  ...
  80101b:	e8 34 fb ff ff       	call   800b54 <sys_page_alloc>
  801020:	83 c4 10             	add    $0x10,%esp
  801023:	85 c0                	test   %eax,%eax
  801025:	74 14                	je     80103b <set_pgfault_handler+0x3b>
			PTE_P | PTE_U | PTE_W))
			
        	panic("sys_page_alloc failed.");
  801027:	83 ec 04             	sub    $0x4,%esp
  80102a:	68 b7 16 80 00       	push   $0x8016b7
  80102f:	6a 24                	push   $0x24
  801031:	68 ce 16 80 00       	push   $0x8016ce
  801036:	e8 7f ff ff ff       	call   800fba <_panic>
  ...
  80103e:	a3 08 20 80 00       	mov    %eax,0x802008
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  801043:	83 ec 08             	sub    $0x8,%esp
  801046:	68 6f 10 80 00       	push   $0x80106f
  80104b:	6a 00                	push   $0x0
  80104d:	e8 0b fc ff ff       	call   800c5d <sys_env_set_pgfault_upcall>
  801052:	83 c4 10             	add    $0x10,%esp
  801055:	85 c0                	test   %eax,%eax
  801057:	79 14                	jns    80106d <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  801059:	83 ec 04             	sub    $0x4,%esp
  80105c:	68 dc 16 80 00       	push   $0x8016dc
  801061:	6a 2b                	push   $0x2b
  801063:	68 ce 16 80 00       	push   $0x8016ce
  801068:	e8 4d ff ff ff       	call   800fba <_panic>
...
_pgfault_upcall:
  ...
  801070:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801077:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  80107a:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  80107e:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
