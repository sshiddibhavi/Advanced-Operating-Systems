...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800caf:	75 2c                	jne    800cdd <set_pgfault_handler+0x3b>
		// First time through!
  ...
  800ccc:	68 af 12 80 00       	push   $0x8012af
  800cd1:	6a 24                	push   $0x24
  800cd3:	68 c6 12 80 00       	push   $0x8012c6
  ...
  800ce0:	a3 08 20 80 00       	mov    %eax,0x802008
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  800ce5:	83 ec 08             	sub    $0x8,%esp
  800ce8:	68 11 0d 80 00       	push   $0x800d11
  800ced:	6a 00                	push   $0x0
  800cef:	e8 08 ff ff ff       	call   800bfc <sys_env_set_pgfault_upcall>
  800cf4:	83 c4 10             	add    $0x10,%esp
  800cf7:	85 c0                	test   %eax,%eax
  800cf9:	79 14                	jns    800d0f <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  800cfb:	83 ec 04             	sub    $0x4,%esp
  800cfe:	68 d4 12 80 00       	push   $0x8012d4
  800d03:	6a 2b                	push   $0x2b
  800d05:	68 c6 12 80 00       	push   $0x8012c6
  800d0a:	e8 26 00 00 00       	call   800d35 <_panic>
...
_pgfault_upcall:
  ...
  800d19:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800d1c:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  800d20:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  800d25:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  800d29:	89 03                	mov    %eax,(%ebx)
	addl $0x8, %esp
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d51:	56                   	push   %esi
  800d52:	50                   	push   %eax
  800d53:	68 f8 12 80 00       	push   $0x8012f8
