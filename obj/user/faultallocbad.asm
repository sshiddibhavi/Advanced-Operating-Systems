...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2a:	75 2c                	jne    800d58 <set_pgfault_handler+0x3b>
		// First time through!
  ...
  800d47:	68 4f 13 80 00       	push   $0x80134f
  800d4c:	6a 24                	push   $0x24
  800d4e:	68 66 13 80 00       	push   $0x801366
  ...
  800d5b:	a3 08 20 80 00       	mov    %eax,0x802008
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  800d60:	83 ec 08             	sub    $0x8,%esp
  800d63:	68 8c 0d 80 00       	push   $0x800d8c
  800d68:	6a 00                	push   $0x0
  800d6a:	e8 08 ff ff ff       	call   800c77 <sys_env_set_pgfault_upcall>
  800d6f:	83 c4 10             	add    $0x10,%esp
  800d72:	85 c0                	test   %eax,%eax
  800d74:	79 14                	jns    800d8a <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  800d76:	83 ec 04             	sub    $0x4,%esp
  800d79:	68 74 13 80 00       	push   $0x801374
  800d7e:	6a 2b                	push   $0x2b
  800d80:	68 66 13 80 00       	push   $0x801366
...
_pgfault_upcall:
  ...
  800d94:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %eax
  800d97:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  800d9b:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  800da0:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  800da4:	89 03                	mov    %eax,(%ebx)
	addl $0x8, %esp
