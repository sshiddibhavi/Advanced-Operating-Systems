...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800214:	e8 54 00 00 00       	call   80026d <vcprintf>
	cprintf("\n");
  800219:	c7 04 24 90 29 80 00 	movl   $0x802990,(%esp)
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80054f:	52                   	push   %edx
  800550:	68 1e 29 80 00       	push   $0x80291e
  800555:	53                   	push   %ebx
  800556:	56                   	push   %esi
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f2b:	ba ec 28 80 00       	mov    $0x8028ec,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f56:	51                   	push   %ecx
  800f57:	50                   	push   %eax
  800f58:	68 6c 28 80 00       	push   $0x80286c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801180:	53                   	push   %ebx
  801181:	50                   	push   %eax
  801182:	68 b0 28 80 00       	push   $0x8028b0
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801255:	53                   	push   %ebx
  801256:	50                   	push   %eax
  801257:	68 cc 28 80 00       	push   $0x8028cc
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80130a:	53                   	push   %ebx
  80130b:	50                   	push   %eax
  80130c:	68 8c 28 80 00       	push   $0x80288c
...
stat(const char *path, struct Stat *stat)
{
  ...
  8013d5:	e8 0c 02 00 00       	call   8015e6 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  80141c:	e8 7c 0d 00 00       	call   80219d <ipc_find_env>
  ...
  801437:	e8 0d 0d 00 00       	call   802149 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80143c:	83 c4 0c             	add    $0xc,%esp
  80143f:	6a 00                	push   $0x0
  801441:	53                   	push   %ebx
  801442:	6a 00                	push   $0x0
  801444:	e8 97 0c 00 00       	call   8020e0 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80150b:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801510:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  801515:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  801518:	89 1d 04 50 80 00    	mov    %ebx,0x805004
	
	memmove(fsipcbuf.write.req_buf, buf, n_real);
  80151e:	53                   	push   %ebx
  80151f:	ff 75 0c             	pushl  0xc(%ebp)
  801522:	68 08 50 80 00       	push   $0x805008
  801527:	e8 a9 f4 ff ff       	call   8009d5 <memmove>
  ...
  801540:	78 1d                	js     80155f <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  801542:	39 d8                	cmp    %ebx,%eax
  801544:	76 19                	jbe    80155f <devfile_write+0x6a>
  801546:	68 00 29 80 00       	push   $0x802900
  80154b:	68 0c 29 80 00       	push   $0x80290c
  801550:	68 a3 00 00 00       	push   $0xa3
  801555:	68 21 29 80 00       	push   $0x802921
  80155a:	e8 86 ec ff ff       	call   8001e5 <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801587:	e8 79 fe ff ff       	call   801405 <fsipc>
  ...
  801596:	68 2c 29 80 00       	push   $0x80292c
  80159b:	68 0c 29 80 00       	push   $0x80290c
  8015a0:	6a 7c                	push   $0x7c
  8015a2:	68 21 29 80 00       	push   $0x802921
  8015a7:	e8 39 ec ff ff       	call   8001e5 <_panic>
	assert(r <= PGSIZE);
  8015ac:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8015b1:	7e 16                	jle    8015c9 <devfile_read+0x65>
  8015b3:	68 33 29 80 00       	push   $0x802933
  8015b8:	68 0c 29 80 00       	push   $0x80290c
  8015bd:	6a 7d                	push   $0x7d
  8015bf:	68 21 29 80 00       	push   $0x802921
  8015c4:	e8 1c ec ff ff       	call   8001e5 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8015c9:	83 ec 04             	sub    $0x4,%esp
  8015cc:	50                   	push   %eax
  8015cd:	68 00 50 80 00       	push   $0x805000
  8015d2:	ff 75 0c             	pushl  0xc(%ebp)
  8015d5:	e8 fb f3 ff ff       	call   8009d5 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8015f0:	53                   	push   %ebx
  8015f1:	e8 14 f2 ff ff       	call   80080a <strlen>
  ...
  801606:	50                   	push   %eax
  801607:	e8 71 f8 ff ff       	call   800e7d <fd_alloc>
  ...
  80161e:	e8 20 f2 ff ff       	call   800843 <strcpy>
  ...
  801633:	e8 cd fd ff ff       	call   801405 <fsipc>
  ...
  801649:	e8 27 f9 ff ff       	call   800f75 <fd_close>
		return r;
  ...
  80165b:	e8 f6 f7 ff ff       	call   800e56 <fd2num>
...
sync(void)
{
  ...
  801683:	e8 7d fd ff ff       	call   801405 <fsipc>
}
  801688:	c9                   	leave  
  801689:	c3                   	ret    
...
writebuf(struct printbuf *b)
{
  ...
  8016a2:	e8 65 fb ff ff       	call   80120c <write>
		if (result > 0)
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  801740:	e8 b0 ec ff ff       	call   8003f5 <vprintfmt>
	if (b.idx > 0)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017a0:	68 3f 29 80 00       	push   $0x80293f
  8017a5:	ff 75 0c             	pushl  0xc(%ebp)
  8017a8:	e8 96 f0 ff ff       	call   800843 <strcpy>
	return 0;
}
...
devsock_close(struct Fd *fd)
{
  ...
  8017bb:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (pageref(fd) == 1)
  8017be:	53                   	push   %ebx
  8017bf:	e8 12 0a 00 00       	call   8021d6 <pageref>
...
devsock_close(struct Fd *fd)
{
  ...
  8017cf:	75 10                	jne    8017e1 <devsock_close+0x2d>
		return nsipc_close(fd->fd_sock.sockid);
  8017d1:	83 ec 0c             	sub    $0xc,%esp
  8017d4:	ff 73 0c             	pushl  0xc(%ebx)
  8017d7:	e8 c0 02 00 00       	call   801a9c <nsipc_close>
...
devsock_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8017fc:	e8 78 03 00 00       	call   801b79 <nsipc_send>
}
  801801:	c9                   	leave  
  801802:	c3                   	ret    
...
devsock_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801817:	e8 f1 02 00 00       	call   801b0d <nsipc_recv>
}
  80181c:	c9                   	leave  
  80181d:	c3                   	ret    
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  8018c9:	e8 50 ff ff ff       	call   80181e <fd2sockid>
		return r;
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  8018d2:	78 1f                	js     8018f3 <accept+0x33>
		return r;
  ...
  8018dd:	50                   	push   %eax
  8018de:	e8 12 01 00 00       	call   8019f5 <nsipc_accept>
...
accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  8018ea:	78 07                	js     8018f3 <accept+0x33>
		return r;
	return alloc_sockfd(r);
  8018ec:	e8 5d ff ff ff       	call   80184e <alloc_sockfd>
  8018f1:	89 c1                	mov    %eax,%ecx
}
  8018f3:	89 c8                	mov    %ecx,%eax
  8018f5:	c9                   	leave  
  8018f6:	c3                   	ret    
...
bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801900:	e8 19 ff ff ff       	call   80181e <fd2sockid>
  801905:	85 c0                	test   %eax,%eax
  801907:	78 12                	js     80191b <bind+0x24>
		return r;
  ...
  801912:	50                   	push   %eax
  801913:	e8 2d 01 00 00       	call   801a45 <nsipc_bind>
...
shutdown(int s, int how)
{
  ...
  801926:	e8 f3 fe ff ff       	call   80181e <fd2sockid>
  80192b:	85 c0                	test   %eax,%eax
  80192d:	78 0f                	js     80193e <shutdown+0x21>
		return r;
	return nsipc_shutdown(r, how);
  80192f:	83 ec 08             	sub    $0x8,%esp
  801932:	ff 75 0c             	pushl  0xc(%ebp)
  801935:	50                   	push   %eax
  801936:	e8 3f 01 00 00       	call   801a7a <nsipc_shutdown>
...
connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801949:	e8 d0 fe ff ff       	call   80181e <fd2sockid>
  80194e:	85 c0                	test   %eax,%eax
  801950:	78 12                	js     801964 <connect+0x24>
		return r;
  ...
  80195b:	50                   	push   %eax
  80195c:	e8 55 01 00 00       	call   801ab6 <nsipc_connect>
...
listen(int s, int backlog)
{
  ...
  80196f:	e8 aa fe ff ff       	call   80181e <fd2sockid>
  801974:	85 c0                	test   %eax,%eax
  801976:	78 0f                	js     801987 <listen+0x21>
		return r;
	return nsipc_listen(r, backlog);
  801978:	83 ec 08             	sub    $0x8,%esp
  80197b:	ff 75 0c             	pushl  0xc(%ebp)
  80197e:	50                   	push   %eax
  80197f:	e8 67 01 00 00       	call   801aeb <nsipc_listen>
...
socket(int domain, int type, int protocol)
{
  ...
  801998:	e8 3a 02 00 00       	call   801bd7 <nsipc_socket>
  80199d:	83 c4 10             	add    $0x10,%esp
  8019a0:	85 c0                	test   %eax,%eax
  8019a2:	78 05                	js     8019a9 <socket+0x20>
		return r;
	return alloc_sockfd(r);
  8019a4:	e8 a5 fe ff ff       	call   80184e <alloc_sockfd>
}
  8019a9:	c9                   	leave  
  8019aa:	c3                   	ret    
...
nsipc(unsigned type)
{
  ...
  8019b2:	89 c3                	mov    %eax,%ebx
	...
	if (nsenv == 0)
  8019b4:	83 3d 08 40 80 00 00 	cmpl   $0x0,0x804008
  8019bb:	75 12                	jne    8019cf <nsipc+0x24>
		nsenv = ipc_find_env(ENV_TYPE_NS);
  8019bd:	83 ec 0c             	sub    $0xc,%esp
  8019c0:	6a 02                	push   $0x2
  8019c2:	e8 d6 07 00 00       	call   80219d <ipc_find_env>
  8019c7:	a3 08 40 80 00       	mov    %eax,0x804008
  ...
  8019d6:	53                   	push   %ebx
  8019d7:	ff 35 08 40 80 00    	pushl  0x804008
  8019dd:	e8 67 07 00 00       	call   802149 <ipc_send>
	return ipc_recv(NULL, NULL, NULL);
  8019e2:	83 c4 0c             	add    $0xc,%esp
  8019e5:	6a 00                	push   $0x0
  8019e7:	6a 00                	push   $0x0
  8019e9:	6a 00                	push   $0x0
  8019eb:	e8 f0 06 00 00       	call   8020e0 <ipc_recv>
}
  8019f0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8019f3:	c9                   	leave  
  8019f4:	c3                   	ret    

008019f5 <nsipc_accept>:
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801a05:	8b 06                	mov    (%esi),%eax
  801a07:	a3 04 60 80 00       	mov    %eax,0x806004
	if ((r = nsipc(NSREQ_ACCEPT)) >= 0) {
  801a0c:	b8 01 00 00 00       	mov    $0x1,%eax
  801a11:	e8 95 ff ff ff       	call   8019ab <nsipc>
  801a16:	89 c3                	mov    %eax,%ebx
  801a18:	85 c0                	test   %eax,%eax
  801a1a:	78 20                	js     801a3c <nsipc_accept+0x47>
		struct Nsret_accept *ret = &nsipcbuf.acceptRet;
		memmove(addr, &ret->ret_addr, ret->ret_addrlen);
  801a1c:	83 ec 04             	sub    $0x4,%esp
  801a1f:	ff 35 10 60 80 00    	pushl  0x806010
  801a25:	68 00 60 80 00       	push   $0x806000
  801a2a:	ff 75 0c             	pushl  0xc(%ebp)
  801a2d:	e8 a3 ef ff ff       	call   8009d5 <memmove>
		*addrlen = ret->ret_addrlen;
  801a32:	a1 10 60 80 00       	mov    0x806010,%eax
  801a37:	89 06                	mov    %eax,(%esi)
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801a5b:	68 04 60 80 00       	push   $0x806004
  801a60:	e8 70 ef ff ff       	call   8009d5 <memmove>
	nsipcbuf.bind.req_namelen = namelen;
  801a65:	89 1d 14 60 80 00    	mov    %ebx,0x806014
	return nsipc(NSREQ_BIND);
  801a6b:	b8 02 00 00 00       	mov    $0x2,%eax
  801a70:	e8 36 ff ff ff       	call   8019ab <nsipc>
}
  801a75:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801a78:	c9                   	leave  
  801a79:	c3                   	ret    

00801a7a <nsipc_shutdown>:
...
nsipc_shutdown(int s, int how)
{
  ...
  801a8b:	a3 04 60 80 00       	mov    %eax,0x806004
	return nsipc(NSREQ_SHUTDOWN);
  801a90:	b8 03 00 00 00       	mov    $0x3,%eax
  801a95:	e8 11 ff ff ff       	call   8019ab <nsipc>
}
  801a9a:	c9                   	leave  
  801a9b:	c3                   	ret    

00801a9c <nsipc_close>:
...
nsipc_close(int s)
{
  ...
  801aaa:	b8 04 00 00 00       	mov    $0x4,%eax
  801aaf:	e8 f7 fe ff ff       	call   8019ab <nsipc>
}
  801ab4:	c9                   	leave  
  801ab5:	c3                   	ret    

00801ab6 <nsipc_connect>:
...
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801acc:	68 04 60 80 00       	push   $0x806004
  801ad1:	e8 ff ee ff ff       	call   8009d5 <memmove>
	nsipcbuf.connect.req_namelen = namelen;
  801ad6:	89 1d 14 60 80 00    	mov    %ebx,0x806014
	return nsipc(NSREQ_CONNECT);
  801adc:	b8 05 00 00 00       	mov    $0x5,%eax
  801ae1:	e8 c5 fe ff ff       	call   8019ab <nsipc>
}
  801ae6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801ae9:	c9                   	leave  
  801aea:	c3                   	ret    

00801aeb <nsipc_listen>:
...
nsipc_listen(int s, int backlog)
{
  ...
  801b01:	b8 06 00 00 00       	mov    $0x6,%eax
  801b06:	e8 a0 fe ff ff       	call   8019ab <nsipc>
}
  801b0b:	c9                   	leave  
  801b0c:	c3                   	ret    
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b10:	56                   	push   %esi
  801b11:	53                   	push   %ebx
  801b12:	8b 75 10             	mov    0x10(%ebp),%esi
	int r;
  ...
  801b30:	e8 76 fe ff ff       	call   8019ab <nsipc>
  801b35:	89 c3                	mov    %eax,%ebx
  801b37:	85 c0                	test   %eax,%eax
  801b39:	78 35                	js     801b70 <nsipc_recv+0x63>
		assert(r < 1600 && r <= len);
  801b3b:	3d 3f 06 00 00       	cmp    $0x63f,%eax
  801b40:	7f 04                	jg     801b46 <nsipc_recv+0x39>
  801b42:	39 c6                	cmp    %eax,%esi
  801b44:	7d 16                	jge    801b5c <nsipc_recv+0x4f>
  801b46:	68 4b 29 80 00       	push   $0x80294b
  801b4b:	68 0c 29 80 00       	push   $0x80290c
  801b50:	6a 62                	push   $0x62
  801b52:	68 60 29 80 00       	push   $0x802960
  801b57:	e8 89 e6 ff ff       	call   8001e5 <_panic>
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  801b5c:	83 ec 04             	sub    $0x4,%esp
  801b5f:	50                   	push   %eax
  801b60:	68 00 60 80 00       	push   $0x806000
  801b65:	ff 75 0c             	pushl  0xc(%ebp)
  801b68:	e8 68 ee ff ff       	call   8009d5 <memmove>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801b86:	a3 00 60 80 00       	mov    %eax,0x806000
	assert(size < 1600);
  801b8b:	81 fb 3f 06 00 00    	cmp    $0x63f,%ebx
  801b91:	7e 16                	jle    801ba9 <nsipc_send+0x30>
  801b93:	68 6c 29 80 00       	push   $0x80296c
  801b98:	68 0c 29 80 00       	push   $0x80290c
  801b9d:	6a 6d                	push   $0x6d
  801b9f:	68 60 29 80 00       	push   $0x802960
  801ba4:	e8 3c e6 ff ff       	call   8001e5 <_panic>
	memmove(&nsipcbuf.send.req_buf, buf, size);
  801ba9:	83 ec 04             	sub    $0x4,%esp
  801bac:	53                   	push   %ebx
  801bad:	ff 75 0c             	pushl  0xc(%ebp)
  801bb0:	68 0c 60 80 00       	push   $0x80600c
  801bb5:	e8 1b ee ff ff       	call   8009d5 <memmove>
	nsipcbuf.send.req_size = size;
  801bba:	89 1d 04 60 80 00    	mov    %ebx,0x806004
	nsipcbuf.send.req_flags = flags;
  801bc0:	8b 45 14             	mov    0x14(%ebp),%eax
  801bc3:	a3 08 60 80 00       	mov    %eax,0x806008
	return nsipc(NSREQ_SEND);
  801bc8:	b8 08 00 00 00       	mov    $0x8,%eax
  801bcd:	e8 d9 fd ff ff       	call   8019ab <nsipc>
}
  801bd2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801bd5:	c9                   	leave  
  801bd6:	c3                   	ret    

00801bd7 <nsipc_socket>:
...
nsipc_socket(int domain, int type, int protocol)
{
  ...
  801bf5:	b8 09 00 00 00       	mov    $0x9,%eax
  801bfa:	e8 ac fd ff ff       	call   8019ab <nsipc>
}
  801bff:	c9                   	leave  
  801c00:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c0f:	e8 52 f2 ff ff       	call   800e66 <fd2data>
  801c14:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801c16:	83 c4 08             	add    $0x8,%esp
  801c19:	68 78 29 80 00       	push   $0x802978
  801c1e:	53                   	push   %ebx
  801c1f:	e8 1f ec ff ff       	call   800843 <strcpy>
  ...
  801c36:	00 00 00 
	stat->st_dev = &devpipe;
  801c39:	c7 83 88 00 00 00 40 	movl   $0x803040,0x88(%ebx)
  801c40:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801c5c:	e8 6a f0 ff ff       	call   800ccb <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801c61:	89 1c 24             	mov    %ebx,(%esp)
  801c64:	e8 fd f1 ff ff       	call   800e66 <fd2data>
  801c69:	83 c4 08             	add    $0x8,%esp
  801c6c:	50                   	push   %eax
  801c6d:	6a 00                	push   $0x0
  801c6f:	e8 57 f0 ff ff       	call   800ccb <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801caf:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801cb2:	8b 15 0c 40 80 00    	mov    0x80400c,%edx
  ...
  801cc9:	50                   	push   %eax
  801cca:	56                   	push   %esi
  801ccb:	68 7f 29 80 00       	push   $0x80297f
  801cd0:	e8 e9 e5 ff ff       	call   8002be <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801cf1:	56                   	push   %esi
  801cf2:	e8 6f f1 ff ff       	call   800e66 <fd2data>
  ...
  801d0e:	75 48                	jne    801d58 <devpipe_write+0x73>
			...
			sys_yield();
  801d10:	e8 12 ef ff ff       	call   800c27 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801d6e:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801d71:	57                   	push   %edi
  801d72:	e8 ef f0 ff ff       	call   800e66 <fd2data>
  ...
  801d96:	75 32                	jne    801dca <devpipe_read+0x65>
			...
			sys_yield();
  801d98:	e8 8a ee ff ff       	call   800c27 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801de2:	50                   	push   %eax
  801de3:	e8 95 f0 ff ff       	call   800e7d <fd_alloc>
  ...
  801e02:	e8 3f ee ff ff       	call   800c46 <sys_page_alloc>
  ...
  801e1a:	50                   	push   %eax
  801e1b:	e8 5d f0 ff ff       	call   800e7d <fd_alloc>
  ...
  801e3a:	e8 07 ee ff ff       	call   800c46 <sys_page_alloc>
  ...
  801e52:	e8 0f f0 ff ff       	call   800e66 <fd2data>
  ...
  801e64:	e8 dd ed ff ff       	call   800c46 <sys_page_alloc>
  ...
  801e7c:	e8 e5 ef ff ff       	call   800e66 <fd2data>
  801e81:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801e88:	50                   	push   %eax
  801e89:	6a 00                	push   $0x0
  801e8b:	56                   	push   %esi
  801e8c:	6a 00                	push   $0x0
  801e8e:	e8 f6 ed ff ff       	call   800c89 <sys_page_map>
  ...
  801e9c:	8b 15 40 30 80 00    	mov    0x803040,%edx
  ...
  801eb1:	8b 15 40 30 80 00    	mov    0x803040,%edx
  ...
  801ef7:	e8 cf ed ff ff       	call   800ccb <sys_page_unmap>
  ...
  801f07:	e8 bf ed ff ff       	call   800ccb <sys_page_unmap>
  ...
  801f17:	e8 af ed ff ff       	call   800ccb <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801f37:	e8 90 ef ff ff       	call   800ecc <fd_lookup>
  ...
  801f49:	e8 18 ef ff ff       	call   800e66 <fd2data>
	return _pipeisclosed(fd, p);
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801f6d:	68 97 29 80 00       	push   $0x802997
  801f72:	ff 75 0c             	pushl  0xc(%ebp)
  801f75:	e8 c9 e8 ff ff       	call   800843 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801fb1:	50                   	push   %eax
  801fb2:	57                   	push   %edi
  801fb3:	e8 1d ea ff ff       	call   8009d5 <memmove>
		sys_cputs(buf, m);
  801fb8:	83 c4 08             	add    $0x8,%esp
  801fbb:	53                   	push   %ebx
  801fbc:	57                   	push   %edi
  801fbd:	e8 c8 eb ff ff       	call   800b8a <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801fe7:	eb 05                	jmp    801fee <devcons_read+0x18>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801fe9:	e8 39 ec ff ff       	call   800c27 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801fee:	e8 b5 eb ff ff       	call   800ba8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  802024:	50                   	push   %eax
  802025:	e8 60 eb ff ff       	call   800b8a <sys_cputs>
}
...
getchar(void)
{
  ...
  80203d:	e8 f0 f0 ff ff       	call   801132 <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  802067:	e8 60 ee ff ff       	call   800ecc <fd_lookup>
  ...
  802076:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
opencons(void)
{
  ...
  80208f:	50                   	push   %eax
  802090:	e8 e8 ed ff ff       	call   800e7d <fd_alloc>
...
opencons(void)
{
  ...
  8020ab:	e8 96 eb ff ff       	call   800c46 <sys_page_alloc>
  ...
  8020d1:	50                   	push   %eax
  8020d2:	e8 7f ed ff ff       	call   800e56 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8020ee:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  8020f0:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  ...
  8020fb:	50                   	push   %eax
  8020fc:	e8 f5 ec ff ff       	call   800df6 <sys_ipc_recv>

	if (r < 0) {
  802101:	83 c4 10             	add    $0x10,%esp
  802104:	85 c0                	test   %eax,%eax
  802106:	79 16                	jns    80211e <ipc_recv+0x3e>
		if (from_env_store)
  802108:	85 f6                	test   %esi,%esi
  80210a:	74 06                	je     802112 <ipc_recv+0x32>
			*from_env_store = 0;
  80210c:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  802112:	85 db                	test   %ebx,%ebx
  802114:	74 2c                	je     802142 <ipc_recv+0x62>
			*perm_store = 0;
  802116:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  80211c:	eb 24                	jmp    802142 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  80211e:	85 f6                	test   %esi,%esi
  802120:	74 0a                	je     80212c <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  802122:	a1 0c 40 80 00       	mov    0x80400c,%eax
  802127:	8b 40 74             	mov    0x74(%eax),%eax
  80212a:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  80212c:	85 db                	test   %ebx,%ebx
  80212e:	74 0a                	je     80213a <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  802130:	a1 0c 40 80 00       	mov    0x80400c,%eax
  802135:	8b 40 78             	mov    0x78(%eax),%eax
  802138:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  80213a:	a1 0c 40 80 00       	mov    0x80400c,%eax
  80213f:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802155:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  80215b:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  80215d:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  802162:	0f 44 d8             	cmove  %eax,%ebx
	}
  ...
  802169:	56                   	push   %esi
  80216a:	57                   	push   %edi
  80216b:	e8 63 ec ff ff       	call   800dd3 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  802170:	83 c4 10             	add    $0x10,%esp
  802173:	83 f8 f9             	cmp    $0xfffffff9,%eax
  802176:	75 07                	jne    80217f <ipc_send+0x36>
			sys_yield();
  802178:	e8 aa ea ff ff       	call   800c27 <sys_yield>
  80217d:	eb e6                	jmp    802165 <ipc_send+0x1c>
		} else if (r < 0) {
  80217f:	85 c0                	test   %eax,%eax
  802181:	79 12                	jns    802195 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  802183:	50                   	push   %eax
  802184:	68 a3 29 80 00       	push   $0x8029a3
  802189:	6a 51                	push   $0x51
  80218b:	68 b0 29 80 00       	push   $0x8029b0
  802190:	e8 50 e0 ff ff       	call   8001e5 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  8021cd:	75 d9                	jne    8021a8 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  8021de:	c1 e8 16             	shr    $0x16,%eax
  8021e1:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  8021ed:	f6 c1 01             	test   $0x1,%cl
  8021f0:	74 1d                	je     80220f <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  8021f2:	c1 ea 0c             	shr    $0xc,%edx
  8021f5:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  8021fc:	f6 c2 01             	test   $0x1,%dl
  8021ff:	74 0e                	je     80220f <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  802201:	c1 ea 0c             	shr    $0xc,%edx
  802204:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  80220b:	ef 
  80220c:	0f b7 c0             	movzwl %ax,%eax
}
  80220f:	5d                   	pop    %ebp
  802210:	c3                   	ret    
  802211:	66 90                	xchg   %ax,%ax
