...
num(int f, const char *s)
{
  ...
  800062:	e8 fe 16 00 00       	call   801765 <printf>
			bol = 0;
...
umain(int argc, char **argv)
{
  ...
  80012f:	e8 93 14 00 00       	call   8015c7 <open>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800214:	e8 54 00 00 00       	call   80026d <vcprintf>
	cprintf("\n");
  800219:	c7 04 24 b3 24 80 00 	movl   $0x8024b3,(%esp)
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80054f:	52                   	push   %edx
  800550:	68 7a 24 80 00       	push   $0x80247a
  800555:	53                   	push   %ebx
  800556:	56                   	push   %esi
...
stat(const char *path, struct Stat *stat)
{
  ...
  8013b6:	e8 0c 02 00 00       	call   8015c7 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013fd:	e8 15 09 00 00       	call   801d17 <ipc_find_env>
  ...
  801418:	e8 a6 08 00 00       	call   801cc3 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80141d:	83 c4 0c             	add    $0xc,%esp
  801420:	6a 00                	push   $0x0
  801422:	53                   	push   %ebx
  801423:	6a 00                	push   $0x0
  801425:	e8 30 08 00 00       	call   801c5a <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8014f1:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  8014f6:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  8014f9:	89 1d 04 50 80 00    	mov    %ebx,0x805004
  ...
  801521:	78 1d                	js     801540 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  801523:	39 d8                	cmp    %ebx,%eax
  801525:	76 19                	jbe    801540 <devfile_write+0x6a>
  801527:	68 5c 24 80 00       	push   $0x80245c
  80152c:	68 68 24 80 00       	push   $0x802468
  801531:	68 a3 00 00 00       	push   $0xa3
  801536:	68 7d 24 80 00       	push   $0x80247d
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801558:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  80155e:	ba 00 00 00 00       	mov    $0x0,%edx
  801563:	b8 03 00 00 00       	mov    $0x3,%eax
  801568:	e8 79 fe ff ff       	call   8013e6 <fsipc>
  ...
  801577:	68 88 24 80 00       	push   $0x802488
  80157c:	68 68 24 80 00       	push   $0x802468
  801581:	6a 7c                	push   $0x7c
  801583:	68 7d 24 80 00       	push   $0x80247d
  801588:	e8 58 ec ff ff       	call   8001e5 <_panic>
	assert(r <= PGSIZE);
  80158d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801592:	7e 16                	jle    8015aa <devfile_read+0x65>
  801594:	68 8f 24 80 00       	push   $0x80248f
  801599:	68 68 24 80 00       	push   $0x802468
  80159e:	6a 7d                	push   $0x7d
  8015a0:	68 7d 24 80 00       	push   $0x80247d
  8015a5:	e8 3b ec ff ff       	call   8001e5 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8015aa:	83 ec 04             	sub    $0x4,%esp
  8015ad:	50                   	push   %eax
  8015ae:	68 00 50 80 00       	push   $0x805000
  8015b3:	ff 75 0c             	pushl  0xc(%ebp)
  8015b6:	e8 1a f4 ff ff       	call   8009d5 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8015d1:	53                   	push   %ebx
  8015d2:	e8 33 f2 ff ff       	call   80080a <strlen>
  ...
  8015e7:	50                   	push   %eax
  8015e8:	e8 71 f8 ff ff       	call   800e5e <fd_alloc>
  ...
  8015ff:	e8 3f f2 ff ff       	call   800843 <strcpy>
  ...
  801614:	e8 cd fd ff ff       	call   8013e6 <fsipc>
  ...
  80162a:	e8 27 f9 ff ff       	call   800f56 <fd_close>
		return r;
  ...
  80163c:	e8 f6 f7 ff ff       	call   800e37 <fd2num>
...
sync(void)
{
  ...
  801664:	e8 7d fd ff ff       	call   8013e6 <fsipc>
}
  801669:	c9                   	leave  
  80166a:	c3                   	ret    
...
writebuf(struct printbuf *b)
{
  ...
  801683:	e8 65 fb ff ff       	call   8011ed <write>
		if (result > 0)
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  801721:	e8 cf ec ff ff       	call   8003f5 <vprintfmt>
	if (b.idx > 0)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801793:	68 9b 24 80 00       	push   $0x80249b
  801798:	53                   	push   %ebx
  801799:	e8 a5 f0 ff ff       	call   800843 <strcpy>
  ...
  8017b0:	00 00 00 
	stat->st_dev = &devpipe;
  8017b3:	c7 83 88 00 00 00 24 	movl   $0x803024,0x88(%ebx)
  8017ba:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8017d6:	e8 f0 f4 ff ff       	call   800ccb <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8017db:	89 1c 24             	mov    %ebx,(%esp)
  8017de:	e8 64 f6 ff ff       	call   800e47 <fd2data>
  8017e3:	83 c4 08             	add    $0x8,%esp
  8017e6:	50                   	push   %eax
  8017e7:	6a 00                	push   $0x0
  8017e9:	e8 dd f4 ff ff       	call   800ccb <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80180f:	e8 3c 05 00 00       	call   801d50 <pageref>
  801814:	89 c3                	mov    %eax,%ebx
  801816:	89 3c 24             	mov    %edi,(%esp)
  801819:	e8 32 05 00 00       	call   801d50 <pageref>
  ...
  801829:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  80182c:	8b 15 08 40 80 00    	mov    0x804008,%edx
  ...
  801843:	50                   	push   %eax
  801844:	56                   	push   %esi
  801845:	68 a2 24 80 00       	push   $0x8024a2
  80184a:	e8 6f ea ff ff       	call   8002be <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80186b:	56                   	push   %esi
  80186c:	e8 d6 f5 ff ff       	call   800e47 <fd2data>
  ...
  801888:	75 48                	jne    8018d2 <devpipe_write+0x73>
			...
			sys_yield();
  80188a:	e8 98 f3 ff ff       	call   800c27 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8018e8:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  8018eb:	57                   	push   %edi
  8018ec:	e8 56 f5 ff ff       	call   800e47 <fd2data>
  ...
  801910:	75 32                	jne    801944 <devpipe_read+0x65>
			...
			sys_yield();
  801912:	e8 10 f3 ff ff       	call   800c27 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  80195c:	50                   	push   %eax
  80195d:	e8 fc f4 ff ff       	call   800e5e <fd_alloc>
  ...
  80197c:	e8 c5 f2 ff ff       	call   800c46 <sys_page_alloc>
  ...
  801994:	50                   	push   %eax
  801995:	e8 c4 f4 ff ff       	call   800e5e <fd_alloc>
  ...
  8019b4:	e8 8d f2 ff ff       	call   800c46 <sys_page_alloc>
  ...
  8019cc:	e8 76 f4 ff ff       	call   800e47 <fd2data>
  ...
  8019de:	e8 63 f2 ff ff       	call   800c46 <sys_page_alloc>
  ...
  8019f6:	e8 4c f4 ff ff       	call   800e47 <fd2data>
  8019fb:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801a02:	50                   	push   %eax
  801a03:	6a 00                	push   $0x0
  801a05:	56                   	push   %esi
  801a06:	6a 00                	push   $0x0
  801a08:	e8 7c f2 ff ff       	call   800c89 <sys_page_map>
  ...
  801a71:	e8 55 f2 ff ff       	call   800ccb <sys_page_unmap>
  ...
  801a81:	e8 45 f2 ff ff       	call   800ccb <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801ab1:	e8 f7 f3 ff ff       	call   800ead <fd_lookup>
  ...
  801ac3:	e8 7f f3 ff ff       	call   800e47 <fd2data>
	return _pipeisclosed(fd, p);
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ae7:	68 ba 24 80 00       	push   $0x8024ba
  801aec:	ff 75 0c             	pushl  0xc(%ebp)
  801aef:	e8 4f ed ff ff       	call   800843 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801b2b:	50                   	push   %eax
  801b2c:	57                   	push   %edi
  801b2d:	e8 a3 ee ff ff       	call   8009d5 <memmove>
		sys_cputs(buf, m);
  801b32:	83 c4 08             	add    $0x8,%esp
  801b35:	53                   	push   %ebx
  801b36:	57                   	push   %edi
  801b37:	e8 4e f0 ff ff       	call   800b8a <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801b61:	eb 05                	jmp    801b68 <devcons_read+0x18>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801b63:	e8 bf f0 ff ff       	call   800c27 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801b68:	e8 3b f0 ff ff       	call   800ba8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801b9e:	50                   	push   %eax
  801b9f:	e8 e6 ef ff ff       	call   800b8a <sys_cputs>
}
...
getchar(void)
{
  ...
  801bb7:	e8 57 f5 ff ff       	call   801113 <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  801be1:	e8 c7 f2 ff ff       	call   800ead <fd_lookup>
  ...
  801bf0:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
opencons(void)
{
  ...
  801c09:	50                   	push   %eax
  801c0a:	e8 4f f2 ff ff       	call   800e5e <fd_alloc>
...
opencons(void)
{
  ...
  801c25:	e8 1c f0 ff ff       	call   800c46 <sys_page_alloc>
  ...
  801c33:	8b 15 40 30 80 00    	mov    0x803040,%edx
  ...
  801c4b:	50                   	push   %eax
  801c4c:	e8 e6 f1 ff ff       	call   800e37 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c68:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801c6a:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801c6f:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801c72:	83 ec 0c             	sub    $0xc,%esp
  801c75:	50                   	push   %eax
  801c76:	e8 7b f1 ff ff       	call   800df6 <sys_ipc_recv>

	if (r < 0) {
  801c7b:	83 c4 10             	add    $0x10,%esp
  801c7e:	85 c0                	test   %eax,%eax
  801c80:	79 16                	jns    801c98 <ipc_recv+0x3e>
		if (from_env_store)
  801c82:	85 f6                	test   %esi,%esi
  801c84:	74 06                	je     801c8c <ipc_recv+0x32>
			*from_env_store = 0;
  801c86:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801c8c:	85 db                	test   %ebx,%ebx
  801c8e:	74 2c                	je     801cbc <ipc_recv+0x62>
			*perm_store = 0;
  801c90:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801c96:	eb 24                	jmp    801cbc <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801c98:	85 f6                	test   %esi,%esi
  801c9a:	74 0a                	je     801ca6 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  801c9c:	a1 08 40 80 00       	mov    0x804008,%eax
  801ca1:	8b 40 74             	mov    0x74(%eax),%eax
  801ca4:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  801ca6:	85 db                	test   %ebx,%ebx
  801ca8:	74 0a                	je     801cb4 <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  801caa:	a1 08 40 80 00       	mov    0x804008,%eax
  801caf:	8b 40 78             	mov    0x78(%eax),%eax
  801cb2:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  801cb4:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801cd5:	85 db                	test   %ebx,%ebx
		...
		va = (void *) KERNBASE;
  801cd7:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  ...
  801ce3:	56                   	push   %esi
  801ce4:	57                   	push   %edi
  801ce5:	e8 e9 f0 ff ff       	call   800dd3 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801cea:	83 c4 10             	add    $0x10,%esp
  801ced:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801cf0:	75 07                	jne    801cf9 <ipc_send+0x36>
			sys_yield();
  801cf2:	e8 30 ef ff ff       	call   800c27 <sys_yield>
  801cf7:	eb e6                	jmp    801cdf <ipc_send+0x1c>
		} else if (r < 0) {
  801cf9:	85 c0                	test   %eax,%eax
  801cfb:	79 12                	jns    801d0f <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801cfd:	50                   	push   %eax
  801cfe:	68 c6 24 80 00       	push   $0x8024c6
  801d03:	6a 51                	push   $0x51
  801d05:	68 d3 24 80 00       	push   $0x8024d3
  801d0a:	e8 d6 e4 ff ff       	call   8001e5 <_panic>
		}
	}
}
