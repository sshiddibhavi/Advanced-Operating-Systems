...
umain(int argc, char **argv)
{
  ...
  8000d5:	e8 0a 17 00 00       	call   8017e4 <fprintf>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800491:	52                   	push   %edx
  800492:	68 16 25 80 00       	push   $0x802516
  800497:	53                   	push   %ebx
  800498:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800b3d:	e8 ae 11 00 00       	call   801cf0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bbe:	e8 2d 11 00 00       	call   801cf0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c00:	e8 eb 10 00 00       	call   801cf0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c42:	e8 a9 10 00 00       	call   801cf0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c84:	e8 67 10 00 00       	call   801cf0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cc6:	e8 25 10 00 00       	call   801cf0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d08:	e8 e3 0f 00 00       	call   801cf0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d6c:	e8 7f 0f 00 00       	call   801cf0 <_panic>
...
stat(const char *path, struct Stat *stat)
{
  ...
  80144c:	e8 0c 02 00 00       	call   80165d <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801493:	e8 5b 09 00 00       	call   801df3 <ipc_find_env>
  ...
  8014ae:	e8 ec 08 00 00       	call   801d9f <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8014b3:	83 c4 0c             	add    $0xc,%esp
  8014b6:	6a 00                	push   $0x0
  8014b8:	53                   	push   %ebx
  8014b9:	6a 00                	push   $0x0
  8014bb:	e8 76 08 00 00       	call   801d36 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801582:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801587:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  80158c:	0f 46 d8             	cmovbe %eax,%ebx
  ...
  8015b7:	78 1d                	js     8015d6 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  8015b9:	39 d8                	cmp    %ebx,%eax
  8015bb:	76 19                	jbe    8015d6 <devfile_write+0x6a>
  8015bd:	68 f8 24 80 00       	push   $0x8024f8
  8015c2:	68 04 25 80 00       	push   $0x802504
  8015c7:	68 a3 00 00 00       	push   $0xa3
  8015cc:	68 19 25 80 00       	push   $0x802519
  8015d1:	e8 1a 07 00 00       	call   801cf0 <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8015ee:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8015f4:	ba 00 00 00 00       	mov    $0x0,%edx
  8015f9:	b8 03 00 00 00       	mov    $0x3,%eax
  8015fe:	e8 79 fe ff ff       	call   80147c <fsipc>
  801603:	89 c3                	mov    %eax,%ebx
  801605:	85 c0                	test   %eax,%eax
  801607:	78 4b                	js     801654 <devfile_read+0x79>
		return r;
	assert(r <= n);
  801609:	39 c6                	cmp    %eax,%esi
  80160b:	73 16                	jae    801623 <devfile_read+0x48>
  80160d:	68 24 25 80 00       	push   $0x802524
  801612:	68 04 25 80 00       	push   $0x802504
  801617:	6a 7c                	push   $0x7c
  801619:	68 19 25 80 00       	push   $0x802519
  80161e:	e8 cd 06 00 00       	call   801cf0 <_panic>
	assert(r <= PGSIZE);
  801623:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801628:	7e 16                	jle    801640 <devfile_read+0x65>
  80162a:	68 2b 25 80 00       	push   $0x80252b
  80162f:	68 04 25 80 00       	push   $0x802504
  801634:	6a 7d                	push   $0x7d
  801636:	68 19 25 80 00       	push   $0x802519
  80163b:	e8 b0 06 00 00       	call   801cf0 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801640:	83 ec 04             	sub    $0x4,%esp
  801643:	50                   	push   %eax
  801644:	68 00 50 80 00       	push   $0x805000
  801649:	ff 75 0c             	pushl  0xc(%ebp)
  80164c:	e8 c6 f2 ff ff       	call   800917 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  801667:	53                   	push   %ebx
  801668:	e8 df f0 ff ff       	call   80074c <strlen>
  80166d:	83 c4 10             	add    $0x10,%esp
  801670:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801675:	7f 67                	jg     8016de <open+0x81>
		return -E_BAD_PATH;
  ...
  80167d:	50                   	push   %eax
  80167e:	e8 71 f8 ff ff       	call   800ef4 <fd_alloc>
  ...
  80168a:	78 57                	js     8016e3 <open+0x86>
		return r;
  ...
  801695:	e8 eb f0 ff ff       	call   800785 <strcpy>
  ...
  8016dc:	eb 05                	jmp    8016e3 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  8016de:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  8016fa:	e8 7d fd ff ff       	call   80147c <fsipc>
}
  8016ff:	c9                   	leave  
  801700:	c3                   	ret    
...
{
	if (b->error > 0) {
  801701:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  801705:	7e 37                	jle    80173e <writebuf+0x3d>
};
...
writebuf(struct printbuf *b)
{
  ...
  801710:	ff 70 04             	pushl  0x4(%eax)
  801713:	8d 40 10             	lea    0x10(%eax),%eax
  801716:	50                   	push   %eax
  801717:	ff 33                	pushl  (%ebx)
  801719:	e8 65 fb ff ff       	call   801283 <write>
		if (result > 0)
  80171e:	83 c4 10             	add    $0x10,%esp
  801721:	85 c0                	test   %eax,%eax
  801723:	7e 03                	jle    801728 <writebuf+0x27>
			b->result += result;
  801725:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  801728:	3b 43 04             	cmp    0x4(%ebx),%eax
  80172b:	74 0d                	je     80173a <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  80172d:	85 c0                	test   %eax,%eax
  80172f:	ba 00 00 00 00       	mov    $0x0,%edx
  801734:	0f 4f c2             	cmovg  %edx,%eax
  801737:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  80173a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  80173d:	c9                   	leave  
  80173e:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  801747:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  80174a:	8b 53 04             	mov    0x4(%ebx),%edx
  80174d:	8d 42 01             	lea    0x1(%edx),%eax
  801750:	89 43 04             	mov    %eax,0x4(%ebx)
  801753:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801756:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  80175a:	3d 00 01 00 00       	cmp    $0x100,%eax
  80175f:	75 0e                	jne    80176f <putch+0x2f>
		writebuf(b);
  801761:	89 d8                	mov    %ebx,%eax
  801763:	e8 99 ff ff ff       	call   801701 <writebuf>
		b->idx = 0;
  801768:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	}
}
  80176f:	83 c4 04             	add    $0x4,%esp
  801772:	5b                   	pop    %ebx
  801773:	5d                   	pop    %ebp
  801774:	c3                   	ret    
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  801778:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  80177e:	8b 45 08             	mov    0x8(%ebp),%eax
  801781:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  801787:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  80178e:	00 00 00 
	b.result = 0;
  801791:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  801798:	00 00 00 
	b.error = 1;
  80179b:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  8017a2:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  8017a5:	ff 75 10             	pushl  0x10(%ebp)
  8017a8:	ff 75 0c             	pushl  0xc(%ebp)
  8017ab:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  8017b1:	50                   	push   %eax
  8017b2:	68 40 17 80 00       	push   $0x801740
  8017b7:	e8 7b eb ff ff       	call   800337 <vprintfmt>
	if (b.idx > 0)
  8017bc:	83 c4 10             	add    $0x10,%esp
  8017bf:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  8017c6:	7e 0b                	jle    8017d3 <vfprintf+0x5e>
		writebuf(&b);
  8017c8:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  8017ce:	e8 2e ff ff ff       	call   801701 <writebuf>

	return (b.result ? b.result : b.error);
  8017d3:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8017d9:	85 c0                	test   %eax,%eax
  8017db:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  8017e2:	c9                   	leave  
  8017e3:	c3                   	ret    
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  8017f4:	e8 7c ff ff ff       	call   801775 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  80180a:	e8 66 ff ff ff       	call   801775 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80181f:	e8 b9 f6 ff ff       	call   800edd <fd2data>
  801824:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801826:	83 c4 08             	add    $0x8,%esp
  801829:	68 37 25 80 00       	push   $0x802537
  80182e:	53                   	push   %ebx
  80182f:	e8 51 ef ff ff       	call   800785 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801834:	8b 46 04             	mov    0x4(%esi),%eax
  801837:	2b 06                	sub    (%esi),%eax
  801839:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  80183f:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801846:	00 00 00 
	stat->st_dev = &devpipe;
  801849:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801850:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  80186c:	e8 9c f3 ff ff       	call   800c0d <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801871:	89 1c 24             	mov    %ebx,(%esp)
  801874:	e8 64 f6 ff ff       	call   800edd <fd2data>
  801879:	83 c4 08             	add    $0x8,%esp
  80187c:	50                   	push   %eax
  80187d:	6a 00                	push   $0x0
  80187f:	e8 89 f3 ff ff       	call   800c0d <sys_page_unmap>
}
  801884:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801887:	c9                   	leave  
  801888:	c3                   	ret    

00801889 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801895:	89 d7                	mov    %edx,%edi
	...
	while (1) {
		n = thisenv->env_runs;
  801897:	a1 04 40 80 00       	mov    0x804004,%eax
  80189c:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  80189f:	83 ec 0c             	sub    $0xc,%esp
  8018a2:	ff 75 e0             	pushl  -0x20(%ebp)
  8018a5:	e8 82 05 00 00       	call   801e2c <pageref>
  8018aa:	89 c3                	mov    %eax,%ebx
  8018ac:	89 3c 24             	mov    %edi,(%esp)
  8018af:	e8 78 05 00 00       	call   801e2c <pageref>
  8018b4:	83 c4 10             	add    $0x10,%esp
  8018b7:	39 c3                	cmp    %eax,%ebx
  8018b9:	0f 94 c1             	sete   %cl
  8018bc:	0f b6 c9             	movzbl %cl,%ecx
  8018bf:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  8018c2:	8b 15 04 40 80 00    	mov    0x804004,%edx
  8018c8:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  8018cb:	39 ce                	cmp    %ecx,%esi
  8018cd:	74 1b                	je     8018ea <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  8018cf:	39 c3                	cmp    %eax,%ebx
  8018d1:	75 c4                	jne    801897 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8018d3:	8b 42 58             	mov    0x58(%edx),%eax
  8018d6:	ff 75 e4             	pushl  -0x1c(%ebp)
  8018d9:	50                   	push   %eax
  8018da:	56                   	push   %esi
  8018db:	68 3e 25 80 00       	push   $0x80253e
  8018e0:	e8 1b e9 ff ff       	call   800200 <cprintf>
  8018e5:	83 c4 10             	add    $0x10,%esp
  8018e8:	eb ad                	jmp    801897 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801901:	56                   	push   %esi
  801902:	e8 d6 f5 ff ff       	call   800edd <fd2data>
  ...
  801917:	e8 6d ff ff ff       	call   801889 <_pipeisclosed>
  ...
  80191e:	75 48                	jne    801968 <devpipe_write+0x73>
			...
			sys_yield();
  801920:	e8 44 f2 ff ff       	call   800b69 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80197e:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801981:	57                   	push   %edi
  801982:	e8 56 f5 ff ff       	call   800edd <fd2data>
  ...
  80199f:	e8 e5 fe ff ff       	call   801889 <_pipeisclosed>
  ...
  8019a6:	75 32                	jne    8019da <devpipe_read+0x65>
			...
			sys_yield();
  8019a8:	e8 bc f1 ff ff       	call   800b69 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8019f2:	50                   	push   %eax
  8019f3:	e8 fc f4 ff ff       	call   800ef4 <fd_alloc>
  ...
  801a12:	e8 71 f1 ff ff       	call   800b88 <sys_page_alloc>
  ...
  801a2a:	50                   	push   %eax
  801a2b:	e8 c4 f4 ff ff       	call   800ef4 <fd_alloc>
  ...
  801a4a:	e8 39 f1 ff ff       	call   800b88 <sys_page_alloc>
  ...
  801a62:	e8 76 f4 ff ff       	call   800edd <fd2data>
  ...
  801a74:	e8 0f f1 ff ff       	call   800b88 <sys_page_alloc>
  ...
  801a8c:	e8 4c f4 ff ff       	call   800edd <fd2data>
  801a91:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801a98:	50                   	push   %eax
  801a99:	6a 00                	push   $0x0
  801a9b:	56                   	push   %esi
  801a9c:	6a 00                	push   $0x0
  801a9e:	e8 28 f1 ff ff       	call   800bcb <sys_page_map>
  ...
  801b07:	e8 01 f1 ff ff       	call   800c0d <sys_page_unmap>
  ...
  801b17:	e8 f1 f0 ff ff       	call   800c0d <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801b47:	e8 f7 f3 ff ff       	call   800f43 <fd_lookup>
  801b4c:	83 c4 10             	add    $0x10,%esp
  801b4f:	85 c0                	test   %eax,%eax
  801b51:	78 18                	js     801b6b <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801b53:	83 ec 0c             	sub    $0xc,%esp
  801b56:	ff 75 f4             	pushl  -0xc(%ebp)
  801b59:	e8 7f f3 ff ff       	call   800edd <fd2data>
	return _pipeisclosed(fd, p);
  801b5e:	89 c2                	mov    %eax,%edx
  801b60:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b63:	e8 21 fd ff ff       	call   801889 <_pipeisclosed>
  801b68:	83 c4 10             	add    $0x10,%esp
}
  801b6b:	c9                   	leave  
  801b6c:	c3                   	ret    

00801b6d <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b7d:	68 56 25 80 00       	push   $0x802556
  801b82:	ff 75 0c             	pushl  0xc(%ebp)
  801b85:	e8 fb eb ff ff       	call   800785 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801b95:	56                   	push   %esi
  801b96:	53                   	push   %ebx
  801b97:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  801ba2:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801ba8:	eb 2d                	jmp    801bd7 <devcons_write+0x46>
		m = n - tot;
  801baa:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801bad:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801baf:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801bb2:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801bb7:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  801bc1:	50                   	push   %eax
  801bc2:	57                   	push   %edi
  801bc3:	e8 4f ed ff ff       	call   800917 <memmove>
		sys_cputs(buf, m);
  801bc8:	83 c4 08             	add    $0x8,%esp
  801bcb:	53                   	push   %ebx
  801bcc:	57                   	push   %edi
  801bcd:	e8 fa ee ff ff       	call   800acc <sys_cputs>
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801bd2:	01 de                	add    %ebx,%esi
  801bd4:	83 c4 10             	add    $0x10,%esp
  801bd7:	89 f0                	mov    %esi,%eax
  801bd9:	3b 75 10             	cmp    0x10(%ebp),%esi
  801bdc:	72 cc                	jb     801baa <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801bf5:	74 2a                	je     801c21 <devcons_read+0x3b>
  801bf7:	eb 05                	jmp    801bfe <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801bf9:	e8 6b ef ff ff       	call   800b69 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801bfe:	e8 e7 ee ff ff       	call   800aea <sys_cgetc>
  801c03:	85 c0                	test   %eax,%eax
  801c05:	74 f2                	je     801bf9 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801c07:	85 c0                	test   %eax,%eax
  801c09:	78 16                	js     801c21 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801c0b:	83 f8 04             	cmp    $0x4,%eax
  801c0e:	74 0c                	je     801c1c <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  801c10:	8b 55 0c             	mov    0xc(%ebp),%edx
  801c13:	88 02                	mov    %al,(%edx)
	return 1;
  801c15:	b8 01 00 00 00       	mov    $0x1,%eax
  801c1a:	eb 05                	jmp    801c21 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801c2c:	88 45 f7             	mov    %al,-0x9(%ebp)
  ...
  801c34:	50                   	push   %eax
  801c35:	e8 92 ee ff ff       	call   800acc <sys_cputs>
}
...
getchar(void)
{
  ...
  801c4d:	e8 57 f5 ff ff       	call   8011a9 <read>
	if (r < 0)
  801c52:	83 c4 10             	add    $0x10,%esp
  801c55:	85 c0                	test   %eax,%eax
  801c57:	78 0f                	js     801c68 <getchar+0x29>
		return r;
	if (r < 1)
  801c59:	85 c0                	test   %eax,%eax
  801c5b:	7e 06                	jle    801c63 <getchar+0x24>
		return -E_EOF;
	return c;
  801c5d:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801c61:	eb 05                	jmp    801c68 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801c63:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801c68:	c9                   	leave  
  801c69:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  801c77:	e8 c7 f2 ff ff       	call   800f43 <fd_lookup>
  801c7c:	83 c4 10             	add    $0x10,%esp
  801c7f:	85 c0                	test   %eax,%eax
  801c81:	78 11                	js     801c94 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  801c83:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c86:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801c8c:	39 10                	cmp    %edx,(%eax)
  801c8e:	0f 94 c0             	sete   %al
...
opencons(void)
{
  ...
  801c9f:	50                   	push   %eax
  801ca0:	e8 4f f2 ff ff       	call   800ef4 <fd_alloc>
...
opencons(void)
{
  ...
  801cac:	78 3e                	js     801cec <opencons+0x56>
		return r;
  ...
  801cbb:	e8 c8 ee ff ff       	call   800b88 <sys_page_alloc>
  ...
  801cc7:	78 23                	js     801cec <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  801cc9:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  801ce1:	50                   	push   %eax
  801ce2:	e8 e6 f1 ff ff       	call   800ecd <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801cf4:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801cf5:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801cf8:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801cfe:	e8 47 ee ff ff       	call   800b4a <sys_getenvid>
  801d03:	83 ec 0c             	sub    $0xc,%esp
  801d06:	ff 75 0c             	pushl  0xc(%ebp)
  801d09:	ff 75 08             	pushl  0x8(%ebp)
  801d0c:	56                   	push   %esi
  801d0d:	50                   	push   %eax
  801d0e:	68 64 25 80 00       	push   $0x802564
  801d13:	e8 e8 e4 ff ff       	call   800200 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801d18:	83 c4 18             	add    $0x18,%esp
  801d1b:	53                   	push   %ebx
  801d1c:	ff 75 10             	pushl  0x10(%ebp)
  801d1f:	e8 8b e4 ff ff       	call   8001af <vcprintf>
	cprintf("\n");
  801d24:	c7 04 24 10 21 80 00 	movl   $0x802110,(%esp)
  801d2b:	e8 d0 e4 ff ff       	call   800200 <cprintf>
  801d30:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801d33:	cc                   	int3   
  801d34:	eb fd                	jmp    801d33 <_panic+0x43>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d44:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801d46:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801d4b:	0f 44 c2             	cmove  %edx,%eax
	}

	r = sys_ipc_recv(va);
  801d4e:	83 ec 0c             	sub    $0xc,%esp
  801d51:	50                   	push   %eax
  801d52:	e8 e1 ef ff ff       	call   800d38 <sys_ipc_recv>

	if (r < 0) {
  801d57:	83 c4 10             	add    $0x10,%esp
  801d5a:	85 c0                	test   %eax,%eax
  801d5c:	79 16                	jns    801d74 <ipc_recv+0x3e>
		if (from_env_store)
  801d5e:	85 f6                	test   %esi,%esi
  801d60:	74 06                	je     801d68 <ipc_recv+0x32>
			*from_env_store = 0;
  801d62:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

		if (perm_store)
  801d68:	85 db                	test   %ebx,%ebx
  801d6a:	74 2c                	je     801d98 <ipc_recv+0x62>
			*perm_store = 0;
  801d6c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d72:	eb 24                	jmp    801d98 <ipc_recv+0x62>

		return r;
	} else {
		if (from_env_store)
  801d74:	85 f6                	test   %esi,%esi
  801d76:	74 0a                	je     801d82 <ipc_recv+0x4c>
			*from_env_store = thisenv->env_ipc_from;
  801d78:	a1 04 40 80 00       	mov    0x804004,%eax
  801d7d:	8b 40 74             	mov    0x74(%eax),%eax
  801d80:	89 06                	mov    %eax,(%esi)

		if (perm_store)
  801d82:	85 db                	test   %ebx,%ebx
  801d84:	74 0a                	je     801d90 <ipc_recv+0x5a>
			*perm_store = thisenv->env_ipc_perm;
  801d86:	a1 04 40 80 00       	mov    0x804004,%eax
  801d8b:	8b 40 78             	mov    0x78(%eax),%eax
  801d8e:	89 03                	mov    %eax,(%ebx)

		return thisenv->env_ipc_value;
  801d90:	a1 04 40 80 00       	mov    0x804004,%eax
  801d95:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dae:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	void *va;
	if (pg) {
  801db1:	85 db                	test   %ebx,%ebx
		va = pg;
	} else {
		va = (void *) KERNBASE;
  801db3:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801db8:	0f 44 d8             	cmove  %eax,%ebx
	}
  ...
  801dbf:	56                   	push   %esi
  801dc0:	57                   	push   %edi
  801dc1:	e8 4f ef ff ff       	call   800d15 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801dc6:	83 c4 10             	add    $0x10,%esp
  801dc9:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801dcc:	75 07                	jne    801dd5 <ipc_send+0x36>
			sys_yield();
  801dce:	e8 96 ed ff ff       	call   800b69 <sys_yield>
  801dd3:	eb e6                	jmp    801dbb <ipc_send+0x1c>
		} else if (r < 0) {
  801dd5:	85 c0                	test   %eax,%eax
  801dd7:	79 12                	jns    801deb <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801dd9:	50                   	push   %eax
  801dda:	68 88 25 80 00       	push   $0x802588
  801ddf:	6a 51                	push   $0x51
  801de1:	68 95 25 80 00       	push   $0x802595
  801de6:	e8 05 ff ff ff       	call   801cf0 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e0c:	75 0d                	jne    801e1b <ipc_find_env+0x28>
			return envs[i].env_id;
  801e0e:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e11:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801e16:	8b 40 48             	mov    0x48(%eax),%eax
  801e19:	eb 0f                	jmp    801e2a <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e1e:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e23:	75 d9                	jne    801dfe <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801e34:	c1 e8 16             	shr    $0x16,%eax
  801e37:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
  ...
  801e46:	74 1d                	je     801e65 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e48:	c1 ea 0c             	shr    $0xc,%edx
  801e4b:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e52:	f6 c2 01             	test   $0x1,%dl
  801e55:	74 0e                	je     801e65 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e57:	c1 ea 0c             	shr    $0xc,%edx
  801e5a:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e61:	ef 
  801e62:	0f b7 c0             	movzwl %ax,%eax
}
  801e65:	5d                   	pop    %ebp
  801e66:	c3                   	ret    
