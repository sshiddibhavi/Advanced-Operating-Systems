	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 88 22 80 00 	movsbl 0x802288(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 c0 23 80 00 	jmp    *0x8023c0(,%eax,4)
  ...
  8003af:	8b 14 85 20 25 80 00 	mov    0x802520(,%eax,4),%edx
  8003b6:	85 d2                	test   %edx,%edx
  8003b8:	75 18                	jne    8003d2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ba:	50                   	push   %eax
  8003bb:	68 a0 22 80 00       	push   $0x8022a0
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 5a 26 80 00       	push   $0x80265a
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 99 22 80 00       	mov    $0x802299,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a72:	68 7f 25 80 00       	push   $0x80257f
  800a77:	6a 23                	push   $0x23
  800a79:	68 9c 25 80 00       	push   $0x80259c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800af3:	68 7f 25 80 00       	push   $0x80257f
  800af8:	6a 23                	push   $0x23
  800afa:	68 9c 25 80 00       	push   $0x80259c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dae:	ba 28 26 80 00       	mov    $0x802628,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dd9:	51                   	push   %ecx
  800dda:	50                   	push   %eax
  800ddb:	68 ac 25 80 00       	push   $0x8025ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801003:	53                   	push   %ebx
  801004:	50                   	push   %eax
  801005:	68 ed 25 80 00       	push   $0x8025ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010d8:	53                   	push   %ebx
  8010d9:	50                   	push   %eax
  8010da:	68 09 26 80 00       	push   $0x802609
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80118d:	53                   	push   %ebx
  80118e:	50                   	push   %eax
  80118f:	68 cc 25 80 00       	push   $0x8025cc
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8013c9:	68 3c 26 80 00       	push   $0x80263c
  8013ce:	68 48 26 80 00       	push   $0x802648
  8013d3:	68 a3 00 00 00       	push   $0xa3
  8013d8:	68 5d 26 80 00       	push   $0x80265d
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801419:	68 68 26 80 00       	push   $0x802668
  80141e:	68 48 26 80 00       	push   $0x802648
  801423:	6a 7c                	push   $0x7c
  801425:	68 5d 26 80 00       	push   $0x80265d
  80142a:	e8 24 0a 00 00       	call   801e53 <_panic>
	assert(r <= PGSIZE);
  80142f:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801434:	7e 16                	jle    80144c <devfile_read+0x65>
  801436:	68 6f 26 80 00       	push   $0x80266f
  80143b:	68 48 26 80 00       	push   $0x802648
  801440:	6a 7d                	push   $0x7d
  801442:	68 5d 26 80 00       	push   $0x80265d
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801513:	68 7b 26 80 00       	push   $0x80267b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8018b9:	68 87 26 80 00       	push   $0x802687
  8018be:	68 48 26 80 00       	push   $0x802648
  8018c3:	6a 62                	push   $0x62
  8018c5:	68 9c 26 80 00       	push   $0x80269c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801906:	68 a8 26 80 00       	push   $0x8026a8
  80190b:	68 48 26 80 00       	push   $0x802648
  801910:	6a 6d                	push   $0x6d
  801912:	68 9c 26 80 00       	push   $0x80269c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80198c:	68 b4 26 80 00       	push   $0x8026b4
  801991:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801a3c:	50                   	push   %eax
  801a3d:	56                   	push   %esi
  801a3e:	68 bb 26 80 00       	push   $0x8026bb
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ce0:	68 d3 26 80 00       	push   $0x8026d3
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e6f:	56                   	push   %esi
  801e70:	50                   	push   %eax
  801e71:	68 e0 26 80 00       	push   $0x8026e0
  ...
  801e82:	e8 69 e2 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801e87:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f3a:	79 12                	jns    801f4e <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801f3c:	50                   	push   %eax
  801f3d:	68 04 27 80 00       	push   $0x802704
  801f42:	6a 51                	push   $0x51
  801f44:	68 11 27 80 00       	push   $0x802711
