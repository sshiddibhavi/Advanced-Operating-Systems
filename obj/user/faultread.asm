...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 d6 21 80 00       	push   $0x8021d6
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8013aa:	68 b8 21 80 00       	push   $0x8021b8
  8013af:	68 c4 21 80 00       	push   $0x8021c4
  8013b4:	68 a3 00 00 00       	push   $0xa3
  8013b9:	68 d9 21 80 00       	push   $0x8021d9
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013fa:	68 e4 21 80 00       	push   $0x8021e4
  8013ff:	68 c4 21 80 00       	push   $0x8021c4
  801404:	6a 7c                	push   $0x7c
  801406:	68 d9 21 80 00       	push   $0x8021d9
  80140b:	e8 bd 05 00 00       	call   8019cd <_panic>
	assert(r <= PGSIZE);
  801410:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801415:	7e 16                	jle    80142d <devfile_read+0x65>
  801417:	68 eb 21 80 00       	push   $0x8021eb
  80141c:	68 c4 21 80 00       	push   $0x8021c4
  801421:	6a 7d                	push   $0x7d
  801423:	68 d9 21 80 00       	push   $0x8021d9
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801506:	68 f7 21 80 00       	push   $0x8021f7
  80150b:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015b6:	50                   	push   %eax
  8015b7:	56                   	push   %esi
  8015b8:	68 fe 21 80 00       	push   $0x8021fe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80185a:	68 16 22 80 00       	push   $0x802216
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019e9:	56                   	push   %esi
  8019ea:	50                   	push   %eax
  8019eb:	68 24 22 80 00       	push   $0x802224
  ...
  8019fc:	e8 ef e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801a01:	c7 04 24 fc 1d 80 00 	movl   $0x801dfc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ab4:	79 12                	jns    801ac8 <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801ab6:	50                   	push   %eax
  801ab7:	68 48 22 80 00       	push   $0x802248
  801abc:	6a 51                	push   $0x51
  801abe:	68 55 22 80 00       	push   $0x802255
