...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003e4:	52                   	push   %edx
  8003e5:	68 f6 21 80 00       	push   $0x8021f6
  8003ea:	53                   	push   %ebx
  8003eb:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800a90:	e8 4a 0f 00 00       	call   8019df <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b11:	e8 c9 0e 00 00       	call   8019df <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b53:	e8 87 0e 00 00       	call   8019df <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b95:	e8 45 0e 00 00       	call   8019df <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bd7:	e8 03 0e 00 00       	call   8019df <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c19:	e8 c1 0d 00 00       	call   8019df <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c5b:	e8 7f 0d 00 00       	call   8019df <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cbf:	e8 1b 0d 00 00       	call   8019df <_panic>
...
stat(const char *path, struct Stat *stat)
{
  ...
  80124b:	e8 0c 02 00 00       	call   80145c <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801292:	e8 4b 08 00 00       	call   801ae2 <ipc_find_env>
  ...
  8012ad:	e8 dc 07 00 00       	call   801a8e <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8012b2:	83 c4 0c             	add    $0xc,%esp
  8012b5:	6a 00                	push   $0x0
  8012b7:	53                   	push   %ebx
  8012b8:	6a 00                	push   $0x0
  8012ba:	e8 66 07 00 00       	call   801a25 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801378:	8b 52 0c             	mov    0xc(%edx),%edx
  80137b:	89 15 00 50 80 00    	mov    %edx,0x805000
  801381:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801386:	bb f8 0f 00 00       	mov    $0xff8,%ebx
  80138b:	0f 46 d8             	cmovbe %eax,%ebx
	
	size_t n_real = min_size(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = n_real;
  80138e:	89 1d 04 50 80 00    	mov    %ebx,0x805004
  ...
  8013b6:	78 1d                	js     8013d5 <devfile_write+0x6a>
		return r;
	assert(r <= n_real); 
  8013b8:	39 d8                	cmp    %ebx,%eax
  8013ba:	76 19                	jbe    8013d5 <devfile_write+0x6a>
  8013bc:	68 d8 21 80 00       	push   $0x8021d8
  8013c1:	68 e4 21 80 00       	push   $0x8021e4
  8013c6:	68 a3 00 00 00       	push   $0xa3
  8013cb:	68 f9 21 80 00       	push   $0x8021f9
  8013d0:	e8 0a 06 00 00       	call   8019df <_panic>
	return r;
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013ed:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8013f3:	ba 00 00 00 00       	mov    $0x0,%edx
  8013f8:	b8 03 00 00 00       	mov    $0x3,%eax
  8013fd:	e8 79 fe ff ff       	call   80127b <fsipc>
  801402:	89 c3                	mov    %eax,%ebx
  801404:	85 c0                	test   %eax,%eax
  801406:	78 4b                	js     801453 <devfile_read+0x79>
		return r;
	assert(r <= n);
  801408:	39 c6                	cmp    %eax,%esi
  80140a:	73 16                	jae    801422 <devfile_read+0x48>
  80140c:	68 04 22 80 00       	push   $0x802204
  801411:	68 e4 21 80 00       	push   $0x8021e4
  801416:	6a 7c                	push   $0x7c
  801418:	68 f9 21 80 00       	push   $0x8021f9
  80141d:	e8 bd 05 00 00       	call   8019df <_panic>
	assert(r <= PGSIZE);
  801422:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801427:	7e 16                	jle    80143f <devfile_read+0x65>
  801429:	68 0b 22 80 00       	push   $0x80220b
  80142e:	68 e4 21 80 00       	push   $0x8021e4
  801433:	6a 7d                	push   $0x7d
  801435:	68 f9 21 80 00       	push   $0x8021f9
  80143a:	e8 a0 05 00 00       	call   8019df <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  80143f:	83 ec 04             	sub    $0x4,%esp
  801442:	50                   	push   %eax
  801443:	68 00 50 80 00       	push   $0x805000
  801448:	ff 75 0c             	pushl  0xc(%ebp)
  80144b:	e8 1a f4 ff ff       	call   80086a <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  801466:	53                   	push   %ebx
  801467:	e8 33 f2 ff ff       	call   80069f <strlen>
  80146c:	83 c4 10             	add    $0x10,%esp
  80146f:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801474:	7f 67                	jg     8014dd <open+0x81>
		return -E_BAD_PATH;
  ...
  80147c:	50                   	push   %eax
  80147d:	e8 71 f8 ff ff       	call   800cf3 <fd_alloc>
  ...
  8014db:	eb 05                	jmp    8014e2 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  8014dd:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  8014f9:	e8 7d fd ff ff       	call   80127b <fsipc>
}
  8014fe:	c9                   	leave  
  8014ff:	c3                   	ret    

00801500 <devpipe_stat>:
	return i;
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801518:	68 17 22 80 00       	push   $0x802217
  80151d:	53                   	push   %ebx
  80151e:	e8 b5 f1 ff ff       	call   8006d8 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801523:	8b 46 04             	mov    0x4(%esi),%eax
  801526:	2b 06                	sub    (%esi),%eax
  801528:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  80152e:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801535:	00 00 00 
	stat->st_dev = &devpipe;
  801538:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  80153f:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  80155b:	e8 00 f6 ff ff       	call   800b60 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801560:	89 1c 24             	mov    %ebx,(%esp)
  801563:	e8 74 f7 ff ff       	call   800cdc <fd2data>
  801568:	83 c4 08             	add    $0x8,%esp
  80156b:	50                   	push   %eax
  80156c:	6a 00                	push   $0x0
  80156e:	e8 ed f5 ff ff       	call   800b60 <sys_page_unmap>
}
  801573:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801576:	c9                   	leave  
  801577:	c3                   	ret    

00801578 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801581:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  80158b:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  80158e:	83 ec 0c             	sub    $0xc,%esp
  801591:	ff 75 e0             	pushl  -0x20(%ebp)
  801594:	e8 82 05 00 00       	call   801b1b <pageref>
  801599:	89 c3                	mov    %eax,%ebx
  80159b:	89 3c 24             	mov    %edi,(%esp)
  80159e:	e8 78 05 00 00       	call   801b1b <pageref>
  8015a3:	83 c4 10             	add    $0x10,%esp
  8015a6:	39 c3                	cmp    %eax,%ebx
  8015a8:	0f 94 c1             	sete   %cl
  8015ab:	0f b6 c9             	movzbl %cl,%ecx
  8015ae:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  8015b1:	8b 15 08 40 80 00    	mov    0x804008,%edx
  8015b7:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  8015ba:	39 ce                	cmp    %ecx,%esi
  8015bc:	74 1b                	je     8015d9 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  8015be:	39 c3                	cmp    %eax,%ebx
  8015c0:	75 c4                	jne    801586 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8015c2:	8b 42 58             	mov    0x58(%edx),%eax
  8015c5:	ff 75 e4             	pushl  -0x1c(%ebp)
  8015c8:	50                   	push   %eax
  8015c9:	56                   	push   %esi
  8015ca:	68 1e 22 80 00       	push   $0x80221e
  8015cf:	e8 7f eb ff ff       	call   800153 <cprintf>
  8015d4:	83 c4 10             	add    $0x10,%esp
  8015d7:	eb ad                	jmp    801586 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8015f0:	56                   	push   %esi
  8015f1:	e8 e6 f6 ff ff       	call   800cdc <fd2data>
  ...
  801606:	e8 6d ff ff ff       	call   801578 <_pipeisclosed>
  ...
  80160d:	75 48                	jne    801657 <devpipe_write+0x73>
			...
			sys_yield();
  80160f:	e8 a8 f4 ff ff       	call   800abc <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80166d:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801670:	57                   	push   %edi
  801671:	e8 66 f6 ff ff       	call   800cdc <fd2data>
  ...
  80168e:	e8 e5 fe ff ff       	call   801578 <_pipeisclosed>
  ...
  801695:	75 32                	jne    8016c9 <devpipe_read+0x65>
			...
			sys_yield();
  801697:	e8 20 f4 ff ff       	call   800abc <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8016e1:	50                   	push   %eax
  8016e2:	e8 0c f6 ff ff       	call   800cf3 <fd_alloc>
  ...
  801701:	e8 d5 f3 ff ff       	call   800adb <sys_page_alloc>
  ...
  801719:	50                   	push   %eax
  80171a:	e8 d4 f5 ff ff       	call   800cf3 <fd_alloc>
  ...
  801739:	e8 9d f3 ff ff       	call   800adb <sys_page_alloc>
  ...
  801751:	e8 86 f5 ff ff       	call   800cdc <fd2data>
  ...
  801763:	e8 73 f3 ff ff       	call   800adb <sys_page_alloc>
  ...
  80177b:	e8 5c f5 ff ff       	call   800cdc <fd2data>
  801780:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801787:	50                   	push   %eax
  801788:	6a 00                	push   $0x0
  80178a:	56                   	push   %esi
  80178b:	6a 00                	push   $0x0
  80178d:	e8 8c f3 ff ff       	call   800b1e <sys_page_map>
  ...
  8017f6:	e8 65 f3 ff ff       	call   800b60 <sys_page_unmap>
  ...
  801806:	e8 55 f3 ff ff       	call   800b60 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801836:	e8 07 f5 ff ff       	call   800d42 <fd_lookup>
  80183b:	83 c4 10             	add    $0x10,%esp
  80183e:	85 c0                	test   %eax,%eax
  801840:	78 18                	js     80185a <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801842:	83 ec 0c             	sub    $0xc,%esp
  801845:	ff 75 f4             	pushl  -0xc(%ebp)
  801848:	e8 8f f4 ff ff       	call   800cdc <fd2data>
	return _pipeisclosed(fd, p);
  80184d:	89 c2                	mov    %eax,%edx
  80184f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801852:	e8 21 fd ff ff       	call   801578 <_pipeisclosed>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80186c:	68 36 22 80 00       	push   $0x802236
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8018ba:	53                   	push   %ebx
  8018bb:	57                   	push   %edi
  8018bc:	e8 5e f1 ff ff       	call   800a1f <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8018e4:	74 2a                	je     801910 <devcons_read+0x3b>
  8018e6:	eb 05                	jmp    8018ed <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8018e8:	e8 cf f1 ff ff       	call   800abc <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8018ed:	e8 4b f1 ff ff       	call   800a3d <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801923:	50                   	push   %eax
  801924:	e8 f6 f0 ff ff       	call   800a1f <sys_cputs>
}
...
getchar(void)
{
  ...
  80193c:	e8 67 f6 ff ff       	call   800fa8 <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  801966:	e8 d7 f3 ff ff       	call   800d42 <fd_lookup>
...
opencons(void)
{
  ...
  80198e:	50                   	push   %eax
  80198f:	e8 5f f3 ff ff       	call   800cf3 <fd_alloc>
...
opencons(void)
{
  ...
  8019aa:	e8 2c f1 ff ff       	call   800adb <sys_page_alloc>
  ...
  8019d0:	50                   	push   %eax
  8019d1:	e8 f6 f2 ff ff       	call   800ccc <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019ed:	e8 ab f0 ff ff       	call   800a9d <sys_getenvid>
  8019f2:	83 ec 0c             	sub    $0xc,%esp
  8019f5:	ff 75 0c             	pushl  0xc(%ebp)
  8019f8:	ff 75 08             	pushl  0x8(%ebp)
  8019fb:	56                   	push   %esi
  8019fc:	50                   	push   %eax
  8019fd:	68 44 22 80 00       	push   $0x802244
  801a02:	e8 4c e7 ff ff       	call   800153 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801a07:	83 c4 18             	add    $0x18,%esp
  801a0a:	53                   	push   %ebx
  801a0b:	ff 75 10             	pushl  0x10(%ebp)
  801a0e:	e8 ef e6 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801a13:	c7 04 24 0c 1e 80 00 	movl   $0x801e0c,(%esp)
  801a1a:	e8 34 e7 ff ff       	call   800153 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a33:	85 c0                	test   %eax,%eax
		...
		va = (void *) KERNBASE;
  801a35:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  ...
  801a40:	50                   	push   %eax
  801a41:	e8 45 f2 ff ff       	call   800c8b <sys_ipc_recv>
  ...
  801a7f:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aae:	56                   	push   %esi
  801aaf:	57                   	push   %edi
  801ab0:	e8 b3 f1 ff ff       	call   800c68 <sys_ipc_try_send>
		if (r == -E_IPC_NOT_RECV) {
  801ab5:	83 c4 10             	add    $0x10,%esp
  801ab8:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801abb:	75 07                	jne    801ac4 <ipc_send+0x36>
			sys_yield();
  801abd:	e8 fa ef ff ff       	call   800abc <sys_yield>
  801ac2:	eb e6                	jmp    801aaa <ipc_send+0x1c>
		} else if (r < 0) {
  801ac4:	85 c0                	test   %eax,%eax
  801ac6:	79 12                	jns    801ada <ipc_send+0x4c>
			panic("ipc_send: %e", r);
  801ac8:	50                   	push   %eax
  801ac9:	68 68 22 80 00       	push   $0x802268
  801ace:	6a 51                	push   $0x51
  801ad0:	68 75 22 80 00       	push   $0x802275
  801ad5:	e8 05 ff ff ff       	call   8019df <_panic>
		}
	}
}
