...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 1c             	sub    $0x1c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 53 0d 00 00       	call   800d94 <fork>
  ...
  800067:	e8 91 0f 00 00       	call   800ffd <ipc_send>
  ...
  800079:	56                   	push   %esi
  80007a:	e8 18 0f 00 00       	call   800f97 <ipc_recv>
  ...
  8000a9:	e8 4f 0f 00 00       	call   800ffd <ipc_send>
		if (i == 10)
...
sys_env_destroy(envid_t envid)
{
  ...
  800ada:	68 84 16 80 00       	push   $0x801684
  800adf:	6a 23                	push   $0x23
  800ae1:	68 a1 16 80 00       	push   $0x8016a1
  800ae6:	e8 9f 05 00 00       	call   80108a <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b5b:	68 84 16 80 00       	push   $0x801684
  800b60:	6a 23                	push   $0x23
  800b62:	68 a1 16 80 00       	push   $0x8016a1
  800b67:	e8 1e 05 00 00       	call   80108a <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b9d:	68 84 16 80 00       	push   $0x801684
  800ba2:	6a 23                	push   $0x23
  800ba4:	68 a1 16 80 00       	push   $0x8016a1
  800ba9:	e8 dc 04 00 00       	call   80108a <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bdf:	68 84 16 80 00       	push   $0x801684
  800be4:	6a 23                	push   $0x23
  800be6:	68 a1 16 80 00       	push   $0x8016a1
  800beb:	e8 9a 04 00 00       	call   80108a <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c21:	68 84 16 80 00       	push   $0x801684
  800c26:	6a 23                	push   $0x23
  800c28:	68 a1 16 80 00       	push   $0x8016a1
  800c2d:	e8 58 04 00 00       	call   80108a <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c63:	68 84 16 80 00       	push   $0x801684
  800c68:	6a 23                	push   $0x23
  800c6a:	68 a1 16 80 00       	push   $0x8016a1
  800c6f:	e8 16 04 00 00       	call   80108a <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cd3:	e8 b2 03 00 00       	call   80108a <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800cee:	74 2c                	je     800d1c <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
  800cf0:	89 d8                	mov    %ebx,%eax
  800cf2:	c1 e8 16             	shr    $0x16,%eax
  800cf5:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
  ...
  800cfe:	74 1c                	je     800d1c <pgfault+0x3c>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
  800d00:	89 de                	mov    %ebx,%esi
  800d02:	c1 ee 0c             	shr    $0xc,%esi
  800d05:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   (see <inc/memlayout.h>).
  ...
  800d0e:	74 0c                	je     800d1c <pgfault+0x3c>
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
  800d10:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	//   Use the read-only page table mappings at uvpt
	//   (see <inc/memlayout.h>).
	...
	if (!((err & FEC_WR) &&
  800d17:	f6 c4 08             	test   $0x8,%ah
  800d1a:	75 14                	jne    800d30 <pgfault+0x50>
	      (uvpd[PDX(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_P) &&
	      (uvpt[PGNUM(addr)] & PTE_COW)))
		panic("not copy on write");
  800d1c:	83 ec 04             	sub    $0x4,%esp
  800d1f:	68 af 16 80 00       	push   $0x8016af
  800d24:	6a 21                	push   $0x21
  800d26:	68 c1 16 80 00       	push   $0x8016c1
  800d2b:	e8 5a 03 00 00       	call   80108a <_panic>
	// Hint:
  ...
  800d30:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
	sys_page_alloc(0, PFTEMP, PTE_W | PTE_P | PTE_U);
  800d36:	83 ec 04             	sub    $0x4,%esp
  800d39:	6a 07                	push   $0x7
  800d3b:	68 00 f0 7f 00       	push   $0x7ff000
  800d40:	6a 00                	push   $0x0
  800d42:	e8 ea fd ff ff       	call   800b31 <sys_page_alloc>
	memcpy(PFTEMP, addr, PGSIZE);
  800d47:	83 c4 0c             	add    $0xc,%esp
  800d4a:	68 00 10 00 00       	push   $0x1000
  800d4f:	53                   	push   %ebx
  800d50:	68 00 f0 7f 00       	push   $0x7ff000
  800d55:	e8 ce fb ff ff       	call   800928 <memcpy>
	sys_page_map(0, PFTEMP,
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
  800d5a:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
	// LAB 4: Your code here.
	...
	memcpy(PFTEMP, addr, PGSIZE);
	sys_page_map(0, PFTEMP,
  800d61:	25 05 06 00 00       	and    $0x605,%eax
  800d66:	83 c8 02             	or     $0x2,%eax
  800d69:	89 04 24             	mov    %eax,(%esp)
  800d6c:	53                   	push   %ebx
  800d6d:	6a 00                	push   $0x0
  800d6f:	68 00 f0 7f 00       	push   $0x7ff000
  800d74:	6a 00                	push   $0x0
  800d76:	e8 f9 fd ff ff       	call   800b74 <sys_page_map>
	             0, addr,
	             (uvpt[PGNUM(addr)] & (PTE_SYSCALL & (~PTE_COW))) | PTE_W);
	sys_page_unmap(0, PFTEMP);
  800d7b:	83 c4 18             	add    $0x18,%esp
  800d7e:	68 00 f0 7f 00       	push   $0x7ff000
  800d83:	6a 00                	push   $0x0
  800d85:	e8 2c fe ff ff       	call   800bb6 <sys_page_unmap>
	return;
...
fork(void)
{
  ...
  800d98:	56                   	push   %esi
  800d99:	53                   	push   %ebx
  800d9a:	83 ec 28             	sub    $0x28,%esp
	// LAB 4: Your code here.

	int r;

	set_pgfault_handler(pgfault);
  800d9d:	68 e0 0c 80 00       	push   $0x800ce0
  800da2:	e8 29 03 00 00       	call   8010d0 <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800da7:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800db6:	79 14                	jns    800dcc <fork+0x38>
		panic ("No memory");
  800db8:	83 ec 04             	sub    $0x4,%esp
  800dbb:	68 cc 16 80 00       	push   $0x8016cc
  800dc0:	6a 77                	push   $0x77
  800dc2:	68 c1 16 80 00       	push   $0x8016c1
  800dc7:	e8 be 02 00 00       	call   80108a <_panic>
  800dcc:	89 c7                	mov    %eax,%edi
  800dce:	bb 00 00 00 00       	mov    $0x0,%ebx
	else if (r == 0)
  800dd3:	85 c0                	test   %eax,%eax
  800dd5:	75 31                	jne    800e08 <fork+0x74>
	{
		set_pgfault_handler(pgfault);
  800dd7:	83 ec 0c             	sub    $0xc,%esp
  800dda:	68 e0 0c 80 00       	push   $0x800ce0
  800ddf:	e8 ec 02 00 00       	call   8010d0 <set_pgfault_handler>
		thisenv = &envs[ENVX(sys_getenvid())];
  800de4:	e8 0a fd ff ff       	call   800af3 <sys_getenvid>
  800de9:	25 ff 03 00 00       	and    $0x3ff,%eax
  800dee:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800df1:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800df6:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800dfb:	83 c4 10             	add    $0x10,%esp
  800dfe:	b8 00 00 00 00       	mov    $0x0,%eax
  800e03:	e9 6d 01 00 00       	jmp    800f75 <fork+0x1e1>
	}
  ...
  800e16:	0f 84 c2 00 00 00    	je     800ede <fork+0x14a>
  800e1c:	89 d8                	mov    %ebx,%eax
  800e1e:	c1 e8 0c             	shr    $0xc,%eax
  800e21:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e28:	f6 c2 01             	test   $0x1,%dl
  800e2b:	0f 84 ad 00 00 00    	je     800ede <fork+0x14a>
			&& (uvpt [PGNUM(i)] & PTE_U))
  800e31:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e38:	f6 c2 04             	test   $0x4,%dl
  800e3b:	0f 84 9d 00 00 00    	je     800ede <fork+0x14a>
{
	int r;
  ...
  800e43:	c1 e6 0c             	shl    $0xc,%esi

	if (uvpt[pn] & PTE_COW || uvpt[pn] & PTE_W)
  800e46:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800e4d:	f6 c6 08             	test   $0x8,%dh
  800e50:	75 0b                	jne    800e5d <fork+0xc9>
  800e52:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800e59:	a8 02                	test   $0x2,%al
  800e5b:	74 6d                	je     800eca <fork+0x136>
	{
		if (sys_page_map(thisenv->env_id, address, envid, address, PTE_COW|PTE_U|PTE_P))
  800e5d:	a1 04 20 80 00       	mov    0x802004,%eax
  800e62:	8b 40 48             	mov    0x48(%eax),%eax
  800e65:	83 ec 0c             	sub    $0xc,%esp
  800e68:	68 05 08 00 00       	push   $0x805
  800e6d:	56                   	push   %esi
  800e6e:	ff 75 e4             	pushl  -0x1c(%ebp)
  800e71:	56                   	push   %esi
  800e72:	50                   	push   %eax
  800e73:	e8 fc fc ff ff       	call   800b74 <sys_page_map>
  800e78:	83 c4 20             	add    $0x20,%esp
  800e7b:	85 c0                	test   %eax,%eax
  800e7d:	74 14                	je     800e93 <fork+0xff>
            panic("sys_page_map failed");
  800e7f:	83 ec 04             	sub    $0x4,%esp
  800e82:	68 d6 16 80 00       	push   $0x8016d6
  800e87:	6a 4f                	push   $0x4f
  800e89:	68 c1 16 80 00       	push   $0x8016c1
  800e8e:	e8 f7 01 00 00       	call   80108a <_panic>
        if (sys_page_map(thisenv->env_id, address, thisenv->env_id, address, PTE_COW|PTE_U|PTE_P))
  800e93:	a1 04 20 80 00       	mov    0x802004,%eax
  800e98:	8b 50 48             	mov    0x48(%eax),%edx
  800e9b:	8b 40 48             	mov    0x48(%eax),%eax
  ...
  800ea8:	56                   	push   %esi
  800ea9:	50                   	push   %eax
  800eaa:	e8 c5 fc ff ff       	call   800b74 <sys_page_map>
  800eaf:	83 c4 20             	add    $0x20,%esp
  800eb2:	85 c0                	test   %eax,%eax
  800eb4:	74 28                	je     800ede <fork+0x14a>
            panic("sys_page_map failed");
  800eb6:	83 ec 04             	sub    $0x4,%esp
  800eb9:	68 d6 16 80 00       	push   $0x8016d6
  800ebe:	6a 51                	push   $0x51
  800ec0:	68 c1 16 80 00       	push   $0x8016c1
  800ec5:	e8 c0 01 00 00       	call   80108a <_panic>
	}
	else
  ...
  800ecf:	56                   	push   %esi
  800ed0:	ff 75 e4             	pushl  -0x1c(%ebp)
  800ed3:	56                   	push   %esi
  800ed4:	6a 00                	push   $0x0
  800ed6:	e8 99 fc ff ff       	call   800b74 <sys_page_map>
  800edb:	83 c4 20             	add    $0x20,%esp
	...
	int i;
	for (i=0; i < USTACKTOP; i+=PGSIZE)
  800ede:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800ee4:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800eea:	0f 85 18 ff ff ff    	jne    800e08 <fork+0x74>
		if ((uvpd [PDX(i)] & PTE_P) && (uvpt [PGNUM(i)] & PTE_P) 
			&& (uvpt [PGNUM(i)] & PTE_U))
			duppage (r, PGNUM(i));
	}
  ...
  800efa:	57                   	push   %edi
  800efb:	e8 31 fc ff ff       	call   800b31 <sys_page_alloc>
  800f00:	83 c4 10             	add    $0x10,%esp
  800f03:	85 c0                	test   %eax,%eax
  800f05:	74 17                	je     800f1e <fork+0x18a>
		panic ("sys_page_alloc error in fork()");
  800f07:	83 ec 04             	sub    $0x4,%esp
  800f0a:	68 00 17 80 00       	push   $0x801700
  800f0f:	68 88 00 00 00       	push   $0x88
  800f14:	68 c1 16 80 00       	push   $0x8016c1
  800f19:	e8 6c 01 00 00       	call   80108a <_panic>

	extern void _pgfault_upcall();
	if(sys_env_set_pgfault_upcall(r, _pgfault_upcall))
  800f1e:	83 ec 08             	sub    $0x8,%esp
  800f21:	68 3f 11 80 00       	push   $0x80113f
  800f26:	57                   	push   %edi
  800f27:	e8 0e fd ff ff       	call   800c3a <sys_env_set_pgfault_upcall>
  800f2c:	83 c4 10             	add    $0x10,%esp
  800f2f:	85 c0                	test   %eax,%eax
  800f31:	74 17                	je     800f4a <fork+0x1b6>
		panic ("sys_env_set_pgfault_upcall error in fork()");
  800f33:	83 ec 04             	sub    $0x4,%esp
  800f36:	68 20 17 80 00       	push   $0x801720
  800f3b:	68 8c 00 00 00       	push   $0x8c
  800f40:	68 c1 16 80 00       	push   $0x8016c1
  800f45:	e8 40 01 00 00       	call   80108a <_panic>

	if (sys_env_set_status(r, ENV_RUNNABLE))
  800f4a:	83 ec 08             	sub    $0x8,%esp
  800f4d:	6a 02                	push   $0x2
  800f4f:	57                   	push   %edi
  800f50:	e8 a3 fc ff ff       	call   800bf8 <sys_env_set_status>
  800f55:	83 c4 10             	add    $0x10,%esp
  800f58:	85 c0                	test   %eax,%eax
  800f5a:	74 17                	je     800f73 <fork+0x1df>
		panic ("Cannot set status in sys_env_set_status");
  800f5c:	83 ec 04             	sub    $0x4,%esp
  800f5f:	68 4c 17 80 00       	push   $0x80174c
  800f64:	68 8f 00 00 00       	push   $0x8f
  800f69:	68 c1 16 80 00       	push   $0x8016c1
  800f6e:	e8 17 01 00 00       	call   80108a <_panic>
	return r;
...
sfork(void)
{
  ...
  800f83:	68 ea 16 80 00       	push   $0x8016ea
  800f88:	68 9b 00 00 00       	push   $0x9b
  800f8d:	68 c1 16 80 00       	push   $0x8016c1
  800f92:	e8 f3 00 00 00       	call   80108a <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800fa5:	85 c0                	test   %eax,%eax
		pg = (void*) -1;
  800fa7:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800fac:	0f 44 c2             	cmove  %edx,%eax

	if (sys_ipc_recv(pg))
  800faf:	83 ec 0c             	sub    $0xc,%esp
  800fb2:	50                   	push   %eax
  800fb3:	e8 e7 fc ff ff       	call   800c9f <sys_ipc_recv>
  800fb8:	83 c4 10             	add    $0x10,%esp
  800fbb:	85 c0                	test   %eax,%eax
  800fbd:	74 13                	je     800fd2 <ipc_recv+0x3b>
	{
		*from_env_store = 0;
  800fbf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;
  800fc5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		return -E_INVAL;
  800fcb:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  800fd0:	eb 24                	jmp    800ff6 <ipc_recv+0x5f>
	}

	if (from_env_store)
  800fd2:	85 f6                	test   %esi,%esi
  800fd4:	74 0a                	je     800fe0 <ipc_recv+0x49>
        *from_env_store = thisenv->env_ipc_from;
  800fd6:	a1 04 20 80 00       	mov    0x802004,%eax
  800fdb:	8b 40 74             	mov    0x74(%eax),%eax
  800fde:	89 06                	mov    %eax,(%esi)
    
    if (perm_store)
  800fe0:	85 db                	test   %ebx,%ebx
  800fe2:	74 0a                	je     800fee <ipc_recv+0x57>
        *perm_store = thisenv->env_ipc_perm;
  800fe4:	a1 04 20 80 00       	mov    0x802004,%eax
  800fe9:	8b 40 78             	mov    0x78(%eax),%eax
  800fec:	89 03                	mov    %eax,(%ebx)

    return thisenv->env_ipc_value;
  800fee:	a1 04 20 80 00       	mov    0x802004,%eax
  800ff3:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80100f:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;
  801011:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801016:	0f 44 d8             	cmove  %eax,%ebx
  801019:	eb 05                	jmp    801020 <ipc_send+0x23>
	while((result = sys_ipc_try_send(to_env, val, pg, perm)) == -E_IPC_NOT_RECV) {
	    sys_yield();
  80101b:	e8 f2 fa ff ff       	call   800b12 <sys_yield>
	// LAB 4: Your code here.
  ...
  801024:	56                   	push   %esi
  801025:	57                   	push   %edi
  801026:	e8 51 fc ff ff       	call   800c7c <sys_ipc_try_send>
  80102b:	83 c4 10             	add    $0x10,%esp
  80102e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801031:	74 e8                	je     80101b <ipc_send+0x1e>
	    sys_yield();
	}
	if (result)
  801033:	85 c0                	test   %eax,%eax
  801035:	74 12                	je     801049 <ipc_send+0x4c>
		panic ("E_IPC_NOT_RECV %e", result);
  801037:	50                   	push   %eax
  801038:	68 74 17 80 00       	push   $0x801774
  80103d:	6a 43                	push   $0x43
  80103f:	68 86 17 80 00       	push   $0x801786
  801044:	e8 41 00 00 00       	call   80108a <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  80105c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80105f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801065:	8b 52 50             	mov    0x50(%edx),%edx
  801068:	39 ca                	cmp    %ecx,%edx
  80106a:	75 0d                	jne    801079 <ipc_find_env+0x28>
			return envs[i].env_id;
  80106c:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80106f:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801074:	8b 40 48             	mov    0x48(%eax),%eax
  801077:	eb 0f                	jmp    801088 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80107c:	3d 00 04 00 00       	cmp    $0x400,%eax
  801081:	75 d9                	jne    80105c <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801092:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801098:	e8 56 fa ff ff       	call   800af3 <sys_getenvid>
  80109d:	83 ec 0c             	sub    $0xc,%esp
  8010a0:	ff 75 0c             	pushl  0xc(%ebp)
  8010a3:	ff 75 08             	pushl  0x8(%ebp)
  8010a6:	56                   	push   %esi
  8010a7:	50                   	push   %eax
  8010a8:	68 90 17 80 00       	push   $0x801790
  8010ad:	e8 f7 f0 ff ff       	call   8001a9 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010b2:	83 c4 18             	add    $0x18,%esp
  8010b5:	53                   	push   %ebx
  8010b6:	ff 75 10             	pushl  0x10(%ebp)
  8010b9:	e8 9a f0 ff ff       	call   800158 <vcprintf>
	cprintf("\n");
  8010be:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  8010c5:	e8 df f0 ff ff       	call   8001a9 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8010d6:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8010dd:	75 2c                	jne    80110b <set_pgfault_handler+0x3b>
		// First time through!
		// LAB 4: Your code here.
  ...
  8010eb:	e8 41 fa ff ff       	call   800b31 <sys_page_alloc>
  8010f0:	83 c4 10             	add    $0x10,%esp
  8010f3:	85 c0                	test   %eax,%eax
  8010f5:	74 14                	je     80110b <set_pgfault_handler+0x3b>
			PTE_P | PTE_U | PTE_W))
			
        	panic("sys_page_alloc failed.");
  8010f7:	83 ec 04             	sub    $0x4,%esp
  8010fa:	68 b3 17 80 00       	push   $0x8017b3
  8010ff:	6a 24                	push   $0x24
  801101:	68 ca 17 80 00       	push   $0x8017ca
  801106:	e8 7f ff ff ff       	call   80108a <_panic>
  ...
  801116:	68 3f 11 80 00       	push   $0x80113f
  80111b:	6a 00                	push   $0x0
  80111d:	e8 18 fb ff ff       	call   800c3a <sys_env_set_pgfault_upcall>
  801122:	83 c4 10             	add    $0x10,%esp
  801125:	85 c0                	test   %eax,%eax
  801127:	79 14                	jns    80113d <set_pgfault_handler+0x6d>
		panic("sys_env_set_pgfault_upcall failed");
  801129:	83 ec 04             	sub    $0x4,%esp
  80112c:	68 d8 17 80 00       	push   $0x8017d8
  801131:	6a 2b                	push   $0x2b
  801133:	68 ca 17 80 00       	push   $0x8017ca
  801138:	e8 4d ff ff ff       	call   80108a <_panic>
...
_pgfault_upcall:
  ...
  801140:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  80114a:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  80114e:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  801153:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  801157:	89 03                	mov    %eax,(%ebx)
	addl $0x8, %esp
